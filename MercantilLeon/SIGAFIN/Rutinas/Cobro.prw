...
RecLock("SEL",.T.)
	...
	SEL->EL_DIACTB := '06'
	SEL->EL_UVLRCBS := crecibobs
	SEL->EL_UVLRCSU := crecibosus
...
//----------------------------------------------------------
SEL->(DBSETORDER(8))
SEL->(DbSeek(xFilial("SEL")+"   "+cRecibo+cTipoPago+ALLTRIM(cprefijo)+" "+PADR(ALLTRIM(cnumero),13," ")+" "+cTipoPago+" "))  
