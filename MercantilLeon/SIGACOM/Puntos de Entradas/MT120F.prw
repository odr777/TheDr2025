...
±±ºPrograma  ³MT120F   º Autor ³ EDUAR ANDIA         º Data ³  31/12/2015 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ PE que Manipula os dados no pedido de Compras na tabela SC7º±±
...
While xFilial("SC7")+SC7->C7_NUM == cChvPed	
	...
	SC7->C7_XHORA	:= SUBSTR(TIME(), 1, 5)   // Nahim se adiciono la fecha 
	MsUnLock()
