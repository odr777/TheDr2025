...
Local cMoneda	 := GetMV("MV_MOEDA"+alltrim(str(SF2->F2_MOEDA)))
...
DEFINE MSDIALOG _oDlg TITLE "Cobros" FROM C(184),C(333) TO C(615),C(1119) PIXEL

	// Cria as Groups do Sistema
	@ C(001),C(005) TO C(045),C(386) LABEL "Datos del Recibo" PIXEL OF _oDlg
	@ C(049),C(005) TO C(096),C(386) LABEL "Datos del Cliente" PIXEL OF _oDlg
	@ C(098),C(005) TO C(140),C(386) LABEL "Datos de la Factura" PIXEL OF _oDlg
	@ C(147),C(005) TO C(191),C(386) LABEL "Datos de la Cobranza" PIXEL OF _oDlg
	...
	@ C(063),C(014) Say "Cliente" Size C(020),C(007) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(063),C(045) MsGet oCliente Var cCliente F3 "SA1" Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(063),C(095) Say "Tienda" Size C(018),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(063),C(120) MsGet oLoja Var cLoja Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(063),C(170) Say "NIT" Size C(011),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(063),C(194) MsGet oCGC Var cCGC Size C(060),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(078),C(015) Say "Nombre" Size C(020),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(078),C(045) MsGet oNome Var cNome Size C(199),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(078),C(258) Say "Telefono" Size C(023),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(078),C(286) MsGet oTel Var cTel Size C(060),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(110),C(015) Say "Serie" Size C(014),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(110),C(045) MsGet oSerie Var cSerie Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(110),C(095) Say "Nro. de Factura" Size C(039),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(110),C(137) MsGet onumfac Var cnumfac Size C(118),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(110),C(262) Say "Moneda" Size C(021),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(110),C(287) MsGet oMoneda Var cMoneda Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(125),C(015) Say "Valor" Size C(014),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(125),C(045) MsGet ovalor Var cvalor Size C(072),C(009) COLOR CLR_BLACK PIXEL OF _oDlg PICTURE	PesqPict("SEL","EL_VALOR",TamSX3("EL_VALOR")[1]) When .F.
	@ C(125),C(143) Say "Emisión" Size C(020),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(125),C(170) MsGet oemision Var cemision Size C(045),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(160),C(015) Say "Forma Pago" Size C(026),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(160),C(045) ComboBox ctipo Items atipo Size C(066),C(010) PIXEL OF _oDlg valid SetDatos(ctipo,cRecibo)
	@ C(160),C(132) Say "Prefijo" Size C(016),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(160),C(152) MsGet oprefijo Var cprefijo Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(160),C(199) Say "Numero" Size C(020),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(160),C(227) MsGet onumero Var cnumero Size C(118),C(009) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(018) Say "Banco" Size C(017),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(045) MsGet obanco Var cbanco F3 "SA6" Size C(026),C(009) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(092) Say "Agencia" Size C(021),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(122) MsGet oagenban Var cagenban Size C(035),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(175),C(170) Say "Cuenta Banco" Size C(036),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(210) MsGet ocuentaBan Var ccuentaBan Size C(060),C(009) COLOR CLR_BLACK PIXEL OF _oDlg When .F.
	@ C(175),C(285) Say "Valor" Size C(014),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
	@ C(175),C(305) MsGet ovalorcob Var cvalorcob Size C(072),C(009) COLOR CLR_BLACK PIXEL OF _oDlg Picture PesqPict("SEL","EL_VALOR",TamSX3("EL_VALOR")[1]) When .F.
	@ C(196),C(273) Button "&Confirmar" Size C(037),C(012) PIXEL OF _oDlg ACTION IIf(UFA087vld('cRecibo',"   ",cRecibo,cbanco,cnumero),_oDlg:End(),(nOpcA := 0,cRecibo  	:= 	GETSXENUM('SEL','EL_RECIBO')))
	@ C(196),C(327) Button "&Finalizar" Size C(037),C(012) PIXEL OF _oDlg ACTION (nOpcA := 0,_oDlg:End())
...
RecLock("SEL",.T.)
	...
	SEL->EL_EMISSAO := DDATABASE
	SEL->EL_DTVCTO := DDATABASE
	SEL->EL_PREFIXO:=  cprefijo
...
//----------------------------------------------------------
SEL->(DBSETORDER(1))
SEL->(DbSeek(xFilial("SEL")+cRecibo+cTipoPago+cprefijo+cnumero,.T.))  
//-------------------ACTUALIZAMOS EL BANCO ------------------------
	UFaGrvSE5(2,"1",cNatureza,cRecibo,cSerie,aTxMoedas,"NOR")
SEL->(DbSeek(xFilial("SEL")+cRecibo+'TB'+cSerie+cnumero,.T.))
//UFaGrvSE5(2,"1","",cRecibo,cSerie,aTxMoedas,"")
GravaSE5("1",cRecibo,cSerie,aTxMoedas)
...
static Function UFA087vld(cVar   ,cSerie,cRecibo,cBanco,cTitulo)
Local lRet 	:= .T.
Local _aArea := GetArea()                      
		If Empty(cRecibo)
...
//	SE5->E5_DTDISPO   := IIf(!Empty(SE1->E1_BAIXA),SE1->E1_BAIXA,dDatabase)
	...
	SE5->E5_VALOR     := xMoeda(SEL->EL_VALOR,Val(SEL->EL_MOEDA),Max(SA6->A6_MOEDA,1),,,aTaxa[Val(SEL->EL_MOEDA)],aTaxa[Max(SA6->A6_MOEDA,1)])
...
//	SE5->E5_DTDISPO   := IIf(!Empty(SE1->E1_BAIXA),SE1->E1_BAIXA,dDatabase)
	...
	SE5->E5_TIPO      := 'NF'
	SE5->E5_MOEDA     := StrZero( SA6->A6_MOEDA, 2)
	SE5->E5_VALOR     := xMoeda(SE1->E1_VALOR,(SE1->E1_MOEDA),Max(SA6->A6_MOEDA,1),,,aTaxa[SE1->E1_MOEDA],aTaxa[Max(SA6->A6_MOEDA,1)])
	SE5->E5_SEQ       := UF087Seq()
	SE5->E5_LA        := "S"
		SE5->E5_LOTE := cRecibo
	SE5->E5_MOTBX := 'NOR'
