...
User Function GetStockNeg(cProducto,cLocal, nCantVen)
	...
	If nCant < 0 .AND. cUNegati=="N" 
		If FUNNAME()$"MATA415"
			...
			nCantidad := nCantVen
		Else
			If FUNNAME()$"MATA410" .OR. FUNNAME()$"MATA467N" .OR. FUNNAME()$"MATA416"
				If (M->C5_DOCGER <> "3")
					IF FUNNAME()$ "MATA416" // Si estแ aprobando el presupuesto 
						if SCJ->CJ_XECOMME <> 'S' //S๓lo muestra si es E-Commerce porque va a mostrar el mensaje M415GRV  ya cambiado C5_DOCGER
