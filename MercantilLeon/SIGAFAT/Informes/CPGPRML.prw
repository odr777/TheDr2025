...
Static Function ReportDef()
    ...
    oReport := TReport():New("CPSBMML","Cuentas por pagar por grupo de producto resumido",cPerg,{|oReport| ReportPrint(oReport)},;
    ...
    oSection2 := TRSection():New(oReport,"CUENTAS POR PAGAR POR PEDIDO",,)
...
Static Function ReportPrint(oReport)
	...
	cQuery2:= " SELECT SUBSTRING(D2_EMISSAO, 1, 4)+'-'+SUBSTRING(D2_EMISSAO, 5, 2) ANIO_MES,"
