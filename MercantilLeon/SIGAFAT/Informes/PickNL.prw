...
cQuery += "C6_ENTREG,C6_ITEM,B1_UCODFAB,C6_PRODUTO,C6_LOCAL,NNR_DESCRI,NNR_UDIREC,B1_UDESCMA, B1_UESPEC2, C6_UM, C6_QTDVEN,C6_PRCVEN,C6_VALOR, C6_LOTECTL, C6_CODFAB, "
...
cQuery += "INNER JOIN " + RetSqlName("SCK") +" SCK ON C6_FILIAL=CK_FILIAL "
...
// ARTICULO	NOMBRE	PROCEDENCIA	UNIDAD	CANTIDAD	PRECIO	MONTO
	...
	//oPrn:Say( Tpix(nLin+00.0), Tpix(01.0), "__________________________________________________________________________________________"	, oFont12C)
	oPrn:Line(Tpix(nLin+00.4),Tpix(01.0),Tpix(nLin+00.4), Tpix(20.5))
	oPrn:Say( Tpix(nLin+00.5), Tpix(01.0), "IT", oFont10C)   
	
	 	                      
	oPrn:Say( Tpix(nLin+00.5), Tpix(02.1), "CODIGO", oFont10C)
	oPrn:Say( Tpix(nLin+00.7), Tpix(02.3), "ML", oFont10C)
	
	oPrn:Say( Tpix(nLin+00.5), Tpix(04.4), "CODIGO", oFont10C)
	oPrn:Say( Tpix(nLin+00.7), Tpix(04.2), "PROVEEDOR", oFont10C)
	
	oPrn:Say( Tpix(nLin+00.5), Tpix(09.5), "DESCRIPCION", oFont10C)

	//oPrn:Say( Tpix(nLin+00.5), Tpix(15.4), "MARCA", oFont10C)
	
	oPrn:Say( Tpix(nLin+00.5), Tpix(17.4), "UNID.", oFont10C)
	
	oPrn:Say( Tpix(nLin+00.5), Tpix(18.8), "CANTIDAD", oFont10C)
	oPrn:Line(Tpix(nLin+01.1),Tpix(01.0),Tpix(nLin+01.1), Tpix(20.5))
	...
	//oPrn:Say( Tpix(nLin+00.9), Tpix(01.0), "__________________________________________________________________________________________"	, oFont12C)
	//oPrn:Say( Tpix(nLin+00.5), Tpix(20.0), "PRECIO", oFont10C)
	 oPrn:Line( Tpix(06.5),Tpix(1.0) ,Tpix(nLindet+2.4),Tpix(1.0))
 	  oPrn:Line( Tpix(06.5),Tpix(01.5) ,Tpix(nLindet+2.4),Tpix(01.5))
 	  oPrn:Line( Tpix(06.5),Tpix(04.0) ,Tpix(nLindet+2.4),Tpix(04.0))
 	  oPrn:Line( Tpix(06.5),Tpix(06.0) ,Tpix(nLindet+2.4),Tpix(06.0))
 	  //oPrn:Line( Tpix(06.5),Tpix(15.0) ,Tpix(nLindet+2.5),Tpix(15.0))
 	  oPrn:Line( Tpix(06.5),Tpix(17.0) ,Tpix(nLindet+2.4),Tpix(17.0))
 	  oPrn:Line( Tpix(06.5),Tpix(18.5) ,Tpix(nLindet+2.4),Tpix(18.5))
 	  oPrn:Line( Tpix(06.5), Tpix(20.5), Tpix(nLindet+2.4), Tpix(20.5))
	//oPrn:Say( Tpix(nLin+00.9), Tpix(01.0), "________________________________________________________________________________________________________________"	, oFont12C)
...
//         oPrn:Say( Tpix(nLin+01.5), Tpix(05.2), Right(C6_DESCRI,10), oFont10C)
	...
	oPrn:Say( Tpix(nLin+01.5), Tpix(02.1), C6_PRODUTO, oFont10C)
	oPrn:Say( Tpix(nLin+01.5), Tpix(4.2), B1_UCODFAB, oFont10C)
	oPrn:Say(Tpix(nLin+01.5), Tpix(8.2),Alltrim(B1_UDESCMA)+" - "+B1_UMARCA)
	oPrn:Say( Tpix(nLin+01.5), Tpix(17.6), C6_UM, oFont10C)
	oPrn:Say( Tpix(nLin+01.5), Tpix(19.3), cValToChar(C6_QTDVEN), oFont10C)
			
	//oPrn:Say( Tpix(nLin+01.5), Tpix(20.0), cValToChar(C6_PRCVEN), oFont10C)
	If !empty(Lote)
		If Len(AllTrim(C6_UESPECI)) > 50
		oPrn:Say( Tpix(nLin+01.3), Tpix(08.2), C6_UESPECI, oFont10C)
		oPrn:Say(Tpix(nLin+01.8), Tpix(08.2), B1_UESPEC2, oFont10C)
		oPrn:Say(Tpix(nLin+02.1), Tpix(08.2), C6_LOTECTL, oFont10C)
		oPrn:Say(Tpix(nLin+01.9), Tpix(08.2), , )
		...
		Else		
			oPrn:Say( Tpix(nLin+01.3), Tpix(08.2), C6_UESPECI, oFont10C)
			oPrn:Say(Tpix(nLin+01.8), Tpix(08.2), B1_UESPEC2, oFont10C)
			oPrn:Say(Tpix(nLin+2.1), Tpix(08.2), C6_LOTECTL, oFont10C)
			//oPrn:Say( Tpix(nLin+02.0), Tpix(01.0), "________________________________________________________________________________________________________________"	, oFont12C)
			nLin:= nLin+00.8
		EndIf
	Else
		...
		EndIf
	EndIf
	//oPrn:Say( Tpix(nLin+01.2), Tpix(01.0), "________________________________________________________________________________________________________________"	, oFont12C)
		//	oPrn:Say( Tpix(nLin+01.2), Tpix(01.0), "__________________________________________________________________________________________"	, oFont12C)		
		oPrn:Line(Tpix(nLin+01.6),Tpix(01.0),Tpix(nLin+01.6), Tpix(20.5))
	nLin:= nLin+00.3	
