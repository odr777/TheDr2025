...
user Function pick()
 ...
 PRIVATE titulo   :="P I C K  - L I S T"
 PRIVATE nomeprog := "PICK"
 PRIVATE cabec1   := ""
 PRIVATE cabec2   := ""
 PRIVATE Tamanho  := "G" 
 PRIVATE cUsrReg  := "" 
...
For _nCont:=1 to nVias
	...
	fImpCab() // IMPRIME LA CABECERA  
 	...
 	While OrdenesCom->(!EOF()) 
    	...
    	Endif*/
    	@ li,colini+106 Psay "____________________"  
    	If empty(OrdenesCom->C5_EMISSAO)
...
// @ li,20 PSAY "Cod-Proveedor" 																	
 ...
 @ li,colini + 92 PSAY "Cantidad"	
 @ li,colini + 106 PSAY "Observacones"												
 //@ li,colini + 124 PSAY "Observacones"	
 li++																		
 @ li,colini PSAY REPLICATE('_',limite)    												
 li += 2																		
