...
Static Function ReportDef()
	...
	TRCell():New(oSection,"CLI_TIT"	,"SA1","Nombre Cli Titular")
...
Static Function PrintReport(oReport)
	...
	#IFDEF TOP
		...
		ISNULL((SELECT A1_NOME FROM SA1010 WHERE A1_COD = F2_CLIENTE AND A1_LOJA = '01' AND D_E_L_E_T_ = ' '),'')CLI_TIT
		...
		while (cAliasQry)->(!Eof())
			...
			oSection:Cell("CLI_TIT"):SetValue( (cAliasQry)->CLI_TIT )
