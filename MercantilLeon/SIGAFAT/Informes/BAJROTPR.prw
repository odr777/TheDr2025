...
User Function BAJROTPR()
	Local oReport
	PRIVATE cPerg   := "BAJROTPR"   // elija el Nombre de la pregunta
...
Static Function ReportDef()
	...
	oReport	 := TReport():New("Producto",NombreProg,cPerg,{|oReport| PrintReport(oReport)},"Reporte de productos de menor movimiento (ventas)", .T.)
