...
//oPrn:Say( Tpix(nLin+03.0), Tpix(01.0), "Telefono: "+A1_TEL, oFont10CN)
	...
	oPrn:Say( Tpix(nLin+04.6), Tpix(01.0), "Observaci๓n: " + alltrim(TRB->C5_UOBSERV), oFont09CN)
