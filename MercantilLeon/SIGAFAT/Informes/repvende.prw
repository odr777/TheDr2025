...
±±³Fun‡…o    ³ REPORTBASE ³ Autor ³EET	Query	: Nahim Terrazas/EET		³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ ejemplo Base de TREPORT() Nahim Terrazas /EET				³±±
...
User Function repvende()
	Local oReport
	PRIVATE cPerg   := "REPVENDE"   // elija el Nombre de la pregunta
	criasx1(cPerg)
...
Static Function ReportDef()
	...
	pergunte(cperg, .F.)
	oReport	 := TReport():New("repvende",NombreProg,cPerg,{|oReport| PrintReport(oReport)},"Reporte de ventas")
