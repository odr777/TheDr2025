...
Static  Function IMPREP(lEnd,WnRel,cString,cPerg,tamanho,titulo,cDesc1,cDesc2,cDesc3)
	...
	cQuery := "select F1_DOC,F1_EMISSAO,F1_FILORIG,F1_UNROREC,F1_UOBSERV,B1_DESC,D1_LOTECTL,D1_CUSTO,"
	cQuery += "D1_ITEM,D1_COD,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_UM,D1_PEDIDO,D1_ITEMORI,D1_NFORI ,F1_MOEDA,NNR.NNR_DESCRI as almdes,D1_VUNIT,D1_TOTAL,F1_SERIE,D1_LOCAL,D1_LOTECTL,D1_LOCALIZ,D1_NUMSERI,D1_NFORI,D1_SERIORI,F1_USRREG,B1_ESPECIF,B1_UESPEC2,B1_UDESCMA,B1_UMARCA,B1_UCODFAB,F1_DTDIGIT  "//B2_QATU,B2_CM1  "
	...
	cQuery += " group by F1_DOC,F1_EMISSAO,F1_FILORIG,F1_UNROREC,F1_UOBSERV,B1_DESC,D1_UM,D1_CUSTO,D1_ITEM,D1_COD,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_PEDIDO,D1_ITEMORI,D1_NFORI,F1_MOEDA,NNR.NNR_DESCRI,D1_VUNIT,D1_TOTAL,F1_SERIE,D1_LOCAL,D1_LOTECTL,D1_LOCALIZ,D1_NUMSERI,D1_NFORI,D1_SERIORI,F1_USRREG,B1_ESPECIF,B1_UESPEC2,B1_UDESCMA,B1_UMARCA,B1_UCODFAB,F1_DTDIGIT  "
...
//	oPrint:SayBitmap(nNroLin,nNroCol-10,cFLogo,675,135)
	...
	oPrint:Say(nNroLin,1400,"NUMERO RECIBO: " +ORDENESENT->F1_UNROREC,oFont10n)
	...
	nNroLin	+= 80;	oPrint:Say(nNroLin,0120,"FECHA DIGITACION: " + ffechalatin(ORDENESENT->F1_DTDIGIT),oFont10n)
	oPrint:Say(nNroLin,1400,"FECHA DE IMPRESIÓN: " + ffechalatin(Dtos(date())),oFont10n)
	...
	nNroLin	+= 80;oPrint:Say(nNroLin,0120,"OBSERVACION: " + substr(upper(ORDENESENT->F1_UOBSERV ),1,93),oFont10n)
	nNroLin	+= 80;oPrint:Say(nNroLin,0120, SUBSTR(upper(ORDENESENT->F1_UOBSERV ),93,107),oFont10n)
