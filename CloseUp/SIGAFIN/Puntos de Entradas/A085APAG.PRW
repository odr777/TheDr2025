...
±±ºPrograma  ³A085APAG   º Autor ³ Nahim Terrazas   º Fecha ³  13/04/15   º±±
...
User Function A085APAG
	...
	If  Alltrim(SEK->EK_TIPO) $ "CH"
		...
		MsUnLock()
		aOrdPag:= {}
		AADD(aOrdPag,{SEK->EK_ORDPAGO,SEK->EK_ORDPAGO,SEK->EK_BANCO,SEK->EK_AGENCIA,SEK->EK_CONTA,SEF->EF_NUM})
