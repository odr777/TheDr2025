...
Static Function CriaSX1(cPerg)  // Crear Preguntas
	...
	*/
	...
	xPutSX1(cPerg,"11","¿Categorías por imprimir?" 	, "¿Categorías por imprimir?"	,"¿Categorías por imprimir?"	,"MV_CH11","C",15,0,0,"G","fCategoria()","","","","MV_PAR11",""       ,""            ,""        ,""     ,""   ,"")
	xPutSX1(cPerg,"12","¿Permanente/Eventual?" , "¿Permanente/Eventual?"	,"¿Permanente/Eventual?"	,"MV_CH12","C",01,0,0,"C","","","","","MV_PAR12","Permanente","Permanente","Permanente","","Eventual","Eventual","Eventual")
	xPutSX1(cPerg,"13","¿Nombre del Empleador?" 	, "¿Nombre del Empleador?"	,"¿Nombre del Empleador?"	,"MV_CH13","C",30,0,0,"G","","","","","MV_PAR13",""       ,""            ,""        ,""     ,""   ,"")
	xPutSX1(cPerg,"14","¿Nº Doc. de Identidad?" , "¿Nº Doc. de Identidad?"	,"¿Nº Doc. de Identidad?"	,"MV_CH14","C",16,0,0,"G","","","","","MV_PAR14",""       ,""            ,""        ,""     ,""   ,"")
	xPutSX1(cPerg,"15","¿Orden?"		, "¿Orden?"			,"¿Orden?"			,"MV_CH15","N",01,0,0,"C","","","","","MV_PAR15","Sucursal+Matric.","Sucursal+Matric.","Sucursal+Matric.","","Sucursal+C.Costo","Sucursal+C.Costo","Sucursal+C.Costo"	,"Apellido Paterno","Apellido Paterno","Apellido Paterno")
	xPutSX1(cPerg,"16","¿Agrupar Por?"		, "¿Agrupar Por?"			,"¿Agrupar Por?"			,"MV_CH16","N",01,0,0,"C","","","","","MV_PAR16","Empresa","Empresa","Empresa","","Sucursal","Sucursal","Sucursal","C.Costo","C.Costo","C.Costo")
