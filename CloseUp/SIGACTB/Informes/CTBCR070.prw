...
Static function fCabec()
	...
	cFLogo := GetSrvProfString("Startpath","") + "lgmid" + CEMPANT + (cAliasCT2)->CT2_FILIAL + ".png"
...
/*/{Protheus.doc} getTipoComp
	...
	/*/
// Static Function getTipoComp(cLanzEst)
// 		// If (CT2->CT2_LP=="575",Titulo:="COMPROBANTE DE INGRESO",If((cAliasCT2)->CT2_LP=="570",Titulo:="COMPROBANTE DE EGRESO",Titulo:="COMPROBANTE DE TRASPASO"))

// Local cSeqLan001 := GetNewPar("MV_SQSUB01","571")// ingreso
// Local cSeqLan002 := GetNewPar("MV_SQSUB02","570")// egreso
// Local cSeqLan003 := GetNewPar("MV_SQSUB03","")// traspaso
// cTitAct := ""

// if cLanzEst $ cSeqLan001 .and. (cLanzEst == "575" and ) // INGRESO

// elseif  cLanzEst $ cSeqLan001 // EGRESO
