...
user Function xxFina087a(cNumFatAut,cDadosAdt,aRecAdt,oPagVenNT)// Nahim Adicionando el objeto JSON para
...
//	Private cSerie  	:=	"A"// NAHIM Criavar("EL_SERIE")
	...
	for nW := 1 to nNumPAgos
		...
		for  nP := 1 to len(aBajasNT)
			ACOLS[nW][nPoVal]		:=  OPagBajasNT:PAGOS[nW]:VALOR + XMOEDA(aBajasNT[nP]:NMULTA,aBajasNT[nP]:MONEDA,OPagBajasNT:PAGOS[nW]:MONEDA,ddatabase,2) - XMOEDA(aBajasNT[nP]:NDESCUENTO,aBajasNT[nP]:MONEDA,OPagBajasNT:PAGOS[nW]:MONEDA,ddatabase,2)  ///revisar la moneda
		next nP

		//ACOLS[nW][nPoVal]		:=  OPagBajasNT:PAGOS[nW]:VALOR    /////erick
...
//	Nahim	OPANEL[nPainel]:NCLRPANE:= RGB(233,233,233) //13165800
	...
	FA087aAtuCli(cNumFatAut) // NAHIM Actualizando cliente que quiero   carga llena la ALINSE1 DE BAJA
		...
		for  nP := 1 to len(aBajasNT)
			...
			if aLinSE1[nK][3] == cNumTitu .and. aLinSE1[nK][4] == cNumParcela .and. aLinSE1[nK][Ascan(aCposSE1,"E1_PREFIXO")] == cNumPrefijo   // numero titulo
				...
				*/
				...
				nPosMoed := AScan(aCposSE1,"E1_MOEDA")  ////moneda titulo
...
Static Function Fa087Cont()
	...
	If nHdlPrv > 0 .and. lLancPad70
		...
		*/
		...
		lLanctOk := cA100Incl(	cArquivo,nHdlPrv,3 ,cLoteCom,.f.,.t.,.t.,,,@aFlagCTB,,aDiario )  ///muestra
