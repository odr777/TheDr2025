...
// Informe de la Rendicion de Caja Chica
...
Local aOrdem   := {STR0004,STR0005,"Nro.Rendici?",STR0007}//"Fornecedor"###"Data De Digitacao"###"Tipo+Grupo+Codigo"###" Grupo+Codigo"
Local aArea	   := Getarea() 
Local aSB1Cod  := TamSX3("B1_COD")
Local aSB1Ite  := TAMSX3("B1_CODITE")
Local nTamCli  := Max(TAMSX3("A1_NOME")[1],TAMSX3("A2_NOME")[1])-15
Local cTitle   := "Rendici? de Caja Chica"//STR0001 //"Relacao de Compras"
...
//TRCell():New(oSection1,"COD"       ,"SD1",/*Titulo*/	,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| cCod })  // C?ula para controle do c?igo do produto, n? ser?impressa
...
TRCell():New(oSection1,"F1_UNIT"  ,"   ","NIT"		,/*Picture*/,13	,/*lPixel*/,{|| alltrim(F1_UNIT) })
...
TRCell():New(oSection1,"B1_CONTA"	  ,"   ","Cta.Ctb." ,/*Picture*/,15/*Tamanho*/,/*lPixel*/,{|| alltrim(D1_CONTA) })
...
#IFDEF TOP
	...
	cSelect1 += "D1_TOTAL,  D1_TES, D1_IPI,   D1_PICM,    D1_TIPO, D1_TP,      D1_GRUPO, D1_CUSTO, D1_LOCAL, D1_QTDEDEV, D1_ITEM, D1_UM,EU_HISTOR,EU_NRREND,EU_CAIXA,F1_UNOMBRE,F1_UNIT,D1_CONTA " 
	...
	SELECT D1_FILIAL, D1_DOC,     D1_SERIE,   D1_FORNECE, D1_LOJA, D1_DTDIGIT,    D1_COD,   D1_QUANT, D1_VUNIT,
	       ...
	       F1_MOEDA,  F1_TXMOEDA, F1_DTDIGIT, B1_DESC,    B1_UM,   A2_NOME RAZAO, A2_NREDUZ RAZAORED, SD1.R_E_C_N_O_ SD1RECNO,
   	       B1_CODITE  D1_CODITE,  'F' TIPO, EU_HISTOR ,EU_NRREND,EU_CAIXA,F1_UNOMBRE,F1_UNIT,F1_CODCTR,F1_NUMAUT,B1_CONTA,D1_EMISSAO,D1_CONTA 
	       %Exp:cSelect%
...
While !oReport:Cancel() .And. !(cAliasSD1)->(Eof())
	...
	If lQuery
        ...
        nValUnit := xmoeda((cAliasSD1)->D1_VUNIT,(cAliasSD1)->F1_MOEDA,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
        nValTot  := xmoeda((cAliasSD1)->D1_TOTAL,(cAliasSD1)->F1_MOEDA,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
		nValCusto:= xmoeda((cAliasSD1)->D1_CUSTO,1,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
		
		// Vari?el para atualizar o C?igo quando for estiver usando ve?ulo ou n?
	...
	Else
		...
		//?osiciona o Fornecedor SA2 ou Cliente SA1 conf. o tipo da Nota ?
...
#IFDEF TOP
	If (TcSrvType()#'AS/400')
	  ...
	  ElseIf nOrdem == 3 
		  ...
		  Else
		    // O Campo 22 ?B1_CODITE para Gest? de Concession?ias !
...
nTotQt   := 0
nTotVal  := 0
// INICIO. VERIFICAR SE O PRIMEIRO REGISTRO   IMPRIM?EL ! MARCOS HIRAKAWA
IF ! lVEIC
	If mv_par11 == 1
...
ELSE
   DO WHILE !(cAliasSD1)->(EOF())
	...
	cSerNf   := (cAliasSD1)->D1_SERIE
ENDIF
// FIM. VERIFICAR SE O PRIMEIRO REGISTRO   IMPRIM?EL ! MARCOS HIRAKAWA
...
aAdd(aRegs,{"06","Nro.Rendici?: ","mv_ch6","C",10,0,0,"G","mv_par06",""       ,""            ,""        ,""     ,"",""})
