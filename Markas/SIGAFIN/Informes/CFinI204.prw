...
static function f4_ROfC3(cTitulo,bImprimir)
	...
	// _csql := _csql + " INNER JOIN " + RetSqlName("SA1") + " SA1 ON A1_COD + A1_LOJA + A1_FILIAL = EL_CLIORIG + EL_LOJORIG + EL_FILIAL AND SA1.D_E_L_E_T_ = ' '" + CHR(13)
	...
	_csql2 := _csql2 + " E1_CLIENTE + E1_LOJA +  E1_PREFIXO + E1_NUM + E1_PARCELA + E1_TIPO = EL_CLIENTE + EL_LOJA + EL_PREFIXO + EL_NUMERO + EL_PARCELA + EL_TIPO " + CHR(13)
	_csql2 := _csql2 + " INNER JOIN " + RetSqlName("SA1") + " SA1 ON A1_COD + A1_LOJA  = E1_CLIENTE + E1_LOJA  AND SA1.D_E_L_E_T_ = ' '" + CHR(13)
	// _csql2 := _csql2 + " INNER JOIN " + RetSqlName("SA1") + " SA1 ON A1_COD + A1_LOJA + A1_FILIAL = E1_CLIENTE + E1_LOJA +E1_FILIAL AND SA1.D_E_L_E_T_ = ' '" + CHR(13)
