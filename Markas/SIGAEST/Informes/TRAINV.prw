...
Else
	...
	cQuery += " group by F2_FILIAL,F2_DOC,F2_EMISSAO,F2_FILDEST,B1_DESC,D2_CUSTO1,D2_UM,D2_ITEM,D2_COD,D2_QUANT,D2_PRCVEN,D2_TOTAL,D2_PEDIDO,D2_ITEMORI,D2_NFORI,F2_MOEDA,NNR.NNR_DESCRI,D2_PRCVEN,D2_TOTAL,A1_NOME,D2_LOCDEST,F2_SERIE,D2_LOCAL,D2_LOTECTL,D2_LOCALIZ,D2_NUMSERI,F2_USRREG,D2_UOBSERV "//,c6_num,
...
TCQUERY cQuery NEW ALIAS "OrdenesCom"
 ...
 While OrdenesCom->(!EOF())
	...
	If _cTipoOp=='E'
	     ...
	     @ li,71 PSAY OrdenesCom->D1_QUANT	Picture	 "@E 999,999.99"
...
//		 @ li,20 PSay SubStr(cNumPart,1,15)		
   ...
   /*
	     ...
	     */
		 ...
		 @ li,21 PSay AllTrim(SubStr(OrdenesCom->B1_DESC,1,45))			
	     ...
	     @ li,71 PSay OrdenesCom->D2_QUANT Picture "@E 999,999.99"
	     @ li,83 PSay OrdenesCom->D2_UOBSERV
...
if OrdenesCom->cli1==OrdenesCom->cli2 
 ...
 @ 012,05 PSAY "Codigo" 
 @ 012,21 PSAY "Descripci๓n"
 @ 012,61 PSAY "UM"
 @ 012,71 PSAY "Cantidad"  
 @ 012,83 PSAY "Observ."																			
