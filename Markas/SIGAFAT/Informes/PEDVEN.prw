...
// cQuery += "INNER JOIN " + RetSqlName("SA1") + " SA1 ON A1_COD=C5_CLIENTE AND A1_LOJA = C5_LOJACLI and SA1.D_E_L_E_T_<>'*' and A1_Filial = C5_Filial "  
...
oPrn:SayBitmap(90,120, cFLogoMarkas,200,200)
...
oPrn:Say( Tpix(nLin+02.2), Tpix(14.0), "NIT: "+iif(!empty(C5_UNITCLI),AllTrim(C5_UNITCLI),AllTrim(A1_CGC)), oFont10CN)
