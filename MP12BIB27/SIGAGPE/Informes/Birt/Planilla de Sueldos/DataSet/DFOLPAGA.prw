...
Private cProcedim 	:= self:execParamValue("MV_PAR02")
...
/**
* Denar Terrazas 09/06/2022
* Valida que las sucursales informadas en los par·metros pertenezcan a la misma empresa
* y tambiÈn que sea la misma empresa en la que el usuario est· autenticado.
* Caso contrario, cierra la rutina.
**/
if( FindFunction("U_xVldComp") )
	U_xVldComp(cFilDe, cFilAte)
endIf
/**********************************************/
