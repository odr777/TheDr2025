...
±±ºProgram   ³GetCodigo  ºAuthor ³TdePº Date ³  12/05/2017 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Programa para colocar el Nombre y NIT a Facturar           º±±
±±º          ³                                               			  º±±
...
DEFINE MSDIALOG _oDlg TITLE "Datos del Cliente" FROM C(288),C(463) TO C(580),C(859) PIXEL
	...
	@ C(077),C(011) Say "Razón Social: " Size C(030),C(008) COLOR CLR_BLACK PIXEL OF _oDlg
