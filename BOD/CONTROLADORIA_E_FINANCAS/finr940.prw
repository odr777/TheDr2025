...
oSection1:= TRSection():New(oReport,STR0004,{cAliasTrb,"SE1","SA1"},/*aOrdem*/) // "Títulos a receber com retenção de Impostos"
...
//Secao - Resumo por cliente
oSection2:= TRSection():New(oSection1,STR0009,{cAliasTrb,"SE1","SA1"},/*aOrdem*/,/*Campos do SX3*/,/*Campos do SIX*/) //"Por Cliente
