...
//	TRCell():New(oSection2,"F1_DTLANC","SF1","FECHA FDSF.",PesqPict("SF1","F1_EMISSAO"),10,.F.,)
...
//	oSection0:Cell("F1_DTLANC"):SetBlock( { || aDados[F] })
	...
	While TMP0->(!Eof())
		...
		cQuery2+= " UNION "
		cQuery2+= " SELECT DISTINCT DBC_DESCRI,F2_FILIAL,'F2_UPOLIZA',F2_TIPODOC,F2_DOC,F2_SERIE,F2_CLIENTE F2_FORNECE,F2_LOJA,A2_NOME,F2_DTLANC,F2_EMISSAO,F2_VALMERC*-1 F2_VALMERC,F2_VALBRUT*-1 F2_VALBRUT,F2_ESPECIE,F2_MOEDA,F2_TXMOEDA, "
