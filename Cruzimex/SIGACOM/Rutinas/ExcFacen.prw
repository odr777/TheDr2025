...
±±ºPrograma  ³ImpFacen  ºAutor  ³Nahim Terrazas	 ºFecha ³  10/09/2019 º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Programa Importação de EXCLUSION Fatura de entrada         º±±
...
User Function ExcFacen
	...
	@ 018,018 Say "EXCLUSION DE Facturas de entrada desde un archivo *.csv"
			...
			For nX := 1 To Len(aTotCabs)
				...
				*/
				...
				If !SF1->(DbSeek(xFilial("SF1")+cxDocumento+cxSerie+cxProveedor+cxTienda))
					lError := .T.
					AutoGrLog( "La factura: " + cxDocumento + "/" + cxSerie + "NO EXISTE ya existe" )
					MostraErro()
					Return
				Endif
				...
				*/
				...
				MSExecAuto({|x,y,z,a| MATA101N(x,y,z,a)},aCabec,aLinha,5)
