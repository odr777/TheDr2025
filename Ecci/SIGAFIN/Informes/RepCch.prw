...
Static Function FA565Imp(lEnd,wnRel,cString)
	...
	While !Eof()
		...
		IF substr(ALLTRIM(SEU->EU_CAIXA),1,1)$'F'
			@ li,03 PSAY __PrtCenter("FONDOS A RENDIR")	// Descripción del tipo de recibo
		Else
			@ li,03 PSAY __PrtCenter("REPOSICIÓN DE CAJA CHICA")	// Descripción del tipo de recibo
		EndIf
		li++
