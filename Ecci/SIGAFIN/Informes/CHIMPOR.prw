...
static function CHEMat(aSef,cTitulo,bImprimir,nCopia,nLinInicial)
	...
	//Aviso("Array IVA",u_zArrToTxt(aSef, .T.),{'ok'},,,,,.t.)
...
Static Function chedetFact(nLinInicial,aMaestro)
	...
	do case
		...
		CASE "BCP" $ cBanco .or. "BANCO DE CREDITO" $ cBanco  //"036|037" //bcp
		oPrn:StartPage()
		...
		OTHERWISE
		MsgInfo ( "No se ha encontrado un formato de cheque para su banco, favor informar a TOTVS con un correo del formato requerido" , "Informacion TOTVS" )
		lRetFa := .f.
	ENDCASE
