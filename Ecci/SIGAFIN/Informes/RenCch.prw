...
Local aOrdem   := {STR0004,STR0005,"Nro.Rendición",STR0007}//"Fornecedor"###"Data De Digitacao"###"Tipo+Grupo+Codigo"###" Grupo+Codigo"
Local aArea	   := Getarea() 
Local aSB1Cod  := TamSX3("B1_COD")
Local aSB1Ite  := TAMSX3("B1_CODITE")
Local nTamCli  := Max(TAMSX3("A1_NOME")[1],TAMSX3("A2_NOME")[1])-15
Local cTitle   := "Rendición de Caja Chica"//STR0001 //"Relacao de Compras"
...
oReport:= TReport():New("RenCch",cTitle,"CCH090", {|oReport| ReportPrint(oReport,aOrdem,cAliasSD1)},STR0002+" "+STR0003) //"Este relatorio ira imprimir a relacao de itens referentes a compras efetuadas."
...
TRCell():New(oSection1,"D1_DOC"    ,"SD1",/*Titulo*/	,/*Picture*/, TamSX3("D1_DOC")[1]+5,/*lPixel*/, {|| IIf(!empty(F1_UDOC),F1_UDOC,D1_DOC) }) // Nahim
...
TRCell():New(oSection1,"F1_UNOMBRE"  ,"   ","Proveedor"		,/*Picture*/,40	,/*lPixel*/,{|| alltrim(F1_UNOMBRE) })
TRCell():New(oSection1,"F1_UNIT"  ,"   ","NIT"		,/*Picture*/,14	,/*lPixel*/,{|| alltrim(F1_UNIT) })
...
TRCell():New(oSection1,"D1_CC"     ,"SD1","Cod. CC"		,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) //RS
TRCell():New(oSection1,"CENTCOS"   ,"   ","Centro Costo",/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nCentCos })	//RS
TRCell():New(oSection1,"D1_ITEMCTA","SD1","Cod. I.Cta"	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/) //RS
TRCell():New(oSection1,"ITEMCTA"   ,"   ","Item Cuenta"	,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| nItemCta })	//RS

TRCell():New(oSection1,"F1_CODCTR"   ,"   ","Cod. Control" ,/*Picture*/,15/*Tamanho*/,/*lPixel*/,{|| alltrim(F1_CODCTR) })
TRCell():New(oSection1,"F1_NUMAUT"	  ,"   ","Num. Autoriz" ,/*Picture*/,15/*Tamanho*/,/*lPixel*/,{|| alltrim(F1_NUMAUT) })
TRCell():New(oSection1,"B1_CONTA"	  ,"   ","Cta.Ctb." ,/*Picture*/,15/*Tamanho*/,/*lPixel*/,{|| alltrim(IIf(!empty(D1_ITEMCTA),B1_UCTAPRO,IIF(!EMPTY(D1_CC),B1_UCTASED,B1_CONTA))) })
...
TRCell():New(oSection1,"D1_EMISSAO","SD1","Fch Emision"	,/*Picture*/,/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/)
TRCell():New(oSection1,"EU_CAIXA"   ,"","Caja"		,/*Picture*/,3/*Tamanho*/,/*lPixel*/,{|| EU_CAIXA })
TRCell():New(oSection1,"EU_NRREND"   ,"","Nro.Rend"		,/*Picture*/,15/*Tamanho*/,/*lPixel*/,{|| EU_NRREND })
TRCell():New(oSection1,"EU_HISTOR","","Historial",/*Picture*/,60/*Tamanho*/,/*lPixel*/,{|| alltrim(EU_HISTOR) })
...
oSection1:Cell("CENTCOS"):GetFieldInfo("D1_CC")	//RS
oSection1:Cell("ITEMCTA"):GetFieldInfo("D1_ITEMCTA")	//RS
...
TRCell():New(oSection2,"RAZAOSOC"  ,"   ",STR0027	 ,/*Picture*/,nTamCli	 ,/*lPixel*/,{|| cRazao })
...
TRCell():New(oSection2,"EU_CAIXA"   ,"","Caja"		,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| EU_CAIXA })
TRCell():New(oSection2,"EU_NRREND"   ,"","Nro.Rend"		,/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| EU_NRREND })
TRCell():New(oSection2,"EU_HISTOR","SD2", "Historial",/*Picture*/,/*Tamanho*/,/*lPixel*/,{|| EU_HISTOR })
...
oSection2:Cell("EU_NRREND"	):GetFieldInfo("EU_NRREND"	)
oSection2:Cell("EU_CAIXA"	):GetFieldInfo("EU_CAIXA"	)
...
oSection2:Cell("EU_HISTOR"	):GetFieldInfo("EU_HISTOR"	)
...
Local nImpos     := 0
Local nY         := 0
Local nDecs      := 2 //Msdecimais(mv_par09) //casas decimais utilizadas na moeda da impressao
Local oBreak
Local oBreak1    
Local oBreak2    
Local oBreak3    
...
#IFDEF TOP
	...
	cSelect1 += "D1_TOTAL,  D1_TES, D1_IPI,   D1_PICM,    D1_TIPO, D1_TP,      D1_GRUPO, D1_CUSTO, D1_LOCAL, D1_QTDEDEV, D1_ITEM, D1_UM,EU_HISTOR,EU_NRREND,F1_UDOC,EU_CAIXA,F1_UNOMBRE,F1_UNIT" 
	...
	SELECT D1_FILIAL, D1_DOC,     D1_SERIE,   D1_FORNECE, D1_LOJA, D1_DTDIGIT,    D1_COD,   D1_QUANT, D1_VUNIT,
		   D1_TOTAL,  D1_TES,     D1_IPI,     D1_PICM,    D1_TIPO, D1_TP,  D1_CC, D1_ITEMCTA, D1_GRUPO, D1_CUSTO, D1_LOCAL, D1_QTDEDEV, D1_ITEM,D1_UM,
	       F1_MOEDA,  F1_TXMOEDA, F1_DTDIGIT, B1_DESC,    B1_UM,   A2_NOME RAZAO, A2_NREDUZ RAZAORED, SD1.R_E_C_N_O_ SD1RECNO,
   	       B1_CODITE  D1_CODITE,  'F' TIPO, EU_HISTOR ,EU_NRREND,EU_CAIXA,F1_UNOMBRE,F1_UNIT,F1_CODCTR,F1_NUMAUT,B1_CONTA,B1_CONTA B1_UCTASED,B1_UCTAPRO,D1_EMISSAO ,D1_VALDESC, F1_DOC F1_UDOC
	       %Exp:cSelect%

	FROM %table:SF1% SF1 , %table:SD1% SD1 , %table:SB1% SB1 , %table:SA2% SA2, %table:SEU% SEU %Exp:cFrom%
   	...
   	WHERE SF1.F1_FILIAL   = %xFilial:SF1%   AND 
	      ...
	      SA2.%NotDel%                      AND
	      SEU.EU_NRCOMP = SF1.F1_DOC AND
	      SEU.EU_SERCOMP = SF1.F1_SERIE  AND
	      SEU.EU_FORNECE  =  SF1.F1_FORNECE AND
          SEU.EU_LOJA     =  SF1.F1_LOJA         AND
          SEU.%NotDel%    AND           
          SF1.F1_ESPECIE='NF' AND  
	      %Exp:cWhereSF4%
 	      SD1.D1_DTDIGIT >= %Exp:Dtos(mv_par01)% AND 
	      SD1.D1_DTDIGIT <= %Exp:Dtos(mv_par02)% AND
	      SEU.EU_CAIXA >= %Exp:mv_par03% AND
	      SEU.EU_CAIXA <= %Exp:mv_par04% AND
	      SEU.EU_NRREND = %Exp:mv_par06% 
...
#ELSE
	...
	cCondicao += 'Dtos(D1_DTDIGIT) >= "'+ Dtos(mv_par01) + '".And.Dtos(D1_DTDIGIT) <="'+ Dtos(mv_par02) + '".And.'
...
If nOrdem == 1
	...
	//TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"   } ) 
    //If cPaisloc <> "BRA"
		//TRFunction():New(oSection1:Cell("IMPNOINC"),NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F.) 
	//EndIf
	//TRFunction():New(oSection1:Cell("VALTOTAL"),NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    //If cPaisloc <> "BRA"
		//TRFunction():New(oSection1:Cell("IMPINC")  ,NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F.) 
	//EndIf
	//TRFunction():New(oSection1:Cell("VALCUSTO"),NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	...
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ	
	TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1QTD2"):GetValue() + oSection2:GetFunction("SD2QTD2"):GetValue() , oSection1:GetFunction("SD1QTD2"):ReportValue() + oSection2:GetFunction("SD2QTD2"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
	...
	EndIf
	TRFunction():New(oSection1:Cell("VALTOTAL"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1TOT2"):GetValue() + oSection2:GetFunction("SD2TOT2"):GetValue() , oSection1:GetFunction("SD1TOT2"):ReportValue() + oSection2:GetFunction("SD2TOT2"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
    ...
    EndIf
	//TRFunction():New(oSection1:Cell("VALCUSTO"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1CUS2"):GetValue() + oSection2:GetFunction("SD2CUS2"):GetValue() , oSection1:GetFunction("SD1CUS2"):ReportValue() + oSection2:GetFunction("SD2CUS2"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 		
...
//		TRFunction():New(oSection1:Cell("IMPNOINC"),NIL,"SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.F.) 
	...
	//³ Impressao dos totalizadores SD1 (-) SD2 Devolucoes.          ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ	
	TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|| oSection1:GetFunction("SD1QTD2"):GetValue() + oSection2:GetFunction("SD2QTD2"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
	...
	EndIf
	TRFunction():New(oSection1:Cell("VALTOTAL"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|| oSection1:GetFunction("SD1TOT2"):GetValue() + oSection2:GetFunction("SD2TOT2"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
    ...
    EndIf
	//TRFunction():New(oSection1:Cell("VALCUSTO"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|| oSection1:GetFunction("SD1CUS2"):GetValue() + oSection2:GetFunction("SD2CUS2"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 		
	TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"ONPRINT",oBreak3,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1QTD3"):GetValue() + oSection2:GetFunction("SD2QTD3"):GetValue() , oSection1:GetFunction("SD1QTD3"):ReportValue() + oSection2:GetFunction("SD2QTD3"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
	...
	EndIf
	TRFunction():New(oSection1:Cell("VALTOTAL"),NIL,"ONPRINT",oBreak3,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1TOT3"):GetValue() + oSection2:GetFunction("SD2TOT3"):GetValue() , oSection1:GetFunction("SD1TOT3"):ReportValue() + oSection2:GetFunction("SD2TOT3"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
    ...
    EndIf
	//TRFunction():New(oSection1:Cell("VALCUSTO"),NIL,"ONPRINT",oBreak3,,/*cPicture*/,{|lSection,lReport,lPage| If( !lReport, oSection1:GetFunction("SD1CUS3"):GetValue() + oSection2:GetFunction("SD2CUS3"):GetValue() , oSection1:GetFunction("SD1CUS3"):ReportValue() + oSection2:GetFunction("SD2CUS3"):ReportValue() ) },.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 		
...
ElseIf nOrdem == 3
	...
	//³ A ordem de chamada de cada TRFunction nao deve ser alterada, pois representa a ordem da celula gerada para planilha XML  ³
	//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
	TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"ONPRINT",oBreak1,,/*cPicture*/,{|| oSection1:GetFunction("SD1QTD1"):GetValue() + oSection2:GetFunction("SD2QTD1"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
	...
	EndIf
	TRFunction():New(oSection1:Cell("VALTOTAL"),NIL,"ONPRINT",oBreak1,,/*cPicture*/,{|| oSection1:GetFunction("SD1TOT1"):GetValue() + oSection2:GetFunction("SD2TOT1"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
    ...
    EndIf
	//TRFunction():New(oSection1:Cell("VALCUSTO"),NIL,"ONPRINT",oBreak1,,/*cPicture*/,{|| oSection1:GetFunction("SD1CUS1"):GetValue() + oSection2:GetFunction("SD2CUS1"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"   } ) 		
	TRFunction():New(oSection1:Cell("D1_QUANT"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|| oSection1:GetFunction("SD1QTD2"):GetValue() + oSection2:GetFunction("SD2QTD2"):GetValue() },.F.,.F. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
    If cPaisloc <> "BRA"
		TRFunction():New(oSection1:Cell("IMPNOINC"),NIL,"ONPRINT",oBreak2,,/*cPicture*/,{|| oSection1:GetFunction("SD1NIC2"):GetValue() + oSection2:GetFunction("SD2NIC2"):GetValue() },.F.,.F.) 
	EndIf
...
If nOrdem == 3 .Or. nOrdem == 4
	...
	TRFunction():New(oSection1:Cell("D1_QUANT"),"SD1QTD1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	TRFunction():New(oSection1:Cell("VALTOTAL"),"SD1TOT1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	//TRFunction():New(oSection1:Cell("VALCUSTO"),"SD1CUS1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	...
	TRFunction():New(oSection2:Cell("D2_QUANT"),"SD2QTD1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	TRFunction():New(oSection2:Cell("VALTOTAL"),"SD2TOT1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	//TRFunction():New(oSection2:Cell("VALCUSTO"),"SD2CUS1","SUM",oBreak1,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
...
TRFunction():New(oSection1:Cell("D1_QUANT"),"SD1QTD2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
TRFunction():New(oSection1:Cell("VALTOTAL"),"SD1TOT2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
//TRFunction():New(oSection1:Cell("VALCUSTO"),"SD1CUS2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
...
TRFunction():New(oSection2:Cell("D2_QUANT"),"SD2QTD2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
TRFunction():New(oSection2:Cell("VALTOTAL"),"SD2TOT2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
//TRFunction():New(oSection2:Cell("VALCUSTO"),"SD2CUS2","SUM",oBreak2,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } )
...
If nOrdem == 2 .Or. nOrdem == 3
	...
	TRFunction():New(oSection1:Cell("D1_QUANT"),"SD1QTD3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	TRFunction():New(oSection1:Cell("VALTOTAL"),"SD1TOT3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	//TRFunction():New(oSection1:Cell("VALCUSTO"),"SD1CUS3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
  ...
  //  oSection1:GetFunction("SD1CUS3"):Disable()
	...
	TRFunction():New(oSection2:Cell("D2_QUANT"),"SD2QTD3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	TRFunction():New(oSection2:Cell("VALTOTAL"),"SD2TOT3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
	//TRFunction():New(oSection2:Cell("VALCUSTO"),"SD2CUS3","SUM",oBreak3,,/*cPicture*/,/*uFormula*/,.F.,.T. ,,, {|| (cAliasSF4)->F4_AGREG <> "N"  } ) 
...
While !oReport:Cancel() .And. !(cAliasSD1)->(Eof())
	...
	lMoeda := .T.
	nCentCos := GetAdvFVal("CTT","CTT_DESC01",XFILIAL("CTT")+(cAliasSD1)->D1_CC		,1,"") //RS
	nItemCta := GetAdvFVal("CTD","CTD_DESC01",XFILIAL("CTD")+(cAliasSD1)->D1_ITEMCTA	,1,"") //RS
	...
	*/
        ...
        nValUnit := xmoeda((cAliasSD1)->(D1_VUNIT-D1_VALDESC),(cAliasSD1)->F1_MOEDA,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
        nValTot  := xmoeda((cAliasSD1)->(D1_TOTAL-D1_VALDESC),(cAliasSD1)->F1_MOEDA,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
		nValCusto:= xmoeda((cAliasSD1)->D1_CUSTO,1,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
		...
		If cPaisLoc <> "BRA"
			...
			For nY:=1 to Len(aImpostos)
				...
				nImpos:=&cCampImp
				nImpos:=xmoeda(nImpos,(cAliasSD1)->F1_MOEDA,mv_par05,(cAliasSD1)->F1_DTDIGIT,nDecs+1,(cAliasSD1)->F1_TXMOEDA)
				If ( aImpostos[nY][3]=="1" )
					nImpInc	+=nImpos
				Else
					If aImpostos[nY][3]=="2"
	...
	Else
		...
		nValUnit := xmoeda((cAliasSD1)->D1_VUNIT,SF1->F1_MOEDA,mv_par05,SF1->F1_DTDIGIT,nDecs+1,SF1->F1_TXMOEDA) 
		nValTot  := xmoeda((cAliasSD1)->D1_TOTAL,SF1->F1_MOEDA,mv_par05,SF1->F1_DTDIGIT,nDecs+1,SF1->F1_TXMOEDA) 
		nValCusto:= xmoeda((cAliasSD1)->D1_CUSTO,1,mv_par05,SF1->F1_DTDIGIT,nDecs+1,SF1->F1_TXMOEDA)
		...
		If cPaisLoc <> "BRA"
			...
			For nY:=1 to Len(aImpostos)
				cCampImp:=(cAliasSD1)+"->"+(aImpostos[nY][2])
				nImpos:=&cCampImp
				nImpos:=xmoeda(nImpos,SF1->F1_MOEDA,mv_par05,SF1->F1_DTDIGIT,nDecs+1,SF1->F1_TXMOEDA)
				If ( aImpostos[nY][3]=="1" )
					nImpInc	+=nImpos
				Else
					If aImpostos[nY][3]=="2"
...
Static Function CCHPerg()
_sAlias := Alias()
dbSelectArea("SX1")
dbSetOrder(1)
cPerg := PADR("CCH090",10)
aRegs:={}
...
//³ mv_par01             // De Fecha                           ³
//³ mv_par02             // A Fecha                         ³
//³ mv_par03             // De Caja Chica                                ³
//³ mv_par04             // A Caja Chica                          ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

aAdd(aRegs,{"01","De Fecha: ","mv_ch1","D",08,0,0,"G","mv_par01",""       ,""            ,""        ,""     ,""   ,""}) 
aAdd(aRegs,{"02","A  Fecha: ","mv_ch2","D",08,0,0,"G","mv_par02",""       ,""            ,""        ,""     ,""   ,""})
aAdd(aRegs,{"03","De Caja Chica: ","mv_ch3","C",03,0,0,"G","mv_par03",""       ,""            ,""        ,""     ,"SET"   ,""})
aAdd(aRegs,{"04","A Caja Chica: ","mv_ch4","C",03,0,0,"G","mv_par04",""       ,""            ,""        ,""     ,"SET"   ,""})
aAdd(aRegs,{"05","Moneda: ","mv_ch5","N",1,0,1,"C","mv_par05","BOLIVIANO"       ,"DOLAR"            ,""        ,""     ,"",""})
aAdd(aRegs,{"06","Nro.Rendición: ","mv_ch6","C",10,0,0,"G","mv_par06",""       ,""            ,""        ,""     ,"",""})


 
//aAdd(aRegs,{"07","De Sucursal       :","mv_ch7","C",2,0,0,"G","mv_par07",""       ,""            ,""        ,""     ,"SM0",""})
