...
±±³Funcao    ³ CTBC662 ³ Autor ³ TOTVS        	        ³ Data ³ 11.12.19 ³±±
...
static function llamaAsiento(aCpoOri,__aDocOri,__aLanCT2)
	...
	cPregNah:="CTR070"
	/*
		Nahim Cambio para imprimir directo 16/03/2021	
	*/
	M->DDATALANC := onModeloGrid:GetValueByPos(2,1)
	M->CLOTE := onModeloGrid:GetValueByPos(3,1)
	M->cSubLote := onModeloGrid:GetValueByPos(4,1)
	M->CDOC := onModeloGrid:GetValueByPos(5,1)
