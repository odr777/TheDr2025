...
Static Function PrintReport(oReport)
	...
	BeginSql alias "QRYTV2"
		...
		LEFT JOIN %Table:TQR% TQR ON ST9.T9_FILIAL = TQR_FILIAL AND ST9.T9_TIPMOD = TQR.TQR_TIPMOD AND TQR.%notDel%
		LEFT JOIN %Table:ST7% ST7 ON ST7.T7_FILIAL = ST9.T9_FILIAL AND ST7.T7_FABRICA = TQR.TQR_FABRIC AND ST7.%notDel%
