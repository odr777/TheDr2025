...
±±Programa  GPM060EX   Autor: Eduar Andia					Data 01.10.2019 ³±?
±±ÃÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±Descricao Punto de entrda para borrar títulos, tomando en cuenta la    	³±?
±±			reversión del asiento contable, cuando se haya generado.		³±?
...
±±? Omar D.	14/10/2019	No estaba borrando SE2 en los títulos que no 		³±?
±±?						generaron asientos en la integración. 				³±?
±±? Omar D.	14/10/2019	Establecer parámetro MV_GPEASIE con los tipos de	³±?
±±?						título que generan/revierten asiento contable		³±?
			...
			If lRetBx
				...
				While  SE2-> ( !Eof() ) .AND. SE2->E2_FILORIG = RC1->RC1_FILTIT .And. SE2->E2_NUM = RC1->RC1_NUMTIT .And. cPrefix == SE2->E2_PREFIXO
					...
					Else
						...
						// ODR 01/10/2019
						// Parámetro para tipo de título RC0 que debe generar/revertir Asiento 
						If Alltrim(SE2->E2_ORIGEM) == "GPEM670" .AND. SE2->E2_PREFIXO $ GetMV("MV_GPEASIE") 
							/*
							RecLock("SE2",.F.,.F.)
							dbDelete()
							MsUnLock()
