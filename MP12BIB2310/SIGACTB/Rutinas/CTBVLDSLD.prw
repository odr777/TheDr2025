...
±±ºModificaciones													      º±±
±±º			 ³ Omar Delgadillo  ³ Bolivia			 º Data ³ 22/05/2025  º±±
±±º			 ³ Se agreguó la rutina CTBA280 para que no sea considerada   º±±
±±º			 ³ en la actualización. 									  º±±	
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
...
If !(Funname()$"CTBA211|CTBA101|CTBA280")
