...
Static Function ReportDef()
	...
	TRCell():New(oSection,"QUIN_PAG",	"   ", "Quinq.Pagados",,10)
	TRCell():New(oSection,"ACUMFIN",	"   ", "Saldo en años")
	TRCell():New(oSection,"TIPO",		"   ", "Tipo Qui.")
...
Static Function QUIUXLSImp(lEnd,WnRel,cString)
	...
	BeginSql alias cQrySRA
		...
		QUIN_PAG, (CASE WHEN QUIN_PAG=5 THEN "QUINQUENIO" ELSE "ANTICIPO" END) TIPO, SUELD_PROM, IMP_QUIN, SUBSTRING(ULT_PAG,7,2) + '/' + SUBSTRING(ULT_PAG,5,2) + '/' + SUBSTRING(ULT_PAG,1,4) AS FECHAPAGO,
		...
		AND b.D_E_L_E_T_ = ' '
		AND SRV.D_E_L_E_T_ = ' '
		AND (RV_CODFOL='1274'  OR RV_COD='767')
