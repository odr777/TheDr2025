...
User Function IMPRESBOL()
	...
	oPrint:say(275,150,"ESTADO PLURINACIONAL DE",oFont08n)
	oPrint:say(305,275,"BOLIVIA",oFont08n)

	oPrint:say(275,1830,"MINISTERIO DE TRABAJO,",oFont08n)
	oPrint:say(305,1810,"EMPLEO Y PREVISION SOCIAL",oFont08n)
