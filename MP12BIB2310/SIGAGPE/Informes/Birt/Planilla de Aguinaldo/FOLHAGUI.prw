...
±±ºPrograma  ³ FOLHAGUI  ³Denar Terrazas		 º Data ³  20/01/2020     º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Llama Planilla de aguinaldo FOLHAGUI	                	  º±±
...
user function FOLHAGUI()

	local oReport
	cPerg   := "FOLHAGUI"   // elija el Nombre de la pregunta
	CriaSX1(cPerg)

	DEFINE user_REPORT oReport NAME FOLHAGUI TITLE "Planilla de aguinaldo" ASKPAR EXCLUSIVE

	ACTIVATE REPORT oReport LAYOUT FOLHAGUI FORMAT HTML
...
Static Function CriaSX1(cPerg)  // Crear Preguntas
	...
	*/
	...
	xPutSX1(cPerg,"16","¿Procedimiento?", "¿Procedimiento?"	,"¿Procedimiento?"	,"MV_CHG","C",03,0,0,"G","","SRY","","","MV_PAR16",""       ,""            ,""        ,""     ,""   ,"")
