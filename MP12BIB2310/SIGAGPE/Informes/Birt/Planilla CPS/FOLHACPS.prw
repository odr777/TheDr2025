...
user function FOLHACPS()

local oReport
cPerg   := "FOLHACPS"   // elija el Nombre de la pregunta
CriaSX1(cPerg)

DEFINE user_REPORT oReport NAME FOLHACPS TITLE "Planilla de sueldos" ASKPAR EXCLUSIVE

ACTIVATE REPORT oReport LAYOUT FOLHACPS FORMAT HTML
