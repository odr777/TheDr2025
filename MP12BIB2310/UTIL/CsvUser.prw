...
ฑฑบPrograma  บCSVUSER   บ Vanderlei Alves             บData ณ 09/11/15    บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบObjetivo  ณLista em formato CSV (Excel) todos os usuarios do arquivo   บฑฑ
ฑฑบ          ณde senhas do Protheus                                       บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบObs       ณUso Quata                                                   บฑฑ
...
User Function CSVUser()
	...
	@ 000,000 To 160,350 Dialog _WndMain TITLE "Rela็ใo de Usuแrios Protheus"
	@ 005,005 To 040,175
	@ 015,010 Say OemToAnsi("Este programa ira gerar um arquivo CSV (Excel), contendo a lista")
...
Static Function ProcSenhas()
	...
	Close(_WndMain)
	Processa({|| RunReport()},"Gerando lista em .....  \System\USERS.CSV" )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบFuncao    ณRunReport บAutor  ณ                    บ Data ณ             บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function RunReport()
	...
	For x := 1 To Len(aUsuario)
		...
		cTXT += cCargo + ";" + cEMail + ";" + AllTrim(Str(nConex)) + ";" + dtoc(dDataRef) + ";" + IIF(lStatus,"Bloq","Ativo") + ";"
