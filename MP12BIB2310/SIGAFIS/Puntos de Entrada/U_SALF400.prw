...
ฑฑบPrograma  SALF400  บAutor  ณOmar Delgadillo บFecha ณ  01/09/2022       บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณPunto de Entrada para traer el saldo desde la contabilidad  บฑฑ
ฑฑบ          ณpara el formulario 400									  บฑฑ
...
user function SALF400()
    Local cPeriodo  := paramixb[1]
    Local aFiliais  := paramixb[2]
    Local cCuenta   := Posicione("SZB",1,xFilial("SZB")+"FIS"+"012","ZB_CONTA") // "1010502002" // Cuenta de IUE a compensar IT
    Local nSaldoCF  := 0
    Local nI        := 0
    Local cQry      := ""
