...
±±ºPrograma  ³ RECIBOCOBR  ³Denar Terrazas		 º Data ³  24/01/18       º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDescricao ³ Llama Recibo de Cobranza		                			  º±±
...
local oReport
cPerg   := "RECIBOCOBR"   // elija el Nombre de la pregunta
CriaSX1(cPerg)

if(FUNNAME() == 'FINA087A')
	DEFINE user_REPORT oReport NAME RECIBOCOBR TITLE "Recibo de Cobranza" EXCLUSIVE
else
	DEFINE user_REPORT oReport NAME RECIBOCOBR TITLE "Recibo de Cobranza" ASKPAR EXCLUSIVE
endIf

ACTIVATE REPORT oReport LAYOUT RECIBOCOBR FORMAT HTML 
