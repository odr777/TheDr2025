...
User Function A085ATIT()
	...
	If _lPA
		...
		/* HERE, YOU CAN SAVE YOUR SPECIFIC COLUMNS ADDED ON A085CPOS */
		/* nro contrato, nro proyecto */
		//	RecLock('SEK',.F.)
		//	nPosObs := Ascan(aHeader,{|X| Alltrim(X[2]) == "EK_OBSBCO"})
		//	SEK->EK_OBSBCO := acols[1][nPosObs]
		//	SEK->(MsUnlock())
	EndIf		        
