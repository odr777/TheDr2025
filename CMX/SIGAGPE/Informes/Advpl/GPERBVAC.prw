...
ฑฑบObservacaoณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบModificacionesณ                                                        บฑฑ
ฑฑบOmar Delgadilloณ		Mejoras en formatoณ      	   บ Data ณ 10/08/2021บฑฑ
...
Static Function printVacaciones(nLinB, aDados)
	...
	oPrint:Say(nLinB + 750, 100 ,"Resumen Vacaciones" ,oFont11N)
	...
	for i:= 1 to Len(aVacPend)
		...
		oPrint:Say(nLinB + 750 + nline, 250 , " - ",oFont09)
	...
	oPrint:Say(nLinB + 750 + nline, 680, "dํas", oFont09N)

	oPrint:Say(nLinB + 750, 840, "Dํas Solicitados :" ,oFont09N)
	oPrint:Say(nLinB + 750, 1100, TRIM(cValtoChar(aDados[7])) ,oFont09)

	oPrint:Say(nLinB + 850, 840, "Desde el :" ,oFont09N)
	oPrint:Say(nLinB + 850, 1100, DTOC(STOD(aDados[5])),oFont09)

	oPrint:Say(nLinB + 950, 840, "Hasta el :" ,oFont09N)
	oPrint:Say(nLinB + 950, 1100, DTOC(STOD(aDados[6])),oFont09)
	...
	oPrint:Say(nLinB + 850, 1800 ,"Vacaciones en el Mes Vigente : " ,oFont09N)
	oPrint:Say(nLinB + 850, 2280 , cValtoChar(diasUtilizados(aDados[16], aDados[1], aDados[10])) ,oFont09)

	oPrint:Say(nLinB + 950, 1800 ,"NUEVO SALDO DISPONIBLE : " ,oFont09N)
