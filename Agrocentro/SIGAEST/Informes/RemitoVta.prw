...
@ nLin, 00 PSAY REPLICATE('-',213) 
  ...
  If mv_par04 == 2
  	//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  	@ nLin, 016 PSAY "CODIGO            DESCRIPCION                                              UNID.        CANTIDAD                            TES  "
  	//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	
  else
  	//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  	@ nLin, 016 PSAY "CODIGO            DESCRIPCION                      UNID.        CANTIDAD        VAL UNIT.        VALOR TOTAL     LOTE         VALIDEZ       TES     PED.COMPRA"
  	//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  end
  nLin := nLin+1
@ nLin, 00 PSAY REPLICATE('-',213) 
...
//	   	@ nLin, 078  PSAY RTRIM (aCod_Trib[I])
		...
		@ nLin, 092  PSAY aUnid_Pro[_I]
		//@ nLin, 077  PSAY aQtd_Pro[_I]               Picture"@E 999,999.99"
		@ nLin, 102  PSAY aQtd_Pro[_I]               Picture"@E 999,999.99"
		//@ nLin, 092  PSAY aPre_Uni[_I]               Picture"@E 99,999,999.99"
		//@ nLin, 110  PSAY aVal_Merc[_I]              Picture"@E 99,999,999.99"                  
		//@ nLin, 112  PSAY alltrim(aPre_Lot[_I])       
		//@ nLin, 119  PSAY alltrim(aPre_Fel[_I])       
		@ nLin, 140  PSAY cvaltochar(alltrim(aTES[_I]))
		If mv_par04 == 1
			@ nLin, 145  PSAY aPedido [_I]
...
ENDIF
	//@ L++, 62 PSAY REPLICATE('-',20)
	@ L++, 062 PSAY "--------------                           --------------                           --------------      "
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  	@ L, 062 PSAY "ELABORADO                                	AUTORIZADO                               CLIENTE   "
  	//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
