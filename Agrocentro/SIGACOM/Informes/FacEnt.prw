...
cQuery += "D1_ITEM,D1_COD,D1_UM,D1_QUANT,D1_VUNIT,D1_TOTAL,D1_PEDIDO,F1_NUMRA,A2_COD,A2_NOME,F1_MOEDA,E4_DESCRI,YA_DESCR,YA_SIGLA,A2_PAIS,D1_CC,D1_ITEMCTA,F1_NUMAUT,F1_CODCTR,F1_USRREG,F1_NODIA,D1_TES  "
...
Static Function fImpCab()
 ...
 @ 007,02 PSAY "Cod. Prov.: "  + OrdenesCom->A2_COD
 @ 007,90 PSAY "Fecha: " + ffechalatin(OrdenesCom->f1_EMISSAO) 
 @ 008,02 PSAY "Proveedor: "+Substr(OrdenesCom->A2_NOME,1,40)  
 @ 008,90 PSAY "Cod.Control: " + OrdenesCom->f1_CODCTR
 @ 009,02 PSAY OemToAnsi("Nro Autorizaci�n: ")  + OrdenesCom->F1_NUMAUT
 @ 009,90 PSAY "Moneda: " +iif(OrdenesCom->F1_MOEDA=1,'Bolivianos','Dolares')
 @ 010,02 PSAY OemToAnsi("Condici�n Pago: ") + OrdenesCom->E4_DESCRI
 @ 010,90 PSAY "Usuario: "+OrdenesCom->F1_USRREG
 @ 011,02 PSAY "Correlativo: "+OrdenesCom->F1_NODIA
