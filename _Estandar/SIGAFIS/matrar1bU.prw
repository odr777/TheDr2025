...
//-------------------------------------------------------------------------//
Static cPictVr := PesqPict("SF3","F3_VALCONT",TamSX3("F3_VALCONT")[1])
Static cPictNF	:= PesqPict("SF3","F3_NFISCAL" ,TamSX3("F3_NFISCAL")[1])
Static cPictAlq:= PesqPict("SF3","F3_ALQIMP1",TamSX3("F3_ALQIMP1")[1])
Static cPictDt := PesqPict("SF3","F3_ENTRADA",20)
Static cPictTP := PesqPict("SF2","F2_TIPO",TamSX3("F2_TIPO")[1])
Static nTam	:= TamSX3("F3_VALCONT")[1]
Static nTamNF	:= TamSX3("F3_NFISCAL")[1] +1
Static nTamTP  := TamSX3("F2_TIPO")[1]
...
/*/
User Function MatrAr1B() // U_MatrAr1B()
Local   I:=0
Local   lError  :=.T.
Local   nLoop := 0
Local   nOpcA := 0
...
if Len(aSelFil) > 1
	cTitulo += " SUCURSAL: AMBAS"
elseif Len(aSelFil) == 1
	if aSelFil[1] == '01'
		cTitulo += " SUCURSAL: SAN FRANCISCO"
	else
		cTitulo += " SUCURSAL: BUENOS AIRES"
	endif
endif
...
TRCell():New(oSection,"F3_FILIAL"  ,cAliasA2,"Suc."          ,/*Picture*/       ,4/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,,,)
TRCell():New(oSection,"A2_COD"     ,cAliasA2,"CODIGO"          ,/*Picture*/       ,IiF(AllTrim(STR(MV_PAR07)) $ "3|4", TamSX3("B1_COD")[1],)/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,,,)
TRCell():New(oSection,"A2_NOME"    ,cAliasA2,STR0006    ,/*Picture*/       ,20         ,/*lPixel*/,/*{|| code-block de impressao }*/,,,) //"DENOMINACION"
TRCell():New(oSection,"A2_AFIP"    ,cAliasA2,STR0049         ,/*Picture*/       ,2,/*lPixel*/,/*{|| code-block de impressao }*/,,,) //"TD"
...
TRCell():New(oSectionP,"A1_COD"     ,cAliasA,"CODIGO"          ,/*Picture*/       ,IiF(AllTrim(STR(MV_PAR07)) $ "3|4", TamSX3("B1_COD")[1],)/*Tamanho*/,/*lPixel*/,/*{|| code-block de impressao }*/,,,)
TRCell():New(oSectionP,"A1_NOME"    ,cAliasA,STR0006    ,/*Picture*/       ,20         ,/*lPixel*/,/*{|| code-block de impressao }*/,,,) //"DENOMINACION" 
TRCell():New(oSectionP,"cF3AlqIVA"  ,cAliasA,STR0013           ,cPictAlq          ,TamSX3("F3_ALQIMP1")[1],/*lPixel*/,/*{|| code-block de impressao }*/,,,"CENTER") //"% IVA"
TRCell():New(oSectionP,"F3_VALCONT" ,cAliasA,STR0014   ,/*Picture*/       ,15       ,/*lPixel*/,/*{|| code-block de impressao }*/,,,"CENTER") //"    TOTAL    "
TRCell():New(oSectionP,"cF3BaseIVA" ,cAliasA,STR0015   ,cPictVr       ,15       ,/*lPixel*/,/*{|| code-block de impressao }*/,,,"CENTER") //"   GRAVADO   "
TRCell():New(oSectionP,"nExenNoGrav",       ,STR0016   ,cPictVr           ,nTam       ,/*lPixel*/,/*{|| code-block de impressao }*/,,,"CENTER")   //"EXEN/NO GRAV "
...
For nJ := 1 To Len(aSucEmp[nLoop][1])
	...
	oReport:SetTitle(cTitulo+STR0002+Transform(mv_par01,"@D")+STR0003+Transform(mv_par02,"@D")+"] ")	//"Emissao do Livro Fiscal de Compras" //"Emision del Libro Fiscal de Compras"###" de ["###" até "
	...
	Endif
		...
		If mv_par03 == 1
			cQry2  := "SELECT SF3.F3_FILIAL,SA2.A2_COD,SA2.A2_NOME,SA2.A2_AFIP,SA2.A2_CGC,SA2.A2_TIPO,SF3.F3_CLIEFOR,SF3.F3_LOJA,SF3.F3_ENTRADA,SF3.F3_ESPECIE,SF3.F3_SERIE,SF3.F3_TPVENT,SF3.F3_RG1415, "
			If SerieNfId("SF3",3,"F3_SERIE")<>"S3_SERIE"
		...
		ElseIf mv_par03 == 2
			cQry2  := "SELECT SF3.F3_FILIAL,SA2.A2_COD,SA2.A2_NOME,SA2.A2_AFIP,SA2.A2_CGC,SA2.A2_TIPO,SF3.F3_CLIEFOR,SF3.F3_LOJA,SF3.F3_ENTRADA,SF3.F3_ESPECIE,SF3.F3_SERIE,SF3.F3_TPVENT,SF3.F3_RG1415,SF3.F3_EXENTAS, "
			If SerieNfId("SF3",3,"F3_SERIE")<>"S3_SERIE"
				cQry2 += "SF3."+SerieNfId("SF3",3,"F3_SERIE")+","
			EndIf
			...
			cQry2+="' AND SF3.F3_DTCANC <> ' ' AND SF3.F3_TIPOMOV = 'C' AND  SF3.F3_ESPECIE IN('NF','NDP','NCP','NCI','NDI') "
		ElseIf mv_par03 == 3
			cQry2  := "SELECT DISTINCT SF3.F3_FILIAL,SA2.A2_COD,SA2.A2_NOME,SA2.A2_AFIP,SA2.A2_CGC,SA2.A2_TIPO,SF3.F3_CLIEFOR,SF3.F3_LOJA,SF3.F3_ENTRADA,SF3.F3_ESPECIE,SF3.F3_SERIE,SF3.F3_TPVENT,SF3.F3_RG1415,SF3.F3_EXENTAS, "
			If SerieNfId("SF3",3,"F3_SERIE")<>"S3_SERIE"
				cQry2 += "SF3."+SerieNfId("SF3",3,"F3_SERIE")+","
			EndIf
			cQry2+= "SF3.F3_NFISCAL,SF3.F3_EMISSAO,SF3.F3_CFO,SUM(SF3.F3_VALMERC) F3_VALMERC,"
		...
		cQry2+= "GROUP BY SA2.A2_COD,SA2.A2_NOME,SA2.A2_AFIP,SA2.A2_CGC,SA2.A2_TIPO,SF3.F3_CLIEFOR,SF3.F3_LOJA,SF3.F3_ENTRADA,SF3.F3_ESPECIE,SF3.F3_EXENTAS,SF3.F3_SERIE,SF3.F3_TPVENT,SF3.F3_RG1415,SF3.F3_NFISCAL,SF3.F3_EMISSAO,SF3.F3_CFO,SF3.F3_FILIAL,"+cCampo
...
While !( cAliasA2 )->(Eof())
	...
	oReport:Section(1):Cell("F3_FILIAL"   ):SetValue((cAliasA2)->F3_FILIAL)
...
If nTotEXEN2 == 0 .and. cPaisLoc == "ARG" .and. nIVA == 0 .and. nIBP <> 0
...
If (cAliasA2)->F3_RG1415 == "066"
	nContab := (nResult*nSinal)+sfVrIVA2(cAliasA2)+sfVrIVAP2(cAliasA2)+sfVrIB2(cAliasA2)+sfVrEXCL2(cAliasA2)
EndIf
Return(nResult*nSinal)
...
Static Function CreaTemp(aTemp,cAliasTemp)
	...
	aAdd(aTemp,{ "A2_COD",  "C", TamSX3("A2_COD")[1],  TamSX3("A2_COD")[2]  })
	aAdd(aTemp,{ "A2_NOME", "C", TamSX3("A2_NOME")[1], TamSX3("A2_NOME")[2] })
	aAdd(aTemp,{ "A2_AFIP", "C", TamSX3("A2_AFIP")[1], TamSX3("A2_AFIP")[2] })
	aAdd(aTemp,{ "A2_CGC",  "C", TamSX3("A2_CGC")[1],  TamSX3("A2_CGC")[2]  })
	aAdd(aTemp,{ "A2_TIPO", "C", TamSX3("A2_TIPO")[1], TamSX3("A2_TIPO")[2] })

	For nI := 1 To Len(aEstrSF3)
		aAdd(aTemp, { aEstrSF3[nI][1], aEstrSF3[nI][2], aEstrSF3[nI][3], aEstrSF3[nI][4] })
	Next

	aAdd(aTemp,{ "SUCURSAL", "C", TamSX3("F3_FILIAL")[1], TamSX3("F3_FILIAL")[2] })
