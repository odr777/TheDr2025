...
//-------------------------------------------------------------------------//
Static cPictVr := PesqPict("SF3","F3_VALCONT")
Static cPictNF	:= PesqPict("SF3","F3_NFISCAL")
...
oReport:SetCustomText( {|| CabecAR1B(oReport) })
...
±±³Fun‡„o    ³ Cabec262   ³ Autor ³ Omar Delgadillo     ³ Data ³ 24.10.24 ³±±
...
ßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßßß
*/
Static Function CabecAR1B( oReport )
	Local aArea		:= GetArea()
	Local aCabec	:= {}
	...
	cPagina := RptFolha + TRANSFORM(oReport:Page(),'999999') + " ."	
	cTitulo := STR0001 + STR0002 + Transform(mv_par01,"@D") + STR0003 + Transform(mv_par02,"@D")+"] "
	...
	aCabec := {	"__LOGOEMP__"; 
				, cChar + "         " + cChar + cPagina ;
				, cChar + "         " + UPPER(AllTrim(cTitulo)) + "         " + cChar;
				, Trim(SM0->M0_FILIAL) ;
				, "CUIT: " + Transform( Alltrim( SM0->M0_CGC ), alltrim( SX3->X3_PICTURE ))}
	RestArea( aArea )
Return aCabec
