...
Static Function PrintReport(oReport)
	...
	cQuery+= " FROM ( "
	cQuery+= " SELECT TC.RA_FILIAL, TC.RA_MAT, TC.RA_NOME, TC.RA_ADMISSA, TC.RA_DEMISSA, SP9.P9_IDPON, (SPC.PC_QUANTC- COALESCE(SPK.PK_HRSABO,0)) PC_QUANTC, TC.RCG_DIAMES, "
