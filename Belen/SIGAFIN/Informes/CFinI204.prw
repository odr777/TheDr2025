...
static function f4_ROfC3(cTitulo,bImprimir)
	...
	_csql := "SELECT "  + Chr(13)
	_csql := _csql + " CTO_SIMB, CTO_DESC, M2_MOEDA2,  EL_MOEDA,EL_CONTA, " + Chr(13)
	...
	_csql := _csql + " EL_USERLGI, EL_USERLGA,EL_COBRAD,EL_UNOMD, " + Chr(13)
	_csql := _csql + " EL_UCAMBIO,EL_VALOR,EL_UOBSTAR,EL_SERIE,EL_PREFIXO" + Chr(13)
	...
	_csql := _csql + " INNER JOIN " + RetSqlName("SA1") + " SA1 ON A1_COD = EL_CLIORIG AND A1_LOJA = EL_LOJORIG AND SA1.D_E_L_E_T_ = ' '" + CHR(13)
	...
	_csql2 := _csql2 + " EL_UCAMBIO,EL_VALOR,EL_UOBSTAR,EL_PREFIXO " + Chr(13)
	_csql2 := _csql2 + " FROM " + RetSqlName("SEL") + " SEL " + Chr(13)
	_csql2 := _csql2 + " LEFT JOIN " + RetSqlName("CTO") + " CTO ON CAST(CTO_MOEDA AS TinyInt) = EL_MOEDA AND CTO.D_E_L_E_T_ = ' '" + Chr(13)
...
//	_csql2 := _csql2 + " E1_PREFIXO + E1_NUM + E1_PARCELA + E1_TIPO = EL_PREFIXO + EL_NUMERO + EL_PARCELA + EL_TIPO AND EL_RECIBO=E1_RECIBO " + CHR(13)nahim quitando recibo 03/05/2019
	_csql2 := _csql2 + " E1_PREFIXO = EL_PREFIXO AND E1_PARCELA = EL_PARCELA AND EL_TIPO = E1_TIPO AND EL_NUMERO = E1_NUM AND SE1.D_E_L_E_T_ = ' '  " + CHR(13)  
	_csql2 := _csql2 + " LEFT JOIN " + RetSqlName("SA1") + " SA1 ON  A1_COD = E1_CLIENTE AND A1_LOJA =E1_LOJA   AND SA1.D_E_L_E_T_ = ' ' " + CHR(13)
	// Desde aca necesito diferenciarlo ya que luego necesitare tomar de todos los pedidos especificos...
	_csql2 := _csql2 + " WHERE   " + CHR(13)
	_csql2 := _csql2 + " EL_FILIAL = '" + _xfilial + "' AND EL_SERIE='"+ _cSerie +"'"
