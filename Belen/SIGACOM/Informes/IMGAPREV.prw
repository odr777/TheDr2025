...
Static Function ReportPrint(oReport)
	...
	cQuery2+= " AND F1_SERIE = D1_SERIE AND F1_FORNECE = D1_FORNECE AND F1_LOJA = D1_LOJA AND D1_COD LIKE 'GI%' AND SD1.D_E_L_E_T_ != '*' LEFT JOIN SA2010 SA2 ON F1_FORNECE = A2_COD AND F1_LOJA = A2_LOJA "
