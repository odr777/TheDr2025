...
WSMETHOD GET WSSERVICE CLIENTES
	...
	BeginSQL Alias cNextAlias
		SELECT TOP 1000 A1_COD, A1_LOJA, RTRIM(A1_NOME) A1_NOME, A1_END, A1_CGC, A1_EST, A1_TEL,A1_MUN,A1_TABELA,A1_CONTA ,A1_COND ,A1_NREDUZ,RTRIM(A1_UNOMFAC) A1_UNOMFAC
		FROM %table:SA1% SA1
