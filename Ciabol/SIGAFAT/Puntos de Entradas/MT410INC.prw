...
user function MT410INC()
	...
	If(FUNNAME()=="PMSA600")
		Do while lN <= Len(aCols)
			...
			_cQuantIt:= aCols[lN][nPosQuant]

			cRevisa := AF8->AF8_REVISA
			cTot := Posicione("AF9",1,xFilial("AF9")+ _cProy+ cRevisa + _cTask,"AF9_TOTAL")//valor total
			...
			aAdd( aRotAut, { "AFF_QUANT" ,nQuantTot,})  //obrigat๓rio
