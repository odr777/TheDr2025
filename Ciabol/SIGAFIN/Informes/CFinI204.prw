...
static function f4_ROfC3(cTitulo,bImprimir)
	...
	_csql := _csql + " INNER JOIN " + RetSqlName("CTO") + " CTO ON CAST(CTO_MOEDA AS TinyInt) = EL_MOEDA AND CTO.D_E_L_E_T_ = ' ' AND SEL.EL_FILIAL = CTO.CTO_FILIAL " + Chr(13)
...
//	aviso("",_csql,{'ok'},,,,,.t.)
	...
	_csql2 := _csql2 + " INNER JOIN " + RetSqlName("CTO") + " CTO ON CAST(CTO_MOEDA AS TinyInt) = EL_MOEDA AND CTO.D_E_L_E_T_ = ' ' AND SEL.EL_FILIAL = CTO.CTO_FILIAL " + Chr(13)
