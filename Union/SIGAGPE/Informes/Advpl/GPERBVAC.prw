...
Static Function printVacaciones(nLinB, aDados)
	...
	//cuadro
	oPrint:Box(nLinB + 500, 50 , nLinB + 1350 + nAumento , 2500)
	oPrint:Box(nLinB + 700 , 800, nLinB + 1350 + nAumento, 800)	// vertical line

	oPrint:Box(nLinB + 1500 + nAumento , 50 , nLinB + 1500 + nAumento, 575)
	oPrint:Say(nLinB + 1530 + nAumento , 100 ,"Registrado por " + UsrRetName(RetCodUsr()) ,oFont09N)
	oPrint:Box(nLinB + 1500 + nAumento , 650 , nLinB + 1500  + nAumento, 1215)
	oPrint:Say(nLinB + 1530 + nAumento , 810 ,"Autorizado por" ,oFont09N)
	oPrint:Box(nLinB + 1500 + nAumento , 1285 ,nLinB + 1500  + nAumento, 1850)
	oPrint:Say(nLinB + 1530 + nAumento , 1495 ,"VO.BO" ,oFont09N)
	oPrint:Box(nLinB + 1500 + nAumento , 1925 ,nLinB + 1500  + nAumento, 2500)
	oPrint:Say(nLinB + 1530 + nAumento , 2105  ,"Empleado(a)" ,oFont09N)
