...
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma  ณFINA087A  ณAutor  ณGuilherme C. Leal       ณ Data ณ  05/27/01   ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDesc.     ณ Rotina baseada na FINA087. Serve para gera็ใo de Recibos.      ณฑฑ
...
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณProgramador  ณ Data   ณ   BOPS   ณ  Motivo da Alteracao                	  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณJ.Aurelio    ณ01/11/01ณNC001503  ณEm atualizacao bancaria, o "if" so a per-ณฑฑ
ฑฑณ             ณ        ณ          ณmite quando nTipo == 2, e a data de baixaณฑฑ
ฑฑณ             ณ        ณ          ณesta pegando do arquivo SEL.             ณฑฑ
ฑฑณJ.Aurelio    ณ03/12/01ณ11894     ณEm Fa087aTudoOk, nao permitit que se ava ณฑฑ
ฑฑณ             ณ        ณ          ณ-nce p/ segundo processo se data emissao ณฑฑ
ฑฑณ             ณ        ณ          ณestiver vazia.                           ณฑฑ
ฑฑณSergio F.    ณ20/02/02ณ13395     ณAjuste na emissao do Recibo com o tipo   ณฑฑ
ฑฑณ             ณ        ณ          ณ"EF".                                    ณฑฑ
ฑฑณPaulo Aug.   ณ07/08/02ณ          ณInclusao do Cobrador e Calculo da Comis. ณฑฑ
ฑฑณ             ณ        ณ          ณpara ele                                 ณฑฑ
ฑฑณC.Denardi    ณ19/08/03ณ66207     ณInclusao da opcao de modificar as colun. ณฑฑ
ฑฑณ             ณ        ณ          ณexibidas do SA1,SE1, gravando no profile ณฑฑ
ฑฑณC.Denardi    ณ11/09/03ณ66637     ณRetirar campo Memo do TwBrowse em SA1,SE1ณฑฑ
ฑฑณWagner       ณ08/06/10ณ          ณImplementado campo Naatureza no Recibo   ณฑฑ
ฑฑณMontenegro   ณ        ณ          ณImplementado tributa็ใo e contabiliza็ใo ณฑฑ
ฑฑณ             ณ        ณ          ณdo ITF.                                  ณฑฑ
ฑฑณ             ณ        ณ          ณImplementado consistencia na sele็ใo de  ณฑฑ
ฑฑณ             ณ        ณ          ณBancos X Natureza e Bancos X Tipo Valor  ณฑฑ
ฑฑณRenan        ณ14/03/11ณ          ณARG = Novo painel de resumo de reten็๕es ณฑฑ
ฑฑณGuedes       ณ        ณ          ณe simula็ใo da contabiliza็ใo.		      ณฑฑ
ฑฑณMarco A. Glz ณ06/04/17ณ MMI-4476 ณSe replica llamado(TTREB6 - V11.8), El   ณฑฑ
ฑฑณ             ณ        ณ          ณcual prevee la funcionalidad para Certi- ณฑฑ
ฑฑณ             ณ        ณ          ณficados de Retencion SUSS. (ARG)         ณฑฑ
ฑฑณMarco A. Glz ณ27/04/17ณ MMI-4152 ณSe replica llamado(TTXEFA - V11.8),      ณฑฑ
ฑฑณ             ณ        ณ          ณfuncionalidad de calculo de comisiones   ณฑฑ
ฑฑณ             ณ        ณ          ณpara vendedores en base al tipo de cambioณฑฑ
ฑฑณ             ณ        ณ          ณutilizado en la emision de factura. (MEX)ณฑฑ
ฑฑณMarco A. Glz ณ09/05/17ณ  MMI-143 ณSe replica llamado(TTDBMT - V11.8), Se   ณฑฑ
ฑฑณ             ณ        ณ          ณrealiza la denotacion de la rutina de    ณฑฑ
ฑฑณ             ณ        ณ          ณCobros Diversos desde MATA465N. (MEX)    ณฑฑ
ฑฑณL. Samaniego ณ27/09/17ณTSSERMI01 ณModificaciones para Mexico "Complemento  ณฑฑ
ฑฑณ             ณ        ณ-153      ณde Recepi๓n de Pagos                     ณฑฑ
ฑฑณL. Samaniego ณ21/12/17ณDMICNS-445ณSe modifica cuando pertenece a pais CHILEณฑฑ
ฑฑณ             ณ        ณ          ณy el arreglo anBaixa pierde Decimales aunณฑฑ
ฑฑณ             ณ        ณ          ณcuando no se contienen decimales en las  ณฑฑ
ฑฑณ             ณ        ณ          ณposiciones del Arreglo.                  ณฑฑ
ฑฑณ  Marco A.   ณ19/02/18ณDMINA-556 ณSe replican para V12.1.17, los issues:   ณฑฑ
ฑฑณ             ณ        ณ          ณ DMINA-385, DMINA-602,  DMINA-723,       ณฑฑ
ฑฑณ             ณ        ณ          ณ DMINA-814, DMINA-1171, DMINA-1223,      ณฑฑ
ฑฑณ             ณ        ณ          ณ DMINA-1255, DMINA-1166 y DMINA-1093;    ณฑฑ
ฑฑณ             ณ        ณ          ณ para Complemento de Pago CFDI 3.3 (MEX) ณฑฑ
ฑฑณMarcos Aur   ณ22/03/18ณDMICNS-   ณEfetuado ajustes para uso de tabelas     ณฑฑ
ฑฑณ             ณ        ณ  1588    ณtemporarias - Arg                        ณฑฑ
ฑฑณLuis Enriquezณ05/04/18ณDMINA-2437ณSe agregan cambios de soluci๓n del issue ณฑฑ
ฑฑณ             ณ        ณ          ณMMI-6165 error log recibos con ret. (PER)ณฑฑ
ฑฑณLuis Enriquezณ24/04/18ณDMINA-2636ณSe elimina paํs VEN de bifurcaci๓n en la ณฑฑ
ฑฑณ             ณ        ณ          ณfunc. Fa087aSalvar para permitir genera- ณฑฑ
ฑฑณ             ณ        ณ          ณci๓n de RA sin documentos. (VEN)         ณฑฑ
ฑฑณLuis Enriquezณ17/05/18ณDMINA-3080ณSe agrega funcionalidad a rutina para queณฑฑ
ฑฑณ             ณ        ณ          ณsea utilizada como Adapter de integraci๓nณฑฑ
ฑฑณ             ณ        ณ          ณEAI para baja de tํtulos generados desde ณฑฑ
ฑฑณ             ณ        ณ          ณotros sistemas marca Totvs (MEX)         ณฑฑ
ฑฑณOscar Garcia ณ31/05/18ณDMINA-3209ณSe muestra Serie2 en pantalla registro deณฑฑ
ฑฑณ           	ณ        ณ        	ณimportes de ret. y se guarda FE_SERIE2   ณฑฑ
ฑฑณ           	ณ        ณ        	ณcon valor de parแmetro MV_CRSERIE (PER)  ณฑฑ
ฑฑณOscar Garcia ณ23/06/18ณDMINA-2916ณCorreci๓n DMINA-2898 En func. Fa087aRet  ณฑฑ
ฑฑณ           	ณ        ณ        	ณse hace modificaci๓n para obtener serie 2ณฑฑ
ฑฑณ           	ณ        ณ        	ณde acuerdo a pos en aCposSE1 (PER)       ณฑฑ
ฑฑณ           	ณ        ณ       	ณvalide solo los doctos de tipo NF NCC NCDณฑฑ
ฑฑณM.Camargo 	ณ06/04/18ณDMINA-3465ณMex. func FA087aHead asigna Campos Memo  ณฑฑ
ฑฑณ           	ณ        ณ        	ณEn func Fa087aLinOk se validan campos CEPณฑฑ
ฑฑณ           	ณ        ณ        	ณSe agrega func FN087AWHEN que activa o   ณฑฑ
ฑฑณ           	ณ        ณ        	ณdesactiva los campos Relacionados al CEP ณฑฑ
ฑฑณ          	ณ        ณ        	ณSe documenta indice SX3 en Fa087aLinOk   ณฑฑ
ฑฑณ          	ณ        ณ        	ณSe modifica funci๓n Fa087aSalvar,        ณฑฑ
ฑฑณ          	ณ        ณ        	ณal momento de generar el registro en SEL ณฑฑ
ฑฑณ          	ณ        ณ        	ณpara el tํtulo en baja coloca el cliente ณฑฑ
ฑฑณ             ณ        ณ          ณy tienda origen en los campos EL_CLIENTE ณฑฑ
ฑฑณ             ณ        ณ          ณy EL_LOJA, y viceversa.                  ณฑฑ
ฑฑณGSantacruz	ณ03/07/18ณ        	ณVenezuela: Para pagos de tipo IR no debe ณฑฑ
ฑฑณ             ณ        ณ          ณguardar retenciones (SFE).               ณฑฑ
ฑฑณ  Marco A.   ณ11/07/18ณDMANSISTE-ณSe reliza replica de solucion realizada  ณฑฑ
ฑฑณ             ณ        ณ21        ณen issue DMINA-1340 (V12.1.14). Grabacionณฑฑ
ฑฑณ             ณ        ณ          ณcorrecta de E5_DOCUMEN. (MEX)            ณฑฑ
ฑฑณLuisEnrํquez ณ19/07/18ณDMINA-3630ณse modifica la funcion A087aPagtos para  ณฑฑ
ฑฑณ             ณ        ณ          ณgenerar la RA, al compensar el anticipo yณฑฑ
ฑฑณ             ณ        ณ          ณy se agrega la funcion fVerifImp la cual ณฑฑ
ฑฑณ             ณ        ณ          ณvalida la resta o no del IGV a generar laณฑฑ
ฑฑณ             ณ        ณ          ณRA del anticipo.                         ณฑฑ
ฑฑณ    Nancy    ณ24/07/18ณDMANSISTE-ณSe agrega validacion, para no solicitar  ณฑฑ
ฑฑณ             ณ        ณ36        ณel procedo de timbrado mas de una vez,   ณฑฑ
ฑฑณ             ณ        ณ          ณtras compensar NCC. (MEX)                ณฑฑ
ฑฑณLuis Enrํquezณ23/08/18ณDMINA-3641ณSe agrega validaci๓n para que s๓lo si se ณฑฑ
ฑฑณ             ณ        ณ          ณdan de baja titulos de origen FINI05 o   ณฑฑ
ฑฑณ             ณ        ณ          ณFINI040 se dispare integraci๓n EAI (MEX) ณฑฑ
ฑฑณOscar Garcia ณ03/09/18ณDMINA-3912ณSe llama la funci๓n FIS815PatCta() para  ณฑฑ
ฑฑณ           	ณ        ณ        	ณvalidar los campos EL_CTAORD y EL_CTABEN ณฑฑ
ฑฑณ           	ณ        ณ        	ณen funcion FN087AWHEN()                  ณฑฑ
ฑฑณ   Marco A.  ณ07/09/18ณDMINA-3961ณSe modifica Func FN087AWHEN()cuando Formaณฑฑ
ฑฑณ             ณ        ณ          ณPago = Cheque(02) se obtienen Valores delณฑฑ
ฑฑณ             ณ        ณ          ณBanco Cheque, si ้ste no tiene valores   ณฑฑ
ฑฑณ             ณ        ณ          ณse obtienen del Banco beneficiario veri- ณฑฑ
ฑฑณ             ณ        ณ          ณficando si el banco es Extranjero.  (MEX)ณฑฑ
ฑฑณOscar Garcia ณ21/09/18ณDMINA-3950ณSe modifica func Fa087aSalvar para no so-ณฑฑ
ฑฑณ             ณ        ณ          ณlicitar confirmacion al generar compleme-ณฑฑ
ฑฑณ             ณ        ณ          ณnto si parametro MV_CFDREC == 1          ณฑฑ
ฑฑณOscar Garcia ณ27/09/18ณDMINA-4214ณA la funciion GETUIID se le pasa como pa-ณฑฑ
ฑฑณ             ณ        ณMEX       ณrametro la filial de SE1, contenida en elณฑฑ
ฑฑณ             ณ        ณ          ณarreglo. Replica DMINA-4081              ณฑฑ
ฑฑณ  Marco A.   ณ01/10/18ณDMINA-4322ณSe replica a V12.1.17, la solucion reali-ณฑฑ
ฑฑณ             ณ        ณ          ณzada en DMINA-4354 de V11.8. (MEX)       ณฑฑ
ฑฑณVeronica F.  ณ19/10/18ณDMINA-3975ณSe replica a v12.1.17, la solucion reali-ณฑฑ
ฑฑณ             ณ        ณ          ณzada en DMINA-3439 y del DMINA-3969      ณฑฑ
ฑฑณ             ณ        ณ          ณde v12.1.14 (PER)                        ณฑฑ
ฑฑณLuis Enrํquezณ24/10/18ณDMINA-4839ณSe modifica GetUUID para tomar en cuenta  ฑฑ
ฑฑณ             ณR้plica ณDMINA-4615ณPE A087TIPTI para validar que docs se en-ณฑฑ
ฑฑณ             ณ        ณ        	ณcuentre timbrado, tipos FI (MEX)         ณฑฑ
ฑฑณM.Camargo    ณ07/11/18ณDMINA-4839ณSe modifica funci๓n MontaTela para quitar|ฑฑ
ฑฑณ             ณ        ณ        	ณcondici๓n de llenado de array aCposSE1   ณฑฑ
ฑฑณ             ณ        ณ        	ณpara que siempre considere campo filial  ณฑฑ
ฑฑณ             ณ        ณ        	ณindependiente del parแmetro MV_PAR09     ณฑฑ
ฑฑณ             ณ        ณ        	ณฟConsidera Filial?                       ณฑฑ
ฑฑณLuis Enrํquezณ08/11/18ณDMINA-5004ณSe modifica GetUUID para validar timbradoณฑฑ
ฑฑณ             ณ        ณ          ณde docs generados en SIGALOJA con usuarioณฑฑ
ฑฑณ             ณ        ณ          ณcaja y no caja.                  (MEX)   ณฑฑ
ฑฑณLuis Enrํquezณ29/11/18ณDMINA-4830ณSe activan campos EL_SERSUS y EL_RECSUS  ณฑฑ
ฑฑณ             ณ        ณ          ณy se agrega func. F87AValRec para funcio-ณฑฑ
ฑฑณ             ณ        ณ          ณde documentos relacionados CFDI 3.3 (MEX)ณฑฑ
ฑฑณM.Camargo    ณ06/12/18ณDMINA-5205ณSe agregan todas las formas de pago ban- ณฑฑ
ฑฑณ             ณ        ณ          ณcarizadas que indiques cuanta ordenante yณฑฑ
ฑฑณ             ณ        ณ          ณrfc cuenta ordenante igual que forma de  ณฑฑ
ฑฑณ             ณ        ณ          ณpago cheque en la funci๓n  FN087AWHEN    ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
//Function Fina087a(cNumFatAut,cDadosAdt,aRecAdt)
user Function xFina087a(cNumFatAut,cDadosAdt,aRecAdt,oPagVenNT)// Nahim Adicionando el objeto JSON para
	...
	Local nJ			:= 0
	Local nNumTb		:= 9 // Numero de tablas asignadas al arreglo aCtbTmp en funci๓n FA87aCtbA
	...
	//	DEFAULT cNumFatAut	:= "" NAHIM CAMBIANDO POR PRIVATE
	//	DEFAULT cDadosAdt	:= "" NAHIM CAMBIANDO POR PRIVATE
	//	DEFAULT aRecAdt		:= {} NAHIM CAMBIANDO POR PRIVATE
	Private cNumFatAut	:= "" // Nahim
	Private cDadosAdt	:= "" // Nahim
	Private aRecAdt		:= {} // Nahim
	Private OPagBajasNT := oPagVenNT // Nahim Objeto que realiza el pago
	Private cRetorno := ""// Nahim indica el nro del recibo
	Private cIdTransc := cvaltochar(Randomize(1,34000)) // Nahim adicionando el ID por transacci๓n
	//Declara las variables conforme el n๚mero de tablas asignadas al arreglo aCtbTmp en funci๓n FA840aCtbA
	For nJ := 1  to nNumTb
		Private &(cNomObjT + alltrim(str(nJ))) := NIL
	Next
	if type("OPagBajasNT:FECHA") <> "U"
		cDataFact:= OPagBajasNT:FECHA
		dDataFact := CTOD(cDataFact)
		ddatabase := dDataFact
	endif
	if type("OPagBajasNT:DDATABASE") <> "U"
		cDataFact:= OPagBajasNT:DDATABASE
		dDataFact := CTOD(cDataFact)
		ddatabase := dDataFact
	endif
	/*
	...
	*/
	...
	//ณCaso seja passado um numero de titulo verifica sua existencia.     ณ
...
//	lDigita  	:= If( mv_par01==1,.T.,.F.)  // Mostra Lanctos.
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณVerifica no Sigamat.acs se o usuario tem acesso เ baixa de titulos.ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	IF Versenha(30)
		if !lCancel //NAHIM SACANDO WHILE 29/09/2019
//		While !lCancel //NAHIM SACANDO WHILE 29/09/2019
			lCancel := .T.
			//
			cRetorno := MontaTela(cNumFatAut,cCodCliTit,cLojCliTit,cCgcCPFTit,cNomCliTit,cTelCliTit,lIncAdt,aRecAdt) // nahim agregando respuesta (Nro de recibo + Serie
			return cRetorno // Nahim agregando return
			...
			If lCarga
				...
				Return !lCancel
			EndIf
		endif //NAHIM SACANDO WHILE 29/09/2019
//		Enddo NAHIM SACANDO WHILE 29/09/2019
		If !SuperGetMv('MV_SERREC') .And. __lSX8
			While ( GetSX8Len() > nSaveSX8 )
				RollBackSX8()
			Enddo
		EndIf
	Else
		Alert(STR0001) //"Usuario sem permissใo para acesso เ essa rotina, verifique os acessos do usuario no Configurador."
	Endif
...
ฑฑบPrograma  ณMontaTela บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta tela de operacao do Recibo.            			  บฑฑ
...
STATIC Function MontaTela(cNumFatAut,cCodCliTit,cLojCliTit,cCgcCPFTit,cNomCliTit,cTelCliTit,lIncAdt,aRecAdt)
	...
	//ณ Faz a montagem da tela e seus objetos.                ณ
	...
	Private aTitulo:={STR0002,STR0003,STR0004,STR0005,STR0171,STR0172}		//"Recibo [Resumo de Reten็๕es]"##"Resumo [Simula็ใo da Contabiliza็ใo]"
	Private cTipos := ""
	Private aRLocks	:=	{}
	Private nPosCli	:= 0
	Private nPosLoja	:= 0
	...
	Private nPanel	 := 1
	Private oPesq
//	Private cSerie  	:=	"A"// NAHIM Criavar("EL_SERIE")
	Private cSerie  	:=	OPagBajasNT:SERIE // NAHIM Criavar("EL_SERIE")
...
//	Private cCliente 	:=	"30816 "// Nahim Toma el cliente Space(TamSX3("EL_CLIENTE")[1])
//	Private cLoja		:=	"01"// Nahim toma la tienda //Space(TamSX3("EL_LOJA")[1])
//	private montPagar   := 4854.26 //1.27 // Nahim Monto a pagar (primer titulo)
//	private cNumTitu := "0000000008393"// NAHIM
	Private cCliente 	:=	OPagBajasNT:CLIENTE // Nahim Toma el cliente Space(TamSX3("EL_CLIENTE")[1])
	Private cLoja		:=	OPagBajasNT:TIENDA // Nahim toma la tienda //Space(TamSX3("EL_LOJA")[1])

/*	private montPagar   := OPagBajasNT:BAJAS[1]:MONTOM1// 4854.26 //1.27 // Nahim Monto a pagar (primer titulo)
	private cNumTitu := OPagBajasNT:BAJAS[1]:NUMERO//"0000000008393"// NAHIM
	private cNumParcela := OPagBajasNT:BAJAS[1]:CUOTA//"  " // NAHIM */
	private aBajasNT	:= OPagBajasNT:BAJAS  // Nahim obtengo las bajas
	...
	DbSetOrder(1)
	DbSeek( xFilial("SX5")+"RN"+cSerie)
	cRecibo := ALLTRIM(SX5->X5_DESCRI)
	// Nahim Validando que la serie no existe.
	...
	//ณApos declaracao das variaveis, inicia montagem da tela.ณ
...
//	DEFINE MSDIALOG oDlgRecibo TITLE STR0006 From oSize:aWindSize[1],oSize:aWindSize[2] To oSize:aWindSize[3],oSize:aWindSize[4] OF oMainWnd PIXEL //"Recibo"  Nahim comentando la interfaz grafica para el JOB
	// odlgRecibo:lMaximized := .T. Nahim comentando la interfaz grafica para el JOB
...
/*	oMasterPanel := TPanel():New(oSize:GetDimension("MASTER","LININI"),;
	...
	oSize:GetDimension("MASTER","YSIZE"),.F.,.F.) Nahim Comentando Creaci๓n de TPANEL para no dar problema */

	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	//ณCria campos do cabecalho.   ณ
...
//		@ nTop+1,090 MSGET oRecibo Var cRecibo	Size 075,008 Pixel 	Of oPanelTop When (nPanel==1 .And. &(cWhenRec)) Valid {||FA087aVld('cRecibo',cNumFatAut)}
	Else
//		@ nTop+3,005 SAY cTitRec 				Size 040,015 Pixel 	Of oPanelTop  //"Recibo"
//		@ nTop+1,045 MSGET oRecibo Var cRecibo	Size 075,008 Pixel 	Of oPanelTop When  (nPanel==1 .And. &(cWhenRec)) Valid {||FA087aVld('cRecibo',cNumFatAut)}
	Endif
...
//	@ nTop+1,310 MSGET cNatureza F3 "SED"		SIZE 075,008 When nPanel==1 Valid FA087AVlNa() PIXEL of oPanelTop HASBUTTON
	...
	nTop+=013
// Nahim	@ nTop+3,005 SAY cTitCli 					Size 040,015 Pixel Of oPanelTop		//"Cliente"
// Nahim	@ nTop+1,035 MSGET oCliente Var cCliente 	Size 050,008 Pixel Of oPanelTop PICTURE	PesqPict("SEL","EL_CLIENTE",TamSX3("EL_CLIENTE")[1]) F3 cF3Cli VALID F087aValCli(@cCliente,@cLoja) HASBUTTON When Eval(bWhenCli)
// Nahim	@ nTop+3,090 SAY cTitLoja 					Size 040,015 Pixel Of oPanelTop		//"Loja"
// Nahim	@ nTop+1,120 MSGET oLoja Var cLoja			Size 020,008 Pixel Of oPanelTop PICTURE	PesqPict("SEL","EL_LOJA",TamSX3("EL_LOJA")[1]) VALID Iif(ExistCpo("SA1",cCliente+cLoja), (F087aValCli(@cCliente,@cLoja) .And. FA087aAtuCli(cNumFatAut)),.F.) When Eval(bWhenCli)
// Nahim	@ nTop+3,180 SAY cTitCGC					Size 030,015 Pixel Of oPanelTop		//"CGC"
// Nahim	@ nTop+1,215 MSGET cCGC 					Size 055,008 Pixel Of oPanelTop	PICTURE	PesqPict("SA1","A1_CGC",TamSX3("A1_CGC")[1]) When If(cPaisLoc=="CHI" .and. nPanel==1,.T.,.F.)
	If cPaisLoc <> "BRA"
//	Nahim	@ nTop+3,280 SAY cTitProv				Size 040,015 Pixel Of oPanelTop		//Recibo Provisorio
//	Nahim	@ nTop+1,310 MSGET cRecProv				Size 075,008 Pixel Of oPanelTop	PICTURE	PesqPict("SEL","EL_RECPROV",TamSX3("EL_RECPROV")[1]) Valid {||FA087Cob("2")} When nPanel==1  //	F3 "SA1" VALID If(CheckSX3("EL_COBRAD",.T.,If(cContato=space(cContato),.t.,.f.)), When nPanel==1
	EndIf
	nTop+=013
//Nahim	@ nTop+3,005 SAY cTitNom 					Size 040,015 Pixel Of oPanelTop		//"Nome"
//Nahim	@ nTop+1,035 MSGET cNome 					Size 235,008 Pixel Of oPanelTop	When .F.
...
//Nahim		@ nTop+3,280 SAY cTitDiar					Size 040,015 Pixel Of oPanelTop	//Cod. Diario
//	Nahim	@ nTop+1,310 MSGET cDiario F3 SX3->X3_F3	Size 020,008 Pixel Of oPanelTop HASBUTTON When CtbWdia() Valid CTBvldDiario(cDiario,dDataBase)
		SX3->(DbSetorder(1))
	EndIf

	nTop+=013
//Nahim	@ nTop+3,005 SAY cTitTel 					Size 040,015 Pixel Of oPanelTop		//"Tel. "
//Nahim	@ nTop+1,035 MSGET cTel  					Size 040,008 Pixel Of oPanelTop	PICTURE	PesqPict("SA1","A1_TEL",TamSX3("A1_CGC")[1]) When .F.
...
//Nahim		@ nTop+3,090 SAY cTitCob				Size 040,015 Pixel Of oPanelTop		//Cobrador
//Nahim		@ nTop+1,120 MSGET cCobrador			Size 050,008 Pixel Of oPanelTop	PICTURE	PesqPict("SEL","EL_COBRAD",TamSX3("EL_COBRAD")[1])	F3 "SAQ" Valid {||FA087Cob("1")} HASBUTTON When lWhenCob .And. nPanel==1
	EndIf

	If cPaisLoc == "MEX"
		If SuperGetMV('MV_SERREC')
			If SEL->(ColumnPos("EL_SERSUS")) > 0
//	Nahim			@ nTop+3,180 SAY "Ser/Rec Sust." 				Size 060,015 Pixel 	Of oPanelTop
//	Nahim			@ nTop+1,215 MSGET oSerieS Var cSerieS	Size 020,008 Pixel 	Of oPanelTop PICTURE PesqPict("SEL","EL_SERIE",TamSX3("EL_SERSUS")[1]) F3 "RN" HASBUTTON When nPanel==1
			EndIf
			If SEL->(ColumnPos("EL_RECSUS")) > 0
//	Nahim			@ nTop+3,245 SAY OemtoAnsi("-") 							Of oPanelTop PIXEL
//	Nahim			@ nTop+1,250 MSGET oReciboS Var cReciboS	Size 075,008 Pixel 	Of oPanelTop When (nPanel==1 .And. &(cWhenRec)) Valid {||F87AValRec(cSerieS,cReciboS)}
			EndIf
		Else
			If SEL->(ColumnPos("EL_RECSUS")) > 0
//	Nahim			@ nTop+3,180 SAY "Recibo Sust." 				Size 040,015 Pixel 	Of oPanelTop
//	Nahim			@ nTop+1,215 MSGET oReciboS Var cReciboS	Size 075,008 Pixel 	Of oPanelTop When (nPanel==1 .And. &(cWhenRec)) Valid {||F87AValRec(cSerieS,cReciboS)}
			EndIf
		EndIf
	EndIf

	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	//ณCria barra onde ficarao as informacoes referentes a cada Grid.  ณ
	...
	Else
//	Nahim			oPanBut:= TPanel():New(087,000,,oMasterPanel,,,,,,370,15,.F.,.F.)
//	Nahim			oPanBut:Align := CONTROL_ALIGN_TOP
	Endif

//	Nahim	@ 000,001 BITMAP oBmp RESNAME "TOOLBAR" SIZE (aSize[5]/2),25  NOBORDER PIXEL OF oPanBut
	cPesq := Space(50)

//	Nahim	@ 001,251 MSGET oPesq VAR cPesq Size 070,008 Pixel Of oPanBut ON CHANGE FA087aBuscar(lIncAdt) When (nPanel < nlastPan .And. nPanel < 4)
	nBase:=001

//	Nahim	@001,001 BTNBMP oBtn[1] RESOURCE "PREV" 		SIZE 25,25 ACTION (nPanel -= 1,FA87AValPan(nPanel,nLastPan),ShowPanel(nPanel, @oPanel,cNumFatAut,lIncAdt))				OF oPanBut WHEN nPanel > 1
//	Nahim	@001,030 BTNBMP oBtn[2] RESOURCE "NEXT" 		SIZE 25,25 ACTION (IIF(Fa087aTudoOk(cNumFatAut,lIncAdt),(nPanel +=1,ShowPanel(nPanel, @oPanel,cNumFatAut,lIncAdt)),))	OF oPanBut WHEN nPanel < nLastPan
//	Nahim	@001,070 BTNBMP oBtn[10] RESOURCE "BMPINCLUIR"	SIZE 25,25 ACTION (A087aMarca())		   																				OF oPanBut WHEN !lIncAdt .and. nPanel == 2
//	Nahim	@001,105 BTNBMP oBtn[4] RESOURCE "BMPINCLUIR"	SIZE 25,25 ACTION (A087aSugerir())		   																				OF oPanBut WHEN nPanel == 3 .and. !lIncAdt .And. ValType(aLinSE1[1][Len(aLinSE1[1])-1]) == "N"
//	Nahim	@001,155 BTNBMP oBtn[5] RESOURCE "PRECO"		SIZE 25,25 ACTION (A087Desconto())		 																				OF oPanBut WHEN (nPanel >= 3 .And. nPanel < 5) .and. !lIncAdt
//	Nahim	@001,374 BTNBMP oBtn[6] RESOURCE "FILTRO"		SIZE 25,25 ACTION (A087aFiltrar(nPanel,cNumFatAut))																		OF oPanBut WHEN (nPanel > 1) .And. (nPanel < nLastPan .And. nPanel < 4)
//	Nahim	@001,400 BTNBMP oBtn[7] RESOURCE "VCDOWN"		SIZE 25,25 ACTION (lDecr:=.F.,Fa087aOrd(nPanel),oBtn[7]:Hide(),oBtn[8]:Show())	   										OF oPanBut WHEN (nPanel < nLastPan .And. nPanel < 4)
//	Nahim	@001,400 BTNBMP oBtn[8] RESOURCE "VCUP"			SIZE 25,25 ACTION (lDecr:=.T.,Fa087aOrd(nPanel),oBtn[8]:Hide(),oBtn[7]:Show())	   										OF oPanBut WHEN (nPanel < nLastPan .And. nPanel < 4)
//	Nahim	@001,645 BTNBMP oBtn[9] RESOURCE "PESQUISA"		SIZE 25,25 ACTION (aoCB[1]:SetFocus(),FA087aBuscar(lIncAdt))	   														OF oPanBut WHEN (nPanel < nLastPan .And. nPanel < 4)
//	Nahim
//	Nahim	oBtn[1]:cToolTip := STR0022 //"Voltar   (Ctrl+Q)"
//	Nahim	oBtn[2]:cToolTip := STR0023 //"Avancar   (Ctrl+W)"
//	Nahim	oBtn[4]:cToolTip := STR0064 //"Sugerir"
//	Nahim	oBtn[5]:cToolTip := STR0065 //"Desconto Geral"
//	Nahim	oBtn[6]:cToolTip := STR0066 //"Filtrar"
//	Nahim	oBtn[7]:cToolTip := STR0067 //"Ordem Descrescente"
//	Nahim	oBtn[8]:cToolTip := STR0068 //"Ordem Crescente"
//	Nahim	oBtn[9]:cToolTip := STR0024 //"Buscar (Ctrl+L)"
//	Nahim	oBtn[10]:cToolTip :=STR0111 // "Inverte Selecao (Ctrl+M)"
//	Nahim	oBtn[7]:Hide()
//	Nahim
//	Nahim	SetKEY(17,oBtn[1]:bAction)
//	Nahim	SetKEY(23,oBtn[2]:bAction)
//	Nahim	SetKEY(12,oBtn[9]:bAction)
//	Nahim	SetKEY(13,oBtn[10]:bAction)
	oPanel := {}

	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	//ณDevolve todos os tipos de Titulos validos.ณ
	...
	//Nahim	Aadd(oPanel,TPanel():New(000,000,,oMasterPanel,,,,,,350,110,.F.,.F.))
		nPan:=nX
	Next
	...
	//ณMonta linhas de acordo com os campos acima definidos.ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	aCols 	:= MontaGrid(c_Alias,cWhi,cSelec,.F.,".F.",cSeek,nIndice,aCposSEL)

	// NAHIM importante adicionando a mano los pagos
	nPotipo	:= AScan(aCposSEL,"EL_TIPO")
	nPoTipdoC	:= AScan(aCposSEL,"EL_TIPODOC")
	nPosNNum		:= AScan(aCposSEL,"EL_NUMERO")
	nPoVal		:= AScan(aCposSEL,"EL_VALOR")
	nPosFecha	:= AScan(aCposSEL,"EL_EMISSAO")
	nPosVenc	:= AScan(aCposSEL,"EL_DTVCTO")
	nPosMoneda	:= AScan(aCposSEL,"EL_MOEDA")
	nPosBanc	:= AScan(aCposSEL,"EL_BANCO")
	nPosAgencia	:= AScan(aCposSEL,"EL_AGENCIA")
	nPosCuenta	:= AScan(aCposSEL,"EL_CONTA")
	nPosDiacont	:= AScan(aCposSEL,"EL_DIACTB")
	

	//aManopla := Array(35)
	//aCols[1] = aManopla
	cReRespo := cRecibo // nahim tomando respuesta (nro del recibo)
	//Nahim adicionando cobrador
	if type("OPagBajasNT:COBRADOR") <> "U"
		cCobrador := OPagBajasNT:COBRADOR
	ENDIF
	//	

	nNumPAgos :=  len(OPagBajasNT:PAGOS)

	if nNumPAgos == 0 // nahim compensaciones 2019/08/29
			ACOLS[1][LEN(ACOLS[1])] := .T. // NAHIM para compensar 
	endif
	for nW := 1 to nNumPAgos
	
		if nW > 1 // caso sea que sea mayor a uno vamos a adicionar un nuevo array
			aNuevo := AClone(ACOLS[1])
			AADD(ACOLS,aNuevo )
			ACOLS[nW][nPosNNum]		:=  cRecibo + "-1" //"EF"
		else // CASO QUE ES EL primero
			ACOLS[nW][nPosNNum]		:=  cRecibo//"EF"
		endif
		
		// NAHIM 20190812
		if OPagBajasNT:PAGOS[nW]:TIPOPAGO == "CH"// caso sea cheque.
			ACOLS[nW][nPotipo]		:=  OPagBajasNT:PAGOS[nW]:TIPOPAGO// TIPOPAGO"CH"
			ACOLS[nW][nPoTipdoC]	:=  OPagBajasNT:PAGOS[nW]:TIPOPAGO // "CH"
			if !empty(OPagBajasNT:PAGOS[nW]:NUMCHEQUE) // Nahim 28/05/2020
				ACOLS[nW][nPosNNum]	:=  OPagBajasNT:PAGOS[nW]:NUMCHEQUE // "CH"				
			else
				if nW > 1 // caso sea que sea mayor a uno
					ACOLS[nW][nPosNNum]	:=  cRecibo + "-1"// ch้que
				else
					ACOLS[nW][nPosNNum]	:=  cRecibo // ch้que
				endif
			endif
			ACOLS[nW][AScan(aCposSEL,"EL_PREFIXO")]	:= OPagBajasNT:PAGOS[nW]:TIPOPAGO // "CH"
			ACOLS[nW][nPosVenc]		:=  ddatabase + 30
		else
			ACOLS[nW][nPotipo]		:=  OPagBajasNT:PAGOS[nW]:TIPOPAGO// TIPOPAGO"CH"
			ACOLS[nW][nPoTipdoC]	:=  OPagBajasNT:PAGOS[nW]:TIPOPAGO // "CH"
			if type("OPagBajasNT:PAGOS[nw]:CAMBIO") <> "U" .and. AScan(aCposSEL,"EL_UCAMBIO") > 0
				ACOLS[nW][AScan(aCposSEL,"EL_UCAMBIO")]	:=  OPagBajasNT:PAGOS[nW]:CAMBIO // "CH"	
			ENDIF
//			ACOLS[nW][AScan(aCposSEL,"EL_NUMERO")]	:=  OPagBajasNT:PAGOS[nW]:NUMCHEQUE // "CH"
//			ACOLS[nW][AScan(aCposSEL,"EL_PREFIXO")]	:= OPagBajasNT:PAGOS[nW]:TIPOPAGO // "CH"
			ACOLS[nW][nPosVenc]		:=  ddatabase
		endif
		// NAHIM 20190812
		ACOLS[nW][nPoVal]		:=  OPagBajasNT:PAGOS[nW]:VALOR// 4854.26 //cRecibo//"EF"
		ACOLS[nW][nPosFecha]	:=  ddatabase
		ACOLS[nW][nPosMoneda]	:=  OPagBajasNT:PAGOS[nW]:MONEDA //que mo
		ACOLS[nW][nPosBanc]	:= OPagBajasNT:PAGOS[nW]:CODIGO //"CX1"// Banco
		ACOLS[nW][nPosAgencia]	:=  OPagBajasNT:PAGOS[nW]:AGENCIA//"00001"// Banco
		ACOLS[nW][nPosCuenta]	:=  OPagBajasNT:PAGOS[nW]:CUENTA// "0000000001"	// Banco
		ACOLS[nW][AScan(aCposSEL,"EL_UOBSTAR")]	:= "REST Rut. "+ cIdTransc // NAHIM ADICIONANDO ID
		if type("OPagBajasNT:IDAPP") <> "U"
		ACOLS[nW][AScan(aCposSEL,"EL_UIDAPPM")]	:= cvaltochar(OPagBajasNT:IDAPP)// NAHIM ADICIONANDO ID
		endif
	next nw
//	ACOLS[1][AScan(aCposSEL,"EL_CONTA")]	:= "0000000001"	// Banco
//	ACOLS[1][AScan(aCposSEL,"EL_DIACTB")]	:= "07"	// Banco
	...
	ACOLS[1][35]	:= .F.
	*/
	// NAHIM importante adicionando a mano los pagos TERMINA

	Private aRotina := { { "RDMAKE" ,"SIGAIXB", 0 , 3}}
	AADD(aRotina,aClone(aRotina[1]))
	AADD(aRotina,aClone(aRotina[1]))

//	Nahim	oPanel[nPainel]:Align := CONTROL_ALIGN_ALLCLIENT

//	Nahim	oGetSEL	:= MSGetDados():New(000,000,109,331,Iif(lCarga,4,1),"Fa087aLinOk(.F.)","Fa087aTudoOk(cNumFatAut,lIncAdt)",,.T.,,,.F.,,"a087aFldOk()",,,"SELDelLin()",oPanel[nPainel])
//	Nahim	oGetSel:oBrowse:Align := CONTROL_ALIGN_ALLCLIENT

	cOrdSEL	:= aCabSEL[1]
	bSEL		:= {|u| If( PCount() == 0, cOrdSEL, cOrdSEL:= u ) }

//	Nahim	aoCB[1]	:= TComboBox():New(001,205,bSEL,aCabSEL,040,020,oPanBut, ,{||FA087aOrd(1,)} , , , ,.t.,,,,)
	...
	If !lIncAdt
		...
		//	Nahim	oPanel[nPainel]:Align := CONTROL_ALIGN_ALLCLIENT
		//	Nahim	oLBCli	:= TwBrowse():New(000,000,000,000,,aCabSA1,aTam,oPanel[nPainel],,,,,,,,,,,,.F.,,.T.,,.F.,,,)
		//	Nahim	oLBCli:Align := CONTROL_ALIGN_ALLCLIENT
		//	Nahim	oLBCli:lColDrag	:= .T.
		//	Nahim	oLBCli:nFreeze	:= 1
		//	Nahim	oLBCli:SetArray(aLinSA1)
		cBLinSA1:= "{If(aLinSA1[oLBCli:nAt,1]>0,oOk,If(aLinSA1[oLBCli:nAt,1]<0,oNo,oNever))"
		//	Nahim	oLBCli:bLDblClick :={ || aLinSA1[oLBCli:nAt,1] := aLinSA1[oLBCli:nAT,1] * -1}
		nI:=2
		...
		Next nI
		//	Nahim	oLBCli:bLine:= { || &(cBLinSA1 + "}") }

		cOrdSA1 := aCabSA1[2]
		bSA1	:= {|u| If( PCount() == 0, cOrdSA1, cOrdSA1:= u ) }
//	Nahim		aoCB[2]	:= TComboBox():New(001,205,bSA1,aCabSA1,040,020,oPanBut, ,{||FA087aOrd(2)} , , , ,.t.,,,,)
	...
	If !lIncAdt
		...
		//ณExecblock para poder modificar os campos no Lisbox do SE1.ณ
		...
		//ณApos montagem dos campos insere campos que sao|
		//ณindispensaveis para o funcionamento da rotina.|
		...
		AAdd(aCposExtra,{"nVASE1"		,STR0200 									,25,}) //"Valores Acess๓rios"
		...
		if  cPaisLoc == "COS"
			AAdd(aCposExtra,{"nImpRetSE1"	,"Imp. Retido",25}) //"Reten็ใo"
		endif
...
//	Nahim		oPanel[nPainel]:Align := CONTROL_ALIGN_ALLCLIENT
//	Nahim		oLBSE1	:= TwBrowse():New(000,000,000,000,,aCabSE1,aTam,oPanel[nPainel],,,,,,,,,,,,.F.,,.T.,,.F.,,,)
//	Nahim		oLBSE1:Align := CONTROL_ALIGN_ALLCLIENT
//	Nahim		oLBSE1:lColDrag	:= .T.
//	Nahim		oLBSE1:nFreeze	:= 1
//	Nahim		oLBSE1:SetArray(aLinSE1)
		cBLinSE1 := "{If(aLinSE1[oLBSE1:nAt,1]>0,oOk,If(aLinSE1[oLBSE1:nAt,1]<0,oNo,oNever))"
//	Nahim		oLBSE1:bLDblClick :={ || A087aPagtos(oLBSE1:nAt,cNumFatAut)}
		...
		For nI:= 2 to Len(aCposSE1)
			...
			Endif
		Next nI
//	Nahim		oLBSE1:bLine:= { || &(cBLinSE1 + "}") }

		cOrdSE1 := aCabSE1[2]
		bSE1	:= {|u| If( PCount() == 0, cOrdSE1, cOrdSE1:= u ) }
		//	Nahim	aoCB[3]	:= TComboBox():New(001,205,bSE1,aCabSE1,040,020,oPanBut, ,{||FA087aOrd(3)} , , , ,.t.,,,,)

		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
		//ณMontagem do panel de pagto.ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ

		//Nahim oPPagto:=TPanel():New(84,100,,oMasterPanel,,,,,,232,170,.F.,.T.)

		nT1:=03
//	Nahim		@ nT1,002 GROUP oGrp1 TO 127+if(cPaisLoc == "COS", 14,0), 116 LABEL OemToAnsi(STR0030) OF oPPagto  PIXEL //"Valores da Baixa" //"Valores da Baixa"
//	Nahim		@ nT1,115 GROUP oGrp1 TO 127+if(cPaisLoc == "COS", 14,0), 230 LABEL " " OF oPPagto  PIXEL
		aMotBx := ReadMotBx()
		...
		//	Nahim	nT1+=09
		//	Nahim	@ nT1,004 SAY OemToAnsi(STR0098) SIZE 53, 07 OF oPPagto PIXEL //"Motivo Baixa"
		//	Nahim	oMotBx :=TComboBox():New(nT1,046,bMotBx,aDescMotbx,066,010,oPPagto, , ,{|| F087aMotBx()}, , ,.T.,,,,)
		//	Nahim
		//	Nahim	@ nT1,120 SAY OemToAnsi( STR0032 )  SIZE 53,07 OF oPPagto PIXEL //"= a Receber"
		//	Nahim	@ nT1,162 MSGET oSaldo VAR nSaldo 	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F.  Picture cMasc3
		//	Nahim	nT1+=14
		//	Nahim	@ nT1,004 SAY OemToAnsi( STR0031 ) SIZE 53, 10 OF oPPagto PIXEL //"Valor Original"
		//	Nahim	@ nT1,046 MSGET oValOrig VAR nValorig 	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F.  Picture cMasc3
		//	Nahim
		//	Nahim	@ nT1,120 SAY OemToAnsi( STR0033 ) SIZE 53, 07 OF oPPagto PIXEL //"Moeda Original"
		//	Nahim	@ nT1,162 MSGET oMoedOri Var cMoedOri SIZE 66, 10 OF oPPagto PIXEL When .F.
		...
		//	Nahim nValRec:= aLinSE1[oLBSE1:nAt][nPosBx]
		...
		For nI := 1 To nQtMoedas
			...
			//	Nahim		aLinBaixa[nI]:={SuperGetMV("MV_MOEDA"+Alltrim(Str(nI))),aLinSE1[oLBSE1:nAt][anPosMoed[nI]]}
		Next nI
		nT1+=14

//	Nahim		oLBBaixa:=TwBrowse():New(nT1,120,000,000,,aCabBaixa,aTamBaixa,oPPagto,,,,,,,,,,,,.F.,,.T.,,.F.,,,)
//	Nahim		oLBBaixa:lHScroll:=.F.
//	Nahim		oLBBaixa:lVScroll:= .T. //nQtMoedas>5
//	Nahim		oLBBaixa:nHeight	:=112
//	Nahim		oLBBaixa:nWidth	:=209
//	Nahim		oLBBaixa:SetArray(aLinBaixa)
//	Nahim		oLBBaixa:bLine 	:= { || {aLinBaixa[oLBBaixa:nAT][1],;
//	Nahim		Transform(aLinBaixa[oLBBaixa:nAT][2],PesqPict("SE1","E1_VALOR",18,oLBBaixa:nAT))}}
//	Nahim		oLBBaixa:bLDblClick := {|| DCLBBaixa()}


//	Nahim		nT1+=02
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0102 ) SIZE 53, 10 OF oPPagto PIXEL //"- Abatimentos"
//	Nahim		@ nT1,046 MSGET oValAbat VAR nTotAbat SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F. Picture cMasc3 //"@E 999,999,999,999.99"
//	Nahim
//	Nahim		If cPaisLoc == "COS"
//	Nahim			nT1+=14
//	Nahim			@ nT1,004 SAY OemToAnsi( "- " + STR0173 ) SIZE 53, 07 OF oPPagto PIXEL  //"Reten็๕es"
//	Nahim			@ nT1,046 MSGET oRetCfg Var nRetCfg	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F.  Picture cMasc3
//	Nahim		EndIf
//	Nahim
//	Nahim		nT1+=14
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0036 ) SIZE 53, 07 OF oPPagto PIXEL  //"- Baixas Parciais"
//	Nahim		@ nT1,046 MSGET oParciais Var nParciais	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F.  Picture cMasc3
//	Nahim		nT1+=14
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0037 ) SIZE 53, 07 OF oPPagto PIXEL  //"- Descontos"
//	Nahim		@ nT1,046 MSGET oDescont VAR nDescont	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON ON CHANGE(FAPagtoAtu()) When !(aLinSE1[oLBSE1:nAt][AScan(aCposSE1,"E1_TIPO")]$MVRECANT+"/"+MV_CRNEG .Or. oMotBx:nAt>1) Picture cMasc3
//	Nahim		nT1+=14
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0070 ) 	SIZE 53, 07 OF oPPagto PIXEL //"+ Multa"
//	Nahim		@ nT1,046 MSGET oMulta VAR nMulta  		SIZE 66, 10 OF oPPagto PIXEL HASBUTTON ON CHANGE(FAPagtoAtu()) When !(aLinSE1[oLBSE1:nAt][AScan(aCposSE1,"E1_TIPO")]$MVRECANT+"/"+MV_CRNEG .Or. oMotBx:nAt>1)Picture cMasc3
//	Nahim		nT1+=14
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0038 ) 	SIZE 53, 07 OF oPPagto PIXEL //"+ Juros"
//	Nahim		@ nT1,046 MSGET oJuros VAR nJuros  		SIZE 66, 10 OF oPPagto PIXEL HASBUTTON ON CHANGE(FAPagtoAtu()) When !(aLinSE1[oLBSE1:nAt][AScan(aCposSE1,"E1_TIPO")]$MVRECANT+"/"+MV_CRNEG .Or. oMotBx:nAt>1)Picture cMasc3
//	Nahim		nT1+=14
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0201  ) 	SIZE 53, 07 OF oPPagto PIXEL //"+ Valores Acess๓rios"
//	Nahim		@ nT1,046 MSGET oVA VAR nVA  		SIZE 66, 10 OF oPPagto PIXEL HASBUTTON When .F. Picture cMasc3
//	Nahim
//	Nahim		@ nT1,120 SAY OemToAnsi( STR0039 )  SIZE 53,07 OF oPPagto PIXEL //"Valor a Baixar"
//	Nahim		@ nT1,162 MSGET oValRec VAR nValRec 	SIZE 66, 10 OF oPPagto PIXEL HASBUTTON  WHEN .F. Picture cMasc3
//	Nahim		nT1+=19
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0202 )  SIZE 53,07 OF oPPagto PIXEL //"Nome Cliente"
//	Nahim		@ nT1,046 MSGET oCliente VAR &cNomeCli 	SIZE 115, 10 OF oPPagto PIXEL HASBUTTON  WHEN .F. //Picture cMasc3
//	Nahim		nT1+=17
//	Nahim		@ nT1,004 SAY OemToAnsi( STR0203 )  SIZE 53,07 OF oPPagto PIXEL //"Titulo"
//	Nahim		@ nT1,046 MSGET oNumTit Var &cNum 	SIZE 115, 10 OF oPPagto PIXEL HASBUTTON WHEN .F. //Picture cMasc3
//	Nahim
//	Nahim		oPPagto:NCLRPANE:= RGB(233,233,233) //13165800
//	Nahim		DEFINE SBUTTON FROM 130,170  TYPE 1  ACTION (Fa087aBaixaOK(cNumFatAut)) OF oPPagto When .T.
//	Nahim		DEFINE SBUTTON FROM 130,200  TYPE 2  ACTION (oPPagto:Hide(),oPanBut:lReadOnly:=.F.,oPanel[3]:lReadOnly:=.F.,a087Lock(oLBSE1:nAt,.F.)) OF oPPagto When .T.
//	Nahim		oPPagto:Hide()

		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
		//ณ Montagem do PANEL de Descontosณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
//	Nahim		oPDesc:=TPanel():New(84,00,,oMasterPanel,,,,,,127,117,.F.,.T.)
//	Nahim
//	Nahim		@ 003,001 GROUP oGrp TO 103, 123 LABEL OemToAnsi(STR0027) OF oPDesc  PIXEL  //"Descontos"
//	Nahim
//	Nahim		@ 015,005 SAY OemToAnsi( STR0045 ) SIZE 55, 07 OF oPDesc PIXEL  //"Valores expressos em "
//	Nahim		oCBMoed1:= TComboBox():New(015,065,bSEL,aNomeMoed,055,020,oPDesc, ,{|| nMoedDesc:=oCBMoed1:nAt, aInfGet[8]:=PesqPict("SE1","E1_VALOR",18,nMoedDesc), F087Get(aInfGet,@nDescTot)} , , , ,.T.,,,,)
//	Nahim
//	Nahim		@ 030,005 SAY OemToAnsi(STR0071) SIZE 60,07	OF oPDesc PIXEL //"Percentual"
//	Nahim		@ 030,065 MSGET oPercDesc Var nPercDesc	SIZE 55,09 	OF oPDesc PIXEL When nDescTot==0 Picture "@R 99.99" HASBUTTON
//	Nahim
//	Nahim		@ 045,005 SAY OemToAnsi(STR0072) SIZE 60,07	OF oPDesc PIXEL //"Valor do Desconto"
		...
		//	Nahim	oPDesc:NCLRPANE:= RGB(233,233,233) ///13165800
		//	Nahim	DEFINE SBUTTON FROM 104,063  TYPE 1  ACTION (A087OKDesc(cNumFatAut)) OF oPDesc When .T.
		//	Nahim	DEFINE SBUTTON FROM 104,093  TYPE 2  ACTION (oPDesc:Hide(),oPanBut:lReadOnly:=.F.,oPanel[nPainel]:lReadOnly:=.F.) OF oPDesc When .T.
		//	Nahim
		//	Nahim	oPDesc:Hide()
...
//	Nahim	@ nT1,001+nRight GROUP oGrp3 TO 085,168+nRight LABEL OemToAnsi(STR0040) OF OPANEL[nPainel]  PIXEL  //"Valores Recebidos"
//	Nahim	@ nT1,172+nRight GROUP oGrp4 TO 085,340+nRight LABEL OemToAnsi(STR0041) OF OPANEL[nPainel]  PIXEL  //"Titulos Baixados"
//	Nahim	@ 088,001+nRight GROUP oGrp5 TO 109,340+nRight 							OF OPANEL[nPainel]  PIXEL

	aCabRec	:={STR0042, STR0043 } //"Tipo"###"Valor"
	aTamRec	:={050,060}
	AAdd(aLinReceb,{"",0})
//	Nahim	oPanel[nPainel]:Align := CONTROL_ALIGN_ALLCLIENT
//	Nahim	oLBReceb := TwBrowse():New(012,004+nRight,000,000,,aCabRec,aTamRec,OPANEL[nPainel],,,,,,,,,,,,.F.,,.T.,,.F.,,,)
//	Nahim	oLBReceb:SetArray(aLinReceb)
//	Nahim	oLBReceb:bLine 	:= { ||{aLinReceb[oLBReceb:nAT][1], Transform(aLinReceb[oLBReceb:nAT][2],cMasc3) }}
//	Nahim	oLBReceb:lHScroll	:= .F.
//	Nahim	oLBReceb:nHeight	:= 140
//	Nahim	oLBReceb:nWidth		:= 320

	aCabBx	:={STR0042, STR0043 } //"Tipo"###"Valor"
	aTamBx	:={050,060}
	AAdd(aLinBX,{"",0})
//	Nahim	oLBBx := TwBrowse():New(012,175+nRight,000,000,,aCabBx,aTamBx,OPANEL[nPainel],,,,,,,,,,,,.F.,,.T.,,.F.,,,)
//	Nahim	oLBBx:SetArray(aLinBx)
//	Nahim	oLBBx:bLine 	:= { ||{aLinBX[oLBBx:nAT][1], Transform(aLinBX[oLBBx:nAT][2],cMasc3) }}
//	Nahim	oLBBx:lHScroll	:= .F.
//	Nahim	oLBBx:nHeight	:= 140
//	Nahim	oLBBx:nWidth	:= 320

	nTotal:=0
	nTotalBx:=0
//	Nahim	@ 096,005+nRight SAY OemToAnsi( STR0044 )	SIZE 020,007 OF OPANEL[nPainel] PIXEL  //"Saldo Final"
//	Nahim	@ 093,035+nRight MSGET oTotal Var nTotal	SIZE 070,009 OF OPANEL[nPainel] PIXEL When .F.  Picture cMasc3
//	Nahim	@ 096,175+nRight SAY OemToAnsi( STR0045 ) 	SIZE 040,007 OF OPANEL[nPainel] PIXEL  //"Valores expressos em "
	FAMoedas(dDataRef,cNumFatAut)
//	Nahim	oCBMoed:= TComboBox():New(090,220+nRight,bSEL,aNomeMoed,070,020,oPanel[nPainel], ,{||RefData(If(lIncAdt,2,4),cNumFatAut,lIncAdt)} , , , ,.t.,,,,)

	//ฺฤฤฤฤฤฤฤฤฤฤ
	//ณ PANEL 5 ณ
	//ภฤฤฤฤฤฤฤฤฤฤ
	If cPaisLoc == "ARG"
		//Cria o painel do resumo de reten็๕es
		nPainel	:= 5
		aSize 	:= MSADVSIZE()
		nRight	:=((aSize[5]/2)-330)/2

		@ 003,001+nRight GROUP oGrp7 TO 109,340+nRight Label STR0173	OF OPANEL[nPainel]  PIXEL		//"Reten็๕es"
		@ 115,001+nRight GROUP oGrp8 TO 182,340+nRight Label STR0174 	OF OPANEL[nPainel]  PIXEL		//"Resumo de reten็๕es"

		oPanel[nPainel]:Align := CONTROL_ALIGN_ALLCLIENT

		//Cria aHeader e campos editaveis do quadro de reten็๕es
		aHeadReten	:= {}
		aAltReten	:= {}
		For nX := 1 To Len(aHeader)
			If (AllTrim(aHeader[nX,2]) $ "EL_TIPODOC|EL_PREFIXO|EL_NUMERO|EL_PARCELA|EL_VALOR|EL_EMISSAO|EL_DTVCTO|")
				...
				If (AllTrim(aHeader[nX,2]) == "EL_VALOR")
					AADD(aAltReten,aHeader[nX,2])		//Adiciona o campo VALOR no array de campos editแveis
					aHeadReten[Len(aHeadReten),6] := "Positivo() .And. NaoVazio()"		//Altera a valida็ใo do campo VALOR
				EndIf
			EndIf
		Next nX
		...
		//Cria coluna de ordena็ใo das reten็๕es
		AADD(aHeadReten,{"Ord. Ret.","ORDEM","@E 9",1,0,"","","N","",""})

		//Cria aCols do quadro de reten็๕es
		...
		//Browse das reten็๕es
		oRetTit := MsNewGetDados():New(012,005+nRight,106,337+nRight,GD_UPDATE,"AllwaysTrue()","AllwaysTrue()", ,aAltReten,000,999,"FA87RetVld()","","AllwaysTrue()",oPanel[nPainel],aHeadReten,aColsReten)
		oRetTit:Refresh()

		//Cria aHeader do quadro de resumo das reten็๕es
		aCabRes := {STR0175,STR0176}		//"Descricao"##"Valor"

		//Cria aCols do quadro de resumo das reten็๕es
		aListRes := {}
		AADD(aListRes,{STR0177	,0})		//"Reten็ใo de IVA"
		AADD(aListRes,{STR0178	,0})		//"Reten็ใo de Ganancias"
		AADD(aListRes,{STR0179	,0})		//"Reten็ใo de Ingressos Brutos"
		AADD(aListRes,{STR0180	,0})		//"Reten็ใo de SUSS"
		...
		//ณ PANEL 6 ณ
		//ภฤฤฤฤฤฤฤฤฤฤ
		//Cria o painel da simula็ใo da contabiliza็ใo
		nPainel	:= 6
		aSize 	:= MSADVSIZE()
		nRight	:=((aSize[5]/2)-330)/2

		@ 003,001 GROUP oGrp9 TO ((aSize[6]/2)-80),((aSize[5]/2)) Label STR0188	OF OPANEL[nPainel]  PIXEL		//"Simula็ใo dos lan็amentos contแbeis"
		...
		//Cria aHeader da simula็ใo da contabiliza็ใo
		dbSelectArea("SX3")
		dbSetOrder(1)
		dbGoTop()
		SX3->(dbSeek("CT2"))
		...
		//Cria aCols da simula็ใo da contabiliza็ใo
		aColsCtb := Array(1,Len(aHeadCtb)+1)
		aColsCtb[1,Len(aHeadCtb)+1] := .T.

		//MsNewGetDados da simula็ใo da contabiliza็ใo
		aAltCtb := {}
		...
		@ 302,005 SAY OemToAnsi(STR0185)	SIZE 040,015 OF OPANEL[nPainel] PIXEL  //"Total D้bito"
		@ 300,050 MSGET oCtbDeb Var nCtbDeb	SIZE 100,008 OF OPANEL[nPainel] PIXEL When .F.  Picture PesqPict("CT2","CT2_VALOR",17,1)
		@ 302,200 SAY OemToAnsi(STR0186)	SIZE 040,015 OF OPANEL[nPainel] PIXEL  //"Total Cr้dito"
...
//	Nahim	OPANEL[nPainel]:NCLRPANE:= RGB(233,233,233) //13165800

	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	//ณ INICIALIZA TELA	 ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
	// NAHIM el Show paner es el que muestra toda la ventana.
	// NAHIM adiciona las cuentas pagadas y prontas
	// NAHIM adiciona las cuentas pagadas y prontas TERMINA
	FA087aAtuCli(cNumFatAut) // NAHIM Actualizando cliente que quiero
	RefData(3,cNumFatAut,lIncAdt) // Nahim Simula que refresca el panel nro 3 (titulos a baixar)
	nEncontrados := 0 //determina el break
	For nK := 1  to Len(aLinSE1)

//		conout("CUENTA: |" + aLinSE1[nK][3] + "| - |"  + aLinSE1[nK][4]+ "|")
		// nahim realizo una comparaci๓n de las bajas
		aDadosBaja := {} // aValRepetidos
		for  nP := 1 to len(aBajasNT)
			cNumTitu := aBajasNT[nP]:NUMERO
			cNumParcela :=  aBajasNT[nP]:CUOTA
			cNumPrefijo :=  aBajasNT[nP]:PREFIJO
//			conout("|" + aLinSE1[nK][3] + "| - |"  + aLinSE1[nK][4]+ "|")
//			if aLinSE1[nK][3] == cNumTitu .and. aLinSE1[nK][4] == cNumParcela // numero titulo Nahim 30/08/2019
			if ASCAN(aDadosBaja,{|x| x[1]+x[2]+x[3]== cNumTitu+cNumParcela+cNumPrefijo } ) <> 0 // Verificando que no se repita para no dar error
				// conout("ENCONTRO DEBERอA PASAR PASA")
				nP++
				LOOP
			ELSE
				// conout("NO ENCUENTRA")
			end
			if aLinSE1[nK][3] == cNumTitu .and. aLinSE1[nK][4] == cNumParcela .and. aLinSE1[nK][Ascan(aCposSE1,"E1_PREFIXO")] == cNumPrefijo   // numero titulo
				nMonM1 :=  aBajasNT[nP]:MONTOM1 // obtengo el monto a pagar de la moneda 1 Nahim
				nMonM2 :=  aBajasNT[nP]:MONTOM2 // obtengo el monto a pagar de la moneda 2 Nahim

				nNumMoneda := aLinSE1[nK][Ascan(aCposSE1,"E1_MOEDA")] // obtengo la moneda
				if nNumMoneda == 1 // caso que la moneda del tํtulo sea en M1
					nMontPagar  :=  nMonM1 +  aLinMoed[2][2] * aBajasNT[nP]:MONTOM2 // suma la moneda uno con Mon2 convertida
					// BAJO LOS montos
					//	nMontPagar  :=  nMonM1 +  aLinMoed[2][2] * aBajasNT[nP]:MONTOM2 // suma la moneda uno con Mon2 convertida
				else // caso que la moneda del tํtulo sea en M2
					nMontPagar  :=  nMonM2 +  aBajasNT[nP]:MONTOM1 / aLinMoed[2][2]// suma la moneda2 con la Mone1 convertida
				endif
				// conout("nMontPagar " + CValToChar(nMontPagar))
				// conout("ALINSALDO " + CValToChar(aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")]))
				// conout("aBajasNT[nP]:MONTOM1 " + CValToChar(aBajasNT[nP]:MONTOM1))
				// conout("aBajasNT[nP]:MONTOM2 " + CValToChar(aBajasNT[nP]:MONTOM2))
				// conout("aBajasNT[nP]:MONTOM2 " + CValToChar(aBajasNT[nP]:MONTOM2))
				if nMontPagar > aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] // Nahim validaci๓n de monto a bajar mayor al saldo del tํtulo
					nMontPagar := aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")]  // el monto toma el valor del saldo
					// Diminuir cantidad correspondiente a cada cuota
					if nNumMoneda == 2 // si es d๓lares
						lPartido := .T. // indica si el monto estแ distribuido y tiene que ser cortado
						if nMonM2 > aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")]  // caso el saldo sea mayor al monto que estoy pagando
							nMonM2 := aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")]
							lPartido := .F.
						endif
						if (nMonM1 / aLinMoed[2][2]) > aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] // caso el saldo sea mayor al monto que estoy pagando
							nMonM1 := aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] * aLinMoed[2][2]
							lPartido := .F.
						endif
						if lPartido  // monto distribuido (SE NECESITAN AMBOS PARA)
//							nMonM2 := aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] // toma el total del monto de d๓lares	
							nMonM1 := (aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] * aLinMoed[2][2]) - (nMonM2 * aLinMoed[2][2])  // disminuyo lo que estaba pagando menos el saldo en d๓lares
							// Saldo tํtulo en BS                                      lo que se estแ pagando en Bs
						endif
					ELSE // bs. TODO VALIDAR BS.
						lPartido := .T. // indica si el monto estแ distribuido y tiene que ser cortado
						if (nMonM2 / aLinMoed[2][2]) > aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")]  // caso el saldo sea mayor al monto que estoy pagando
							nMonM2 := aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] / aLinMoed[2][2]
							lPartido := .F.
						endif
						if nMonM1 > aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] // caso el saldo sea mayor al monto que estoy pagando
							nMonM1 := aLinMoed[2][2]
							lPartido := .F.
						endif
						if lPartido  // monto distribuido (SE NECESITAN AMBOS PARA)
							nMonM1 := (aLinSE1[nK][Ascan(aCposSE1,"E1_SALDO")] ) - (nMonM2 * aLinMoed[2][2])  // disminuyo lo que estaba pagando menos el saldo en d๓lares
						endif
					endif
				endif

				aLinSE1[nK][1] := 1 // Nahim Escogiendo la cuenta a pagar en este caso es la nro 000533 - 356,7
				aLinSE1[nK][Ascan(aCposSE1,"nBaixar")] := nMontPagar // monto total a bajar montPagar
				aLinSE1[nK][Ascan(aCposSE1,"nBxMoeda1")] := nMonM1
				aLinSE1[nK][Ascan(aCposSE1,"nBxMoeda2")] := nMonM2 // aLinMoed[2][2] * aLinMoed[2][3]
				aLinSE1[nK][Ascan(aCposSE1,"cMotBxSE1")]:= "NOR"	// NAHIM ESTA
				// nahim bajo valores recibidos 2019/08/28
//				conout("nMonM1 "+ CVALTOCHAR(nMonM1))
//				conout("nMonM2 "+ CVALTOCHAR(nMonM2))
				aLinMoed[1][4] := aLinMoed[1][4] -  nMonM1
				aLinMoed[2][4] := aLinMoed[2][4] -  nMonM2
				// conout("aLinMoed[1][4]" +CVALTOCHAR(aLinMoed[1][4]))
				// conout("aLinMoed[2][4]" +CVALTOCHAR(aLinMoed[2][4]))
				// Nahim 06/07/2020 validando si existe un valor negativo se tiene que pasar el mismo a la otra moneda
				if aLinMoed[1][4] < 0 // Caso se est้ pagando de mแs los bs
					aLinMoed[2][4]  := aLinMoed[2][4] - ( ABS(aLinMoed[1][4]) / aLinMoed[2][2] ) // lo negativo resto
				endif
				if aLinMoed[2][4] < 0 // Caso se est้ pagando de mแs los Sus
					aLinMoed[1][4] :=  aLinMoed[1][4] - ( ABS(aLinMoed[2][4]) * aLinMoed[2][2] ) // lo negativo resto
				endif
				//
				aadd(aDadosBaja,{cNumTitu,cNumParcela,cNumPrefijo})
				nEncontrados++
			endif


		next nP
		if Nencontrados == len(aBajasNT) // caso la cantidad de bajas ya hayan sido encontradas
			EXIT
		endif
	Next nK
	RefData(4,cNumFatAut,lIncAdt) // Nahim Simula que refresca el panel nro 4

	//  ShowPanel(1,@oPanel,cNumFatAut,lIncAdt)// nahim cambiando a 3 de 1
	...
	//Endif
	Fa087aSalvar(NIL,NIL,cNumFatAut,lIncAdt,aRecAdt)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณShowPanel บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Mostra o panel referente ao passo em questao.			  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function ShowPanel( nPan, oPanel,cNumFatAut,lIncAdt)
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Parametros utilizados na funcao                       ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ nPan 	- Numero do panel a ser mostrado.             ณ
	//ณ oPanel 	- Objeto recebido como referencia.            ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	Local nX := 1
	Local nLastPan := 4
	...
	//Caso o objeto oPanel esteja sem valor, recupero atrav้s do
	//objeto de backup
	If oPanel == Nil
		oPanel := oObjBkp
	EndIf
	...
	If nPan > 0 .And. nPan <= nLastPan
		...
		Case nPan == 2 .and. !lIncAdt
			//	Nahim	oLBCli:SetFocus()
		Case nPan == 3 .and. !lIncAdt
			//	Nahim	oLBSE1:SetFocus()
		End Case
		nPan:=nPanel
	Else
		If nPanel <  1
	...
	//Efetuo uma copia do objeto oPanel caso na pr๓xima chamada da fun็ใo
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA087aVld บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Faz a validacao de campos que nao estao no Browse.		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
...
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ cVar 	- Variavel a ser validada.			          ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Retorna aRet, se .T. ้ que o conteudo e valido.		  ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA087aOrd บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Ordena linhas do Grid de acordo com Combo.        		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
...
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ nCombo	- Qual combo deve ser considerado		      ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
*/
...
ฑฑบPrograma  ณFA087aBuscar บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Busca valor do campo cPesq de acordo com o combo. 			 บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณRefData   บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Remonta dados do Grid, de acordo com Panel.                บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function RefData(nPan,cNumFatAut,lIncAdt)
	...
	Local nImpRet := 0
	Local cLstNoBlq 	:= FN022LSTCB(6,'0008')	//Lista das situacoes de cobranca (Nใo bloqueadas para determinado processo)
...
//NAHIM		oLBCli:bLine:= { || &(cBLinSA1 + "}") }
	...
	//If nPan == 3 .and. !lIncAdt // NAHIM PARA ACTUALIZAR LA VARIABLE CAMBIO NPAN POR TRUE
	If nPan == 3 .and. !lIncAdt // NAHIM PARA ACTUALIZAR LA VARIABLE aLinSE1 CAMBIO NPAN POR TRUE
...
//NAHIM		AEval(oLBCli:aARRAY, {|x,y| If(oLBCli:aARRAY[y][1] == 1, nQtdCli++,.T.)})//Qtd de Clientes selecionados
		...
		Else
			nX:=1
			/*
			Nahim cambiando para que no lo envํa al objeto sino al array
			...
			Next nX
			*/
			// nahim agregando tipo de movimiento
			aLinSE1[1][1] := 1
			aLinSE1[nX][nPosCli] := OPagBajasNT:CLIENTE//"CL0001"
			aLinSE1[nX][nPosLoja] := OPagBajasNT:TIENDA// "01"
			// nahim termina
			For nX:= 1 to Len(aLinSE1) //ListBox de clientes
				If aLinSE1[nX][1] == 1 // Cliente esta selecionado
					AAdd(aCli,{aLinSE1[nX][nPosCli],aLinSE1[nX][nPosLoja]})
					If !lQuery //Prepara a condicao de filtro para DBF
						cFilClie += aLinSE1[nX][nPosCli] +  aLinSE1[nX][nPosLoja] + "|"
					Else //Prepara a condicao de filtro para Bco de Dados
						cFilClie += "(E1_CLIENTE = '" + aLinSE1[nX][nPosCli] + "' AND E1_LOJA = '" + aLinSE1[nX][nPosLoja] + "')"
						nContCli++
						If nContCli != nQtdCli //Verifica se existem mais clientes para se adicionar a Query
							//			cFilClie  += " OR " // NAHIM CAMBIANDO
							cFilClie  += " AND " // NAHIM CAMBIANDO
						Else
							cFilClie  += ") AND "
						EndIf
					EndIf
			...
			If Len(aCli) > 0
				...
				Else
					If !lQuery
						...
						//PCREQ-3782 - Bloqueio por situa็ใo de cobran็a
...
// Nahim					cQuery += " D_E_L_E_T_ = ' '"
						cQuery += " D_E_L_E_T_ = ' ' )" // nahim aumentando )
...
//	Nahim cambiando	nM:=IIf(Empty(aRecs[nX][nPosMoedTit]).Or. Val(aRecs[nX][nPosMoedTit])<=1,1,Val(aRecs[nX][nPosMoedTit]))
					nM:=IIf(Empty(aRecs[nX][nPosMoedTit]).Or. aRecs[nX][nPosMoedTit] <=1 ,1,aRecs[nX][nPosMoedTit])
//	Nahim cambiando	aLinReceb[Len(aLinReceb)][2]+=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[oCBMOed:nAt])
					aLinReceb[Len(aLinReceb)][2]+=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[1]) // nahim modiifcando apra 1
				Endif
			Next nX

//	Nahim		oLBReceb:SetArray(aLinReceb)
//	Nahim		oLBReceb:bLine := { ||{aLinReceb[oLBReceb:nAT][1],Transform(aLinReceb[oLBReceb:nAT][2],PesqPict("SEL","EL_VALOR",18,oCBMOed:nAt)) }}
//	Nahim		oLBReceb:Refresh()
...
//	Nahim				aLinBx[Len(aLinBx)][2]-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[oCBMOed:nAt])
						aLinBx[Len(aLinBx)][2]-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[1])
						If aRecs[nX][nPosMotBx]=="DAC"
//	Nahim				nValDac-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[oCBMOed:nAt])
							nValDac-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[1])
						EndIf
					Else
//	Nahim					nValDac-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[oCBMOed:nAt])
						nValDac-=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[1])
// 	Nahim			aLinBx[Len(aLinBx)][2]+=(aRecs[nX][nPosVal]-aRecs[nX][nPosDesc]+aRecs[nX][nPosJuros]+aRecs[nX][nPosMulta])*aTaxa[nM]/aTaxa[oCBMOed:nAt]
						aLinBx[Len(aLinBx)][2]+=(aRecs[nX][nPosVal]-aRecs[nX][nPosDesc]+aRecs[nX][nPosJuros]+aRecs[nX][nPosMulta])*aTaxa[nM]/aTaxa[1]
						If aRecs[nX][nPosMotBx]=="DAC"
//	Nahim				nValDac+=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[oCBMOed:nAt])
							nValDac+=aRecs[nX][nPosVal]*(aTaxa[nM]/aTaxa[1])
						EndIf
					Endif
					// Soma Reten็ใo de Impostos como Baixa
				...
				Endif
				If nDescGer>0
//	Nahim			Aadd(aLinBx,{"DC",nDescGer*(aTaxa[nMoedDesc]/aTaxa[oCBMoed:nAt])*(-1)})
					Aadd(aLinBx,{"DC",nDescGer*(aTaxa[nMoedDesc]/aTaxa[1])*(-1)})
				Endif
				If nPercGer>0
					nTotBx:=0
...
// Nahim		oLBBx:SetArray(aLinBx)
// Nahim		oLBBx:bLine := { ||{aLinBx[oLBBx:nAT][1],Transform(aLinBx[oLBBx:nAT][2],PesqPict("SE1","E1_VALOR",18,oCBMOed:nAt)) }}
// Nahim		oLBBx:Refresh()
			//NAHIM 2019/08/28 ESTม SUMANDO LO RECIBIDO + LO BAJADO
			nTotBx := nTotBx - nTotRec //  2019/08/28
			//NAHIM 2019/08/28 ESTม SUMANDO LO RECIBIDO + LO BAJADO

			nTotalBx := nTotBx
// nahim cambiando		nTotal:= Round(nTotRec-nTotBx,MsDecimais(oCBMOed:nAt))
			nTotal:= Round(nTotRec-nTotBx,MsDecimais(2)) // nahim redondeando a 2 valores
//	conout("Primer nTotRec: " +  cvaltochar(nTotRec))
//	conout("Primer nTotBx (nTotalBx): " +  cvaltochar(nTotBx))
//	conout("Primer nTotal: " +  cvaltochar(nTotal))
//Nahim		oTotal:Picture:=PesqPict("SE1","E1_VALOR",TamSX3("E1_VALOR")[1],oCBMOed:nAt)
//Nahim		oTotal:Refresh()
		...
		If cPaisLoc == "ARG"
			...
			If nPan == 5
				...
				For nX := 1 To Len(aCols)
					If !(aCols[nX,Len(aHeader)+1]) .And. (aCols[nX,nPosTmp] $ "RI|RG|RB|RS|")
						nCont++
						//Se nใo for a primeira linha, adiciona nova linha no quadro de reten็๕es
						If !(nCont == 1)
						...
						For nY := 1 To (Len(oRetTit:aHeader)-1)
							...
							//Preenche a coluna de ordena็ใo
							Do Case
				...
				//Verifica se hแ reten็๕es ou nใo, para preencher a aColsReten com conte๚dos em branco
				If nCont <= 0
				...
				Else
					//Reordena as linhas do quadro de reten็๕es, por tipo, de acordo com a ordem RI,RG,RB,RS
				...
				//Atualiza o quadro do resumo de reten็๕es
				For nX := 1 To Len(oRetRes:aArray)
					oRetRes:aArray[nX,2] := 0
				Next nX

				For nX := 1 To Len(oRetTit:aCols)
					//Soma as reten็๕es e atualiza os valores do quadro de resumo de reten็๕es
					Do Case
			...
			//Painel 6
			If nPan == 6
				//Processa a simula็ใo da contabiliza็ใo
				MsAguarde({|| FA87aCtbA(1) } , STR0189)

				//Monta o browse da simula็ใo da contabiliza็ใo
...
ฑฑบPrograma  ณFA087aVld บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Faz refresh dos objetos do Panel informado.        		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function OBJRefresh(nPan)
	...
	If nPan==1
// NAHIM		oGetSEL:ForceRefresh()
// NAHIM		oGetSEL:oBrowse:Refresh()
		aDadosAdm:={}
	Endif
	If nPan==2
// NAHIM		oLBCli:Refresh()
	Endif
	If nPan==3
// NAHIM		oLBSE1:Refresh()
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFAMoedas  บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta ListBox que contem as taxas das moedas.			  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
...
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ dData	- Data para buscar no SM2, caso nao informada,ณ
//ณ nao monta taxas, somente Saldos.                      ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
*/
Static Function FAMoedas(dData,cNumFatAut)
	...
	If oLBMoed==NIL
		aSize := MSADVSIZE()
//Nahim		oLBMoed:Refresh()		oLBMoed	:=TwBrowse():New(001,(aSize[5]/2)-200,000,000,,aCabMoed,aTamMoed,oPanelTop,,,,,,,,,,,,.F.,,.T.,,.F.,,,)
		lNovo	:=.T.
	Endif

	IF lNovo
//Nahim		oLBMoed:Refresh()		oLBMoed:SetArray(aLinMoed)
//Nahim		oLBMoed:Refresh()		oLBMoed:bLine 	:= { ||{aLinMoed[oLBMoed:nAT][1],;
///Nahim		oLBMoed:Refresh()/Nahim		oLBMoed:Refresh()//Nahim		oLBMoed:Refresh()		Transform(aLinMoed[oLBMoed:nAT][2],PesqPict("SM2","M2_MOEDA"+AllTrim(Str(oLBMoed:nAT)),TamSx3("M2_MOEDA"+AllTrim(Str(oLBMoed:nAT)))[1])),;
//Nahim		oLBMoed:Refresh()		Transform(aLinMoed[oLBMoed:nAT][3],PesqPict("SEL","EL_VALOR",TamSx3("EL_VALOR")[1],oLBMoed:nAT)),;
//Nahim		oLBMoed:Refresh()		Transform(aLinMoed[oLBMoed:nAT][4],PesqPict("SEL","EL_VALOR",TamSx3("EL_VALOR")[1],oLBMoed:nAT)) }}

//Nahim		oLBMoed:Refresh()		oLBMoed:bLDblClick := {|| DCLBMoed(cNumFatAut)}
//Nahim		oLBMoed:Refresh()		oLBMoed:lHScroll:=.F.
//Nahim		oLBMoed:Refresh()		oLBMoed:lVScroll:=.T.
//Nahim		oLBMoed:Refresh()		oLBMoed:nHeight:=112
//Nahim		oLBMoed:Refresh()		oLBMoed:nWidth	:=400
	Else
//Nahim		oLBMoed:Refresh()
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSomaReceb บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Soma todos os recebimentos.                       		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
//			IF Empty(aCols[nX][nPosMoed]) .Or. aCols[nX][nPosMoed] <= "1" Nahim cambiando por vacio 
			IF Empty(aCols[nX][nPosMoed]) .Or. aCols[nX][nPosMoed] <= 1
				anRec[1] += aCols[nX][nPosVal]
			Else
//				anRec[Val(aCols[nX][nPosMoed])]+= aCols[nX][nPosVal] nahim cambio
				anRec[aCols[nX][nPosMoed]]+= aCols[nX][nPosVal]
			Endif
		Endif
	Next nX
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSomaBaixa บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Soma valores a serem baixados.                    		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSomatitBaixa บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Soma valores a serem baixados sem considerar NEGATIVOS.       บฑฑ
ฑฑศออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA087aHeadบAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta ListBox que contem as taxas das moedas.     		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
static Function FA087aHead(c_Alias,aCpos,lMark,aCposNo)
	...
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ c_Alias 	- Arquivo onde buscar as informacoes.     ณ
	//ณ aCpos 	- Campos a serem utilizados no cabecalho,     ณ
	//ณ caso nao seja informado, cria com base no SX3.        ณ
	//ณ aCposNo	- Campos que NAO devem aparecer na Get Dados. ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Retornos											  ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ aRet[1]	- aHeader a ser utilizado na GetDados.			ณ
	//ณ aRet[2]	- Array contendo campos validos.				ณ
	//ณ aRet[3]	- Array contendo cabecalho dos campos validos.	ณ
	//ณ aRet[4]	- Array contendo Tamanho dos campos validos.	ณ
	...
	//No caso de usar marca no list, o primeiro campo nใo deve ser consistido.
	If lMark
		nS:=2
	Else
		nS:=1
	...
	For nX:=nS to Len(aCpos)
		If DbSeek(aCpos[nX],.F.) .And. x3uso(x3_usado) .And. cNivel >= X3_NIVEL .And. X3_CONTEXT!="V"  .And. IIF(cPaisLoc == "MEX",.t.,X3_TIPO <> "M")
			...
			//ณSe o campo foi encontrado no X3 e esta disponivel, adiciona no aH     ณ
			...
			//ณArmazena em um array separado as sequencias do aCpos que realmente serao utilizadas,ณ
			//ณpara depois poder se referenciar aos campos.                                        ณ
			//ณNao foi utilizado diretamente o aH pois esta rotina monta aHeader                   ณ
			//ณe Cabecalho do ListBox, e seriam posicoes distintas do Array.                       ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณMontaGrid บAutor  ณGuilherme C. Leal   บ Data ณ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Monta linhas dos Grids                           		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function MontaGrid(c_Alias,cWhile,cCond,lMark,cCMarca,cSeek,nInd,aCpos,lRecno,cQuery,lIncAdt,nPanel)
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ c_Alias 	- Arquivo onde buscar as informacoes.     ณ
	//ณ cWhile 	- Condicao inicial para o While.              ณ
	//ณ cCond 	- Se .T. o registro sera inserido no aC.      ณ
	//ณ lMark 	- Se usa Marca (somente para ListBox).        ณ
	//ณ cCMarca - Se .T. o registro vem marcado.              ณ
	//ณ cSeek 	- Registro inicial do while (performance).    ณ
	//ณ nInd 	- Indice da Busca.                            ณ
	//ณ aCpos 	- Campos utilizados (somente os validos).     ณ
	//ณ lRecno	- Se TRUE, carregara o RECNO na penultima pos.ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Retorna aC, que sera utilizado como aCols ou Linhas   ณ
	//ณ do ListBox.											  ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	...
	Local lMulLoj	  	:= SuperGetMv("MV_LJINTFS", ,.F.) //Calcula multa conforme regra do loja, se integra็ใo com financial estiver habilitada
	...
	//ณDe acordo com todos os parametros passados, monto o aC. 	ณ
	...
	//ณSe nao encontrar nenhum registro, cria novamente em branco.ณ
...
ฑฑบPrograma  ณa087aFldOk  บAutor  ณGuilherme C. Leal   บ Data ณ  20010730   บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Faz a valida็ใo por campo,  utilizada para atualizar moedas. บฑฑ
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออหออออออออออออหอออออออหออออออออออออออออออออหออออออหอออออออออออออปฑฑ
ฑฑบPrograma  บFa087aLinOk บAutor  บGuilherme C. Leal   บ Data บ  05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออสออออออออออออออออออออสออออออสอออออออออออออนฑฑ
ฑฑบDesc.     บ Monta ListBox que contem as taxas das moedas.     			บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosบ lTudo	- Indica se rotina esta sendo chamada pela TUDOOK() บฑฑ
ฑฑบ          บ nLinaCols - Linha do aCols a ser Validada.                   บฑฑ
ฑฑศออออออออออสออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
static Function Fa087aLinOk(lTudo,nLinaCols)
	...
	IF !(aCols[n][Len(aCols[n])])    // Somente Linhas nใo Deletadas
		...
		If lCarga .And. lRet
			...
			If !lRet
				Alert(STR0101)   // Tipo de Valor nใo ingressado na conferencia da carga.
				Return lRet
			EndIf
	...
	If lRet //Solo valide si las demas validaciones estan OK
			...
			If nCepTip > 0 .And. nCerCEP > 0 .And. nCadCEP > 0 .And. nSelloCEP > 0
				If !Empty(aCols[n][nCepTip])
					...
					If Empty(aCols[n][nCerCEP]) .OR. Empty(aCols[n][nCadCEP]) .OR. Empty(aCols[n][nSelloCEP])
						Help( ,, STR0149,, STR0212 + alltrim(str(n)) + STR0213 + cCmpsCEP + STR0214 ,1, 0 )//"Atencion" //"En el ํtem " //" el campo Tipo CEP contiene informaci๓n, por lo tanto los campos "//" deben ser informados."
						lRet := .F.
					EndIf
				EndIf
			EndIf
		...
		If cPaisLoc == "PER" .And. SEL->(FieldPos('EL_SERRET')) > 0
			...
			If aCols[n][nPosTpDoc] $ "RI" .And. Empty(aCols[n][nPosSerRet])
				Help( ,, STR0149,, STR0212 + alltrim(str(n)) + "STR0225" ,1, 0 )//"Atencion" //"En el ํtem " //" el tipo de documento es Retenci๓n IGV, debe informar la serie del certificado de retenci๓n."
				lRet := .F.
			ElseIf !(aCols[n][nPosTpDoc] $ "RI") .And. !Empty(aCols[n][nPosSerRet])
				Help( ,, STR0149,, STR0212 + alltrim(str(n)) + "STR0226" ,1, 0 )//"Atencion" //"En el ํtem " //" se inform๓ serie de certificado de retenci๓n pero el tipo de documento no es de Retenci๓n IGV."
				lRet := .F.
			Endif
		EndIf
	EndIf
...
ฑฑบPrograma  ณFa087aTudoOk  บAutor  ณGuilherme C. Leal บ Data ณ05/27/01   บฑฑ
ฑฑฬออออออออออุออออออออออออออสอออออออฯออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ Faz a validacao de todos os campos.               		  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
static Function Fa087aTudoOk(cNumFatAut,lIncAdt)
	...
	If !lIncAdt		//ANGOLA - Nao e inclusao de adiantamento
		...
		ElseIf nPanel == 3
			...
			If cPaisLoc == "ARG"
				...
				SE1->(DbsetOrder(1))
				SE1->(DbGotop())
				For nE:= 1 to Len(aLinSE1)
					If aLinSE1[nE][nPosValBx] <> 0
						SE1->(Dbseek(xfilial("SE1")+aLinSE1[nE][nPosPre]+aLinSE1[nE][nPosNum]+aLinSE1[nE][nPosPar]+aLinSE1[nE][nPosTp])) // posicionar
						If NoRound(aLinSE1[nE][nPosValBx],2) > SE1->E1_SALDO
							lRet:= .F.
							MsgAlert( STR0197 + SE1->E1_NUM )
						EndIf
					EndIf
				Next
	...
	If nPanel == 1
		For nI:= 1 to Len(aCols)
			...
			If lRet .And. leTaxa
				Alert(STR0049) //"Informe todas as taxas das moedas que serใo utilizadas nos Documentos."
				lRet:=.F.
				Return(lRet)
			Endif
			If !lRet
//Nahim				oGetSEL:oBrowse:nAt:=nI
//Nahim				oGetSEL:oBrowse:Refresh()
//Nahim				oGetSEL:oBrowse:SetFocus()
				Exit
			Endif
		Next nI
			...
			For nX := 1 To Len(aCols)
				If ! aCols[nX][Len(aCols[1])]
					If AllTrim(aCols[nX][nPosTpDoc]) $ "RI|RR"
						...
						If Len(aNumCert) == 0
							MsgAlert(STR0169,STR0149) //"Tabla de Control de Comprobantes invalida, favor evaluar la tabla SFP en el m๓dulo Fiscal.","Atenci๓n!")
							lRet := .F.
							Return lRet
						EndIf
					EndIf
	...
	EndIf
	If lRet
		lRet:=IF(cPaisLoc=='PER' .AND. AllTrim(cCalcITF) == '1', If(!Empty(cNatureza),CkNatureza(cNatureza,@lNatureza),Eval({||MsgAlert(STR0166),.F.})),.T.)
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณSELDelLin บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
...
ฑฑบPrograma  ณA087aPagtosบAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
...
Static Function A087aPagtos(nLin,cNumFatAut)
	...
	If (aLinSE1[oLBSE1:nAT,1] * -1) != 1
		...
		aLinSE1[oLBSE1:nAt][nPosDesc]  	:=0
		aLinSE1[oLBSE1:nAt][nPosJuros]	:=0
		aLinSE1[oLBSE1:nAt][nPosVA]		:=0
		aLinSE1[oLBSE1:nAt][nPosMulta]	:=0
	...
	Else
		...
		If cPaisLoc $ "MEX|PER" .And. X3Usado("ED_OPERADT")
			...
			//----------------------------------------------------------------------------------
			// Nao permite a selecao de titulos tipo RA com opera็ใo de adiantamento habilitada
			//----------------------------------------------------------------------------------
			If aLinSE1[oLBSE1:nAt][nPosTipo] == cDocRA .And. GetAdvFVal("SED","ED_OPERADT",xFilial("SED")+aLinSE1[oLBSE1:nAt][nPosNATU],1,"") == "1"
				MsgAlert(STR0195) //"Nใo ้ possivel selecionar registros de recebimento antecipado que possuam natureza com opera็ใo de adiantamento habilitada."
				Return
			EndIf

			//---------------------------------------------------------------
			// Nao permite a selecao de titulo gerados pelo faturamento com
			// opera็ใo de adiantamento habilitada com outros titulos
			//---------------------------------------------------------------
			nTitSel := AScan(aLinSE1, {|x| x[1] == 1}) //Caso haja registro selecionado obtem a posicao

			If cPaisLoc == "MEX"
				If FWHasEAI("FINA087A",.T.,,.T.) //Valida que rutina se encuentre configurada como adapter para integraci๓n EAI
					...
					If nQtdDRM >= 1 .Or. (Alltrim(aLinSE1[oLBSE1:nAt][nPosOri]) $ "FINI055|FINI040" .And. nQtdDPro > 0)
						// MsgAlert(STR0215) //"Para baja de tํtulos generados a partir de rutina FINI055 o FINI040 s๓lo se permite baja uno a uno, verifique seleccionados."
						Return
					EndIf
				EndIf
			EndIf
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณPonto de entrada antes da montagem da tela de baixas,	ณ
	//ณpermite que o analista configue os valores para baixa.	ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	...
	If cPaisLoc == "MEX"
		If (AllTrim(SE1->E1_ORIGEM) $ "FINI055|FINI040" .And. lRet  .And. SE1->E1_SITUACA == "0")
			If FWHasEAI("FINI087A",.T.,,.T.) //Valida que rutina se encuentre configurada como adapter para integraci๓n EAI
				SE1->(msUnlock())
				SetRotInteg('FINI087A')
				//				MsgRun ( "STR0216NAHIM" + " " + RTrim(SE1->E1_NUM)+ " " + "STR0217NAHIM",STR0218,{||aRetMsg:=Fini087A()} ) //"Actualizando el titulo" "a valor presente..." "Valor Presente"
				MsgRun ( "STR0216NAHIM" + " " + RTrim(SE1->E1_NUM)+ " " + "NAHIMSTR0217","NAHIMSTR0218",{||aRetMsg:=Fini087A()} ) //"Actualizando el titulo" "a valor presente..." "Valor Presente"
				...
				If ValType(aRetMsg) == "A" .And. Len(aRetMsg) > 0
					If ValType(aRetMSg[1]) <> "U" .and. !aRetMsg[1]
						...
						Else
							MsgAlert("NAHIMSTR0220" + " " + Rtrim(SE1->E1_NUM) + ". " + "NAHIMSTR0221") //"Hubo un error inesperado en el intento de actualizacion del titulo " "Verifique las configuraciones de la integraciำn e intente nuevamente."
						EndIf
						lRet := .F.
			...
			Else
				lRet := .F.
				MsgAlert("STR0222NAHIM") //"Para realizar las bajas de integraciones como TIN, es necesario archivar el adapter de la rutina FINI087A - UPDATECONTRACTPARCEL."
			EndIf
		EndIf
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFAPagtoAtuบAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณDCLBMoed  บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณDCLBBaixa บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑบPrograma  ณFa087aBaixaOKบAutor  ณMicrosiga           บ Data ณ 03/23/11 บฑฑ
...
Static Function Fa087aBaixaOK(cNumFatAut)
	...
	For nX:=1 To nQtMoedas
		...
		If aLinBaixa[nX][2]>0 .And. aTaxa[nX]<=0
			Alert(STR0052) //"Informe todas as taxas das moedas que serใo utilizadas nas Baixas."
			Return .F.
		Endif
	Next nX
	...
	If Round(nValRec,nDec)>Round(nSaldo+nRetCfg,nDec)
		Alert(STR0053) //"Valor Recebido nใo pode ser maior que o saldo a receber."
		Return .F.
	Endif
...
ฑฑบPrograma  ณFA087aUnlockบAutor  ณMicrosiga           บ Data ณ 03/23/11  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณFA087aAtuCliบAutor  ณMicrosiga           บ Data ณ  03/23/11 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณFa087aSalvarบAutor  ณMicrosiga           บ Data ณ  03/23/11 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
static Function Fa087aSalvar(lTela,lGerNCC,cNumFatAut,lIncAdt,aRecAdt)
	...
	Local nDifDesc := 0
	Local nPosUlt := 0
	local nColig		:= GetNewPar("MV_RMCOLIG",0) //Verifica se a integra็ใo com o TOP estแ ativa
	...
	If cPaisLoc == "MEX"
		...
		EndIF
	EndIf
	If .F.//nPanel != nLastPan NAHIM NO ENTRA
...
//	If !(Fa087aTudoOk(cNumFatAut,lIncAdt)) Nahim quitando validaci๓n
//		Return .F.
//	Endif
	lTela:= .F.
	If lTela
	...
	//Verificar abatimentos atrav้s das Reten็๕es e validar totais
	If cPaisLoc $ "EQU"
		nTotal    := 0
		nTotReceb := 0
		...
		Next nX
		If !lSelectSE1
			//###"Seleccione por lo menos una factura a cancelar en la tercera pantalla."###"Aten็ใo"
		...
		Next nCount
		If nTotReceb > nTotal
			lGerNCC:=MsgYesNo(STR0055+ cDocCred +	STR0056,STR0048)
		EndIf
	Else
		// nahim probando que devuelve el err
		//	ConOut("nTotal : " + cvaltochar(nTotal))
		//	ConOut("nTotalBx: " + cvaltochar(nTotalBx))
		If lIncAdt .and. (nTotal > 0 .and.( nTotal >= nValMinRa))
			lGerNCC:= .T.
		ElseIf !lGerNCC .And. (nTotal > 0 .and.( nTotal >= nValMinRa .or.nTotalBx  ==0 ))
// 	lGerNCC:=MsgYesNo(STR0055+ cDocCred +	STR0056,STR0048) Nahim Quitando si pregunta si recibe RA
			lGerNCC := .T. // nahim cambiando
			If !lGerNCC
				Return .F.
			EndIf
		Endif
	...
	If nDescGer >0
		...
		Else
			// Tratamento para quando existir rateio e ao calcular o rateio do ultimo titulo o valor rateado nใo seja o valor total do
			// desconto informado, neste caso serแ ajustado o valor restante no ultimo titulo.
			For nX:=1 to Len(aLinSE1)
	...
	If lExiste
		...
		//ณSe utiliza controle de numeracao sem SERIE, estou utilizando        ณ
		//ณos semaforos, portanto nao posso simplesmente pegar o proximo numeroณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		If !SuperGetMv('MV_SERREC')
			Help(" ",1,"EXISTNUM")
			Return .F.
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณSe utiliza controle de numeracao COM SERIE, NAO estou utilizando os ณ
			//ณsemaforos, e sim o SX5, portanto posso pegar o proximo numero disp. ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		Else
			...
			If cRecAnt  <> cRecibo
				lOk:= .T. //MsgYesNo(OemToAnsi(STR0117) + cRecAnt +OemToAnsi(STR0118) + cRecibo) Nahim 03/09/2019
...
//	Begin Transaction // Nahim quitanod el begin transaction
	...
	//Verifica se nใo ha linhas repetidas com uma excluida e outra ativa e caso haja modifica para nใo gerar inconsistencia
	For nX:=1 to Len(aCols)
		If aCols[nX][Len(aCols[nX])]
	...
	//Gerar o n๚mero do processo do Recibo
	...
	For nX:=1 to Len(aCols)
		If	SEL->(DbSeek(xFilial("SEL")+cSerie+cRecibo+aCols[nX][nPosTpDoc]+aCols[nX][nPosPrefixo]+;
			...
			Else
				...
				// nahim 2019/08/28 cambiando por moneda
				nPosMoneda	:= AScan(aCposSEL,"EL_MOEDA")
				aCols[nX][nposmoneda] := cvaltochar(aCols[nX][nposmoneda])// NAHIM MODIFICANDO LA MONEDA para string
				// nahim 2019/08/28
		...
		Else
			...
			If aCols[nX][nPosTpDoc] $ cTiposAdm
				...
				SEL->EL_TIPODOC := aDadosAdm[nPosDados][04]
			EndIf
			//		SEL->EL_VLMOED1:= Round( SEL->EL_VALOR*aTaxa[Val(SEL->EL_MOEDA)] , MsDecimais(1)) NAHIM CAMBIANDO POR MONEDA 1
			//SEL->EL_MOEDA := "1"
			SEL->EL_VLMOED1:= Round( SEL->EL_VALOR*aTaxa[Val(SEL->EL_MOEDA)] , MsDecimais(1))
			...
			If cPaisLoc == "ARG"
				...
				If SEL->EL_TIPODOC == "CH"   //Cheque
					PcoDetLan("000361","01","FINA087A")
				ElseIf SEL->EL_TIPODOC $ "RI|RG|RB|RS" // Retencion IVA
					PcoDetLan("000361","03","FINA087A")
				ElseIf SEL->EL_TIPODOC == "EF" // En Efectivo
					PcoDetLan("000361","04","FINA087A")
				ElseIf SEL->EL_TIPODOC == "TF" // Deposito
					PcoDetLan("000361","05","FINA087A")
				Endif
			Endif

			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณ Grava็ใo das Reten็๕es de IVA,Rentas ou ISRL - Equador                ณ
				...
				If AllTrim(aCols[nX][nPosTpDoc]) $ "RI|RR"
					...
					If Len(aNumCert) > 0
						...
						For nCount := 1 To Len(aConcepto)
							...
							MsUnLock()
						Next nCount
						//Grava Tํtulo de Abatimento no Contas a Receber.
						If Len(aConcepto) > 0
			...
			//ณ Grava็ใo da tabela de Cheques - Controle de Cheques - Equador.                ณ
		...
		If aCols[nX][nPosTpDoc] $ cCredMed
			...
			//+------------------------------------------------------------------------------+
			//ฆ Gerar registro no SE1 se sao cheques ou pagtos sem movimenta็ใo imediata.    ฆ
			//+------------------------------------------------------------------------------+
			SE1->(DbSetOrder(2))
			...
			//+--------------------------------------------------------------------------------+
			//ฆSi no se ingreso el banco o se ingreso en una caja, SITUACA es 0 (en cartera)   ฆ
			//+--------------------------------------------------------------------------------+
			...
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณCalculo para o tempo de Clearing, o tempo de Clearing estaณ
			//ณsendo calculado somente com dias uteis corridos.          ณ
			//ณSe o Tempo for de mais de uma semana, coloco uma data de  ณ
			//ณaqui a dez anos assim tem que ser acreditado manualmente. ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			...
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณIntegracao com SigaLoja que grava o numero da NF no campo ณ
			//ณE1_NUM. Apos a emissao da NF, a referencia passa a ser o  ณ
			//ณnumero do cheque - Loc. Paraguai                          ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			If cPaisLoc == "PAR"
		...
		If aCols[nX][nPosCred] $ "1|2" .Or. aCols[nX][nPosTpDoc] $ cCredInm
			//Valida a grava็ใo do modelo de baixa ou movimento bancแrio.
		...
		//ณCalculo da Comissao do Cobrador caso o mesmo seja informado no Recibo e grava no ณ
		//ณarquivo SEX                                                                      ณ
	...
	If !lIncAdt
		...
		For nX:=1 to Len(aLinSE1)
			...
			//ณ Caso a Natureza do titulo for de adiatamento ED_OPERADT = 1    ณ
			//ณ gera o titulo do tipo "RA" com base no titulo de adiantamento. ณ
			...
			If cPaisLoc == "COS" .And. SE1->E1_SALDO == SE1->E1_VALOR
				...
				For nCount := 1 To Len(aConcepto)
					...
					If FRM->(MsSeek(xFilial("FRM") + aConcepto[nCount][7] + StrZero(0,Len(FRM_SEQ))))
						...
						//-- Baixa o Tํtulo de Reten็ใo de Impostos
						SE1->(DbSetOrder(1)) //-- E1_FILIAL+E1_PREFIXO+E1_NUM+E1_PARCELA+E1_TIPO
			...
			ElseIf cPaisLoc == "COS" .And. !(SE1->E1_SALDO == SE1->E1_VALOR)
				...
				For nCount := 1 To Len(aConcepto)
					...
					//Verifica se jแ existe o tํtulo, e vai trocando a parcela
					cParcTx := aDadosTit[3]
					SE1->(dbSetOrder(1))
					cTpFrmRetn := FRM->FRM_TPABT

					//Necessแrio posicionar o tipo certo antes de procurar a parcela, quando existe mais de uma reten็ใo no documento
					If Len(aConcepto) > 1
			...
			//Valida a grava็ใo dos movimentos com uso do modelo de baixa ou movimento bancแrio.
			//conout("FaGrvSE5 2")
			...
			EL_TIPODOC  := "TB"
			EL_UOBSTAR  := "REST Rut. "+ cIdTransc // 30/08/2019 Nahim Terrazas
			if type("OPagBajasNT:IDAPP") <> "U"
				EL_UIDAPPM	:= cvaltochar(OPagBajasNT:IDAPP)// NAHIM ADICIONANDO ID
			endif
			...
			If cPaisLoc $ "ARG|COS"
				...
				//ณ Grava os lancamentos nas contas orcamentarias SIGAPCO    ณ
				//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
				PcoDetLan("000361","06","FINA087A") // Cobran็as diversas - Transferencia Bancaria
			Endif
			...
			If cPaisLoc == "MEX" .And. nQtdF055 > 0
				If FWHasEAI("FINA087A",.T.,,.T.) //Valida que rutina se encuentre configurada como adapter para integraci๓n EAI
					...
					//Se der erro no envio da integra็ใo, entใo faz rollback e apresenta mensagem em tela para o usuแrio
					If ValType(aRetInteg) == "A" .AND. Len(aRetInteg) >= 2 .AND. !aRetInteg[1]
						If ! IsBlind()
							Help( ,, "FINA087INTEG",, "NAHIMSTR0220" + ": " + "NAHIMSTR0223" + " - " + AllTrim( aRetInteg[2] ), 1, 0,,,,,, {"NAHIMSTR0221"} ) //"Hubo un error inesperado en el intento de actualizacion del titulo " "Baja de titulos" "Verifique las configuraciones de la integracion e intente nuevamente."
						EndIf
						DisarmTransaction()
						Return .F.
					EndIf
	...
	//ณ Faz as gravacoes dos titulos que tem retencoes no SFE		 ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	If cPaisLoc == "ARG" .And. Len(aCols) > 0
		DbSelectArea("SFE")
		nX	:=	0
		//Rateia os impostos nos titulos informados
		For nI:= 1 to Len(aCols)
			If (aCols[nI][nPosTpDoc] $ "RS|RL|RB|RI|RG") .And. !aCols[nI][Len(aHeader)+1]//Verifico se a linha nใo foi marcada como deletada
				nX++
				SE1->(DbSetorder(1))
				For nY := 1 to Len( aLinRet[nX])
					If aCols[nI][nPosTpDoc] == "RB"
						If !aLinRet[nX][nY][Len(aLinRet[nX,nY])] .And. (aLinRet[nX][nY][Len(aLinRet[nX,nY])-1] > 0) .And. ;
								(!lRatImp .Or.(SE1->( DbSeek(xFilial("SE1")+aLinRet[nX][nY][1]+aLinRet[nX][nY][2]+aLinRet[nX][nY][3]+aLinRet[nX][nY][4]) )))
							RecLock("SFE",.T.)
							FE_FILIAL   := xFilial('SFE')
							FE_EMISSAO  := dDataRef
							FE_CLIENTE  := cCliente
							...
							If lRatImp
								...
								FE_VALBASE 	:= aLinRet[nX][nY][7]
								FE_ALIQ		:=	aLinret[nX][nY][8]
								FE_RETENC 	:= aLinRet[nX][nY][9]
							Else
								FE_EST 		:= aLinRet[nX][nY][1]
								FE_CFO	 	:= aLinRet[nX][nY][2]
								FE_VALBASE 	:= aLinRet[nX][nY][3]
								FE_ALIQ		:=	aLinret[nX][nY][4]
					...
					ElseIf aCols[nI][nPosTpDoc] == "RI"
						If !aLinRet[nX][nY][Len(aLinRet[nX,nY])] .And. (aLinRet[nX][nY][Len(aLinRet[nX,nY])-1] > 0)
							RecLock("SFE",.T.)
							FE_FILIAL   := xFilial('SFE')
							FE_EMISSAO  := aCols[nI][nPosEmis]
							FE_CLIENTE  := cCliente
							FE_LOJCLI 	:= cLoja
							FE_EST 		:= aLinRet[nX][nY][1]
							FE_CFO	 	:= aLinRet[nX][nY][2]
				...
				Next nY
			Else
				If (aCols[nI][nPosVal] > 0) .And. (aCols[nI][nPosTpDoc] $ "RI") .And. !aCols[nI][Len(aHeader)+1]//Verifico se a linha nใo foi marcada como deletada
					RecLock("SFE",.T.)
					FE_FILIAL   := xFilial('SFE')
					FE_NROCERT	:= aCols[nI][nPosNumero]
					FE_EMISSAO  := dDataRef
		...
		For nValMoed := 1 to Len(aLinMoed)
			...
			If nVlrTit > 0
				...
				If cPaisLoc $ "ARG|COS"
					...
					//ณ Grava os lancamentos nas contas orcamentarias SIGAPCO    ณ
					//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
					PcoDetLan("000361","02","FINA087A") // "Cobran็as diversas - Recebimento Antecipado"
				Endif
				//-- Registro no SE1
				RecLock("SE1",.T.)
				SE1->E1_FILIAL   	:= xFILIAL("SE1")
				...
				if type("OPagBajasNT:HISTORIAL") <> "U"
					//  SE1->E1_HIT     	:= cDocCred Nahim HISTORIAL 09/10/2020
					SE1->E1_HIST 		:= OPagBajasNT:HISTORIAL
				endif
				...
				Endif
				//integra็ใo Protheus Argentina X TOP
				If !lMsgUnica
					If nColig >0 .and. IntePms().and. MsgYesNo (OemToAnsi(STR0192)+" "+"("+cDocCred+")"+" ";
							+AllTrim(SE1->E1_NUM)+" " +OemToAnsi(STR0193)+" " +GetMv("MV_SIMB1")+" " + AllTrim(Transform(SE1->E1_VLCRUZ,PesqPict("SE1","E1_VLCRUZ")))+" " +OemToAnsi(STR0194))//"Voc๊ deseja associar o tํtulo" "de valor" "a um projeto?"
						PmsFi087a()
					Endif
				Endif
				MsUnlock()

				aadd(aRecAdt,{SE1->(RECNO()),SE1->E1_VALOR}) //Controle de inclusใo de adiantamentos
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณPonto de entrada depois da grava็ใo de TODOS os arquivos ณ
	//ณe antes da contabilidade                                 ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	...
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณAtualiza o cadastro de Recibo x Cobradores			    ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	If nRecnoSEY>0
	...
	If !lIncAdt
		//Gera diferen็a de cambio automatica apos a grava็ใo do recebimento diversos
		aSort(aLinSE1,,,{|x,y| x[1]>y[1]})			// Organiza aLinSE1 para que os marcados venham primeiro.
		If lGeraDCam .And. cPaisLoc$"ARG|COS" .And. lTemMon // verifica se a moeda eh maior que 1 e se irแ gerar diferen็a automatica
			DbSelectArea("SE1")
...
//	End Transaction // nahim quitando el transaction
	//Libera codigo usado pela MayIUseCode
	FreeUsedCode()
	//Destrava os registros que tenham ficado travados
	FA087aUnlock()

	//Ponto de entrada ap๓s a grava็ใo da tabela SEL
	If ExistBlock("FA087SEL")
		ExecBlock("FA087SEL",.F.,.F.)
	Endif

	If cPaisLoc == "MEX" .and. lCfdi33 .And. nQtdF055 == 0
		If nImpAuto <> 0
			If nImpAuto == 1
				FISA815(cRecibo,cSerie)
			EndIf
		ElseIf MSGYESNO( STR0210, STR0209 ) //"ฟDesea realizar el Complemento de Recepci๓n de Pago?" - "Complemento de Recepci๓n de Pagos"
			FISA815(cRecibo,cSerie)
		EndIf
	EndIf
	...
	If cPaisLoc $ "ARG|COS"
		////////////////////////////////////////
		// Finaliza integra็ใo com M๓dulo PCO //
		////////////////////////////////////////
		PcoFinLan("000361")
	Endif
Return .T.
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFaGrv     บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFaGrvSE5  บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
Static Function FaGrvSE5(nTipo,cTpCred,cNatureza,cProc,nPosLin)
	...
	Local lGrvMov := .T.
	/*
	* Reestrutura das tabelas do processo de movimento bancแrio
	*/
	...
	Local cHistMov    	:= ""
	Local lRet			:= .T. //Valida็ใo do Modelo
	Local aAlt := {}
	...
	If nTipo==1
		...
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Taxa da moeda: calcula segundo valores do titulo SE1         ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		...
		//ณA correcao monetaria nao deve ser gravada pois os pagamentos sao feitos em bloco,    ณ
		//ณe nao temos como saber se o titulo foi pago com a mesma moeda (neste caso nao existe ณ
		//ณcorrecao monetaria) ou com outra moeda diferente.                                    ณ
		//ณA correcao eh tratada nos relatorios.                                                ณ
		...
		//Atualiza saldo dos valores acess๓rios (FKD)
		If lExistFKD
			FAtuFKDBx(.F.)
		EndIf
		...
		///chamada da Fun็ใo que cria o Hist๓rico de Cobran็a
		FinaCONC(aAlt)

	ElseIf nTipo==2
		cMotBx		:= IF(Empty(SE1->E1_MOTIVO),"NOR",SE1->E1_MOTIVO) // NAHIM AGREGANDO TIPO DE movimiento
		If l087GrSE5
		...
		If lGrvMov
			...
			oModelMov:Activate()
			oModelMov:SetValue( "MASTER", "E5_GRV", .T. ) //habilita grava็ใo de SE5
			oModelMov:SetValue( "MASTER", "IDPROC", cProc )
			oModelMov:SetValue( "MASTER", "NOVOPROC", .F. ) //Informa que a inclusใo nใo serแ feita com um novo n๚mero de processo
			...
			//IIF(! SA6->(DbRlock(SA6->(Recno()))),Conout("BLOQUEADO ANTES CCAMPOSE5"),Conout("NO BLOQUEADO CCAMPOSE5"))
			...
			//Os campos do Banco/Agencia/Conta do cheque estarใo apenas na tabela correspondente ao cheque (SEF)
			If cPaisLoc $ "EQU|DOM"
			...
			oSubFKA:SetValue( "FKA_TABORI" , 'FK5' ) //Todo o recibo precisa do mesmo n๚mero de processo
			...
			//IIF(! SA6->(DbRlock(SA6->(Recno()))),Conout("DESP ANTES CCAMPOSE5"),Conout("DESP BLOQUEADO CCAMPOSE5"))
			...
			IF !EMPTY(SEL->EL_BANCO).And. MovBcoBx(cMotBx, .T.) .and. !lAdiantamento
				...
				//ณ Gravar Saldo Banc rio	        ณ
				//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู

				AtuSalBco(cBanco,cAgencia,cConta,dBaixa,SE5->E5_VALOR,"+")


				// Nahim verifica SA6 O SE8 04/11/2020 para para ver si existe un bloqueo.
				/*nRecBcoBkp := SA6->(Recno())
				nRecSE8bkp := SE8->(Recno())

				dbSelectArea("SA6")
				SA6->(DbSetOrder(1))

				if SA6->(dbSeek(cFilial+cBanco+cAgencia+cConta))
					If !InTransact()
						SA6->(MsRUnlock(SA6->(Recno())))
					Else
						SA6->( MsUnLock() )
					EndIf
				endif
				...
				dbSelectArea("SE8")
				SE8->(DbSetOrder(1))
				if SE8->(DbSeek(xFilial("SE8")+cBanco+cAgencia+cConta+DtoS(dBaixa),.t.))
					If !InTransact()
						SE8->(MsRUnlock(SE8->(Recno())))
					else
						SE8->( MsUnLock() )
					endif
				endif
				...
				nTentativa := 0
				while ! SA6->(DbRlock(SA6->(Recno())))
					nTentativa++
					IF nTentativa == 30
						Conout( 'SA6 BLOQUEADO DEMASIADOS INTENTOS' )
						return .f.
					endif
					Conout( 'SA6 BLOQUEADO WHILE' )
					sleep( 1000 )
					SA6->( MsUnLock() )
					SA6->(dbCloseArea())
					dbSelectArea("SA6")
				...
				If ! SA6->(DbRlock(SA6->(Recno())))
					Conout( 'SA6 BLOQUEADO' )
					Return .F.
				else
					dbSelectArea("SE8")
					SE8->(DbSetOrder(1))
					SE8->(DbSeek(xFilial("SE8")+cBanco+cAgencia+cConta+DtoS(dBaixa),.t.))

					nTentativa := 0
					while ! SE8->(DbRlock(SE8->(Recno())))   ///PODEMOS PONER INTENTOS
						nTentativa++
						IF nTentativa == 30
							Conout( 'SE8 BLOQUEADO DEMASIADOS INTENTOS' )
							return .f.
						endif
						Conout( 'SE8 BLOQUEADO WHILE' )
						sleep( 1000 ) ///15 seg
						SE8->( MsUnLock() )
						SE8->(dbCloseArea())
						dbSelectArea("SE8")
					...
					If ! SE8->(DbRlock(SE8->(Recno())))
						Conout('SE8 BLOQUEADO')
						Return .F.
					else
						AtuSalBco(cBanco,cAgencia,cConta,dBaixa,SE5->E5_VALOR,"+")
					endif
				...
				SA6->(DbGoTo(nRecBcoBkp))   // Reposiciona no Banco da entrada da funcao
				SE8->(DbGoTo(nRecSE8bkp))   // Reposiciona no Banco da entrada da funcao
				// Nahim termina actualizaci๓n.
				*/
			EndIf
		EndIf
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFa087Cont บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
Static Function Fa087Cont()
	...
	If lLancPad70
		...
		//ณ Inicializa Lancamento Contabil                                   ณ
	...
	If nHdlPrv > 0 .and. lLancPad70
		//	Conout("pasa lLancPad70")	// Nahim para ver si genera o no
		//+--------------------------------------------------+
		//ฆ Gera Lancamento Contab. para RECIBO.             ฆ
		//+--------------------------------------------------+
		If lLancPad70
			SEL->(DbSetOrder(8))
			SEL->(DbGotop())
		...
		//	Conout("pasa 1")	// Nahim para ver si genera o no
		//	Conout(lLanctOk)	// Nahim para ver si genera o no
		If lLanctOk
			SEL->(DbSetOrder (8))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณa087aWhen บAutor  ณBruno Sobieski      บ Data ณ  07/30/01   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณPermissao de digitacao dependendo de outros campos.		  บฑฑ
ฑฑบ          ณX3_WHEN                                                     บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณFa087aCancelบAutor  ณMicrosiga           บ Data ณ 03/23/11  บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณa087Lock  บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณA087aSugerirบAutor  ณMicrosiga           บ Data ณ 03/23/11  บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณA087aFiltrarบAutor  ณMicrosiga           บ Data ณ  03/23/11 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑบPrograma  ณCalcField  บAutor  ณMicrosiga           บ Data ณ  03/23/11  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณBuildTxt  บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFilterExp บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
Static Function FilterExp(cTxtFil,cExpFil)
	...
	DEFINE MSDIALOG oDlg TITLE OemToAnsi(STR0094) FROM 0,0 TO 100,500 OF oPai PIXEL //"Expressใo:"
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณAFilOk    บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณA087DescontoบAutor  ณMicrosiga           บ Data ณ 03/23/11  บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณA087OKDescบAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
Static Function A087OKDesc(cNumFatAut)
	...
	// Para poder fazer a valida็ใo do valor do desconto, transformo o valor
	...
	If nDescTot > 0
		...
		nTot:=nTot/aTaxa[nMoedDesc]
		If nDescTot > nTot
			Alert(STR0096)  //"Valor do desconto nใo pode ser maior que o valor a baixar."
			Return .F.
		Endif
	EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณF087aMotBxบAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณa087VerPE บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑณFuno    ณTelaAdmCarณ Autor ณ Fernando Machima      ณ Data ณ19/08/2001ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Mostra a tela para selecionar a administradora de cartao deณฑฑ
ฑฑณ          ณ credito                                                    ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ FINA087A                                                   ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณFA087COB  ณ Autor ณ Paulo Augusto         ณ Data ณ07/08/2002ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Valida para saber se o recibo pertence ao cobrador e tb se ณฑฑ
ฑฑณ          ณ esse talao ja esta fechado                                 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ FINA087A                                                   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFuno    ณFa087Com  ณ Autor ณ Paulo Augusto         ณ Data ณ07/08/2002ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescrio ณ Grava o arquivo de comissoes  de cobrador                  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ FINA087A                                                   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑณFun…o    ณ A087aMarca() ณAutor ณ  Paulo Augusto       ณDataณ 19.02.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Inverte selecao na tela de clientes                        ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณFa087Ser  ณ Autor ณ Gilson da Silva       ณ Data ณ28.05.03  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Achoice para numero e serie do Recibo vindo do SX5         ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณ Uso      ณ FINA087A                                                   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณF087AGrvTx  บAutor  ณCristiano Denardi   บ Data ณ22.01.2004 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณGrava taxa da Moeda em SEL para qdo existirem campos        บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087aProf()  ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Retorna Array contendo lista de campos gravados no Profile ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087aCFG()   ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Configurador da ordem das colunas de recibo no Profile     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087aCFGCo() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Verifica Profile e monta lista de campos                   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087aCFGPR() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Resgata a lista do profile e mescla com campos de SX3      ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087aCFGNR() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Cria a lista nova de campos                                ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGlst() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Desconsidera a lista atual e restaura a config. inicial    ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGbmp() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Efetua a troca do BMP de aCOls                             ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGsel() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Troca a selecao de campos para NAO SELECIONADOS            ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGOrd() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Organiza aCols qdo e trocado a ordem de um campo           ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGgrv() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Grava lista de campos no profile do usuario corrente	      ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGfol() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Trata a troca de folder, fazendo a troca do valor de aCols ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ A087CFGleg() ณAutor ณCristiano Denardi     ณDataณ 19.08.03 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ F087Get      ณAutor ณJulio Ceasr           ณDataณ 08.07.04 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Cria um get com os parametros informados.                  ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ Fa087aRet()  ณAutor ณSabrina Passini SoaresณDataณ 17.06.04 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Funcao que verifica se ha retencoes recebidas e chama a    ณฑฑ
ฑฑณ          ณ montagem do panel correspondente para rateio dos valores   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function Fa087aRet()
	...
	//ณ StrTokArr: Esta funcao pega uma string com separadores e faz virar um array ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู

	Local aDesc  := StrTokArr(oGetsel:aInfo[AScan(aCposSEL,"EL_TIPODOC")][2], ';')

	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Carrega array com os titulos (NF) selecionados para distribuir as retencoes ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	...
	For nX:=1 To Len( aLinSE1 )
		If aLinSE1[nX][1]== 1 // Titulo selecionado
			...
			ElseIf Alltrim(aLinSE1[nX][nPosTipo]) $ "NF|NDC" .AND. lSerie2
				...
				cPrefSF := "F2_"
			EndIf
			If cPaisLoc $ "ARG|COS" .Or. (!Alltrim(aLinSE1[nX][nPosTipo]) $ MV_CRNEG .Or. Alltrim(aLinSE1[nX][nPosTipo])=="CC") .OR. (cPaisLoc == "PER" .AND.  Alltrim(aLinSE1[nX][nPosTipo])=="NCC")
				Aadd( aLinTit, { aLinSE1[nX][nPosPref], aLinSE1[nX][nPosNum], aLinSE1[nX][nPosParc], ;
					aLinSE1[nX][nPosTipo], 0, "", "",IIf(lSerie2,Posicione("SF2",1,xFilial("SF2")+aLinSE1[nX][nPosNum]+aLinSE1[nX][nPosPref]+aLinSE1[nX][nPosCli]+aLinSE1[nX][nPosLoja],"F2_SERIE2"),"") } )
			EndIf
		EndIf
	Next
	...
	For nI:=1 To Len(aCols)
		If  !aCols[nI][Len(aHeader)+1] .And.  ((cPaisLoc $ "ARG|COS" .And. ( aCols[nI][AScan(aCposSEL,"EL_TIPODOC")] $ 'RB|RS|RL|RI|RG' )) ;
			...
			If Len(aLinTit) > 0 .And. ((cPaisLoc $ "ARG|COS" .And.aCols[nI][AScan(aCposSEL,"EL_TIPODOC")] $ "RB|RI|RS|RG" ) .Or. ( cPaisLoc == "PER" .And. aCols[nI][AScan(aCposSEL,"EL_TIPODOC")] $ 'RI' ))
				nNumRet++
				...
				If Len(aLinTit)> 1  .Or. (cPaisLoc $ "ARG|COS|PER" .And. (aCols[nI][AScan(aCposSEL,"EL_TIPODOC")] $ "RB|RI|RS|RG"))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ MostraRets() ณAutor ณSabrina Passini SoaresณDataณ 18.06.04 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
...
Static Function MostraRets( cRetText, nRetVal, cRetNum, aCab, aItRet,cRet ,lRatImp,nMoeda)
	...
	ACTIVATE MSDIALOG oDlgRet ON INIT EnchoiceBar(oDlgRet, {||( If ( A87VldRet(aItRet, nRetVal,nTipo,oGetd, lRatImp), (lRet := .T.,If(cRet $ "RB|RI|RS|RG" , aItRet	:=	aClone(oGetD:aCols),Nil), oDlgRet:End()),.F.) )} , {||(lRet := .F., oDlgRet:End()) }) CENTERED
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณDblClickBrowบAutor  ณMicrosiga           บ Data ณ 03/24/11  บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
Valida็ใo Botใo OK - Tela MostraRets
@author Totvs
@since  26/06/2015
@version 12
/*/
...
/*/
	...
	ฑฑณFun…o	 ณFa087GrvIVA() ณ Autor ณ Paulo Augusto         ณ Data ณ 20/12/06 ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณDescri…o ณ Gravacao dos campos do Iva para o Mexico                       ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณSintaxe	 ณ Fa087GrvIVA()              								      ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณ Uso		 ณ FINA87a													      ณฑฑ
	...
	If Found()
		...
		For nX := 1 to Len(aGrvSE)
			...
			If (aGrvSE[nX,1])->(FieldPos(aGrvSE[nX,2]))> 0
				...
				//atribui็ใo de valor no campo, caso o mesmo exista.
...
/*/
	...
	ฑฑณFun…o    ณFinA087AT  ณ Autor ณ Marcelo Celi Marques ณ Data ณ 15.05.08 ณฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณFun…o    ณ Fa087aIGV()  ณAutor ณAna Paula					 03.11.09 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescri…o ณ Funcao que verifica se ha retencoes recebidas e chama a    ณฑฑ
ฑฑณ          ณ montagem do panel correspondente para rateio dos valores   ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
...
Static Function Fa087aIGV(cCliente,cLoja,cNumFatAut)
	...
	If Len(aLinTit)< 1 .And. lCalcPerc  .And. lPercRA .And. aCols[1][nPosVal]>0
		...
		//ณ Montagem do PANEL de aliquotas para percep็ใoณ//
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤ
		oAPerc:=TPanel():New(84,00,,oDlgRecibo,,,,,,127,117,.F.,.T.)

		@ 003,001 GROUP oGrp6 TO 103, 123 LABEL OemToAnsi(STR0157) OF oAPerc  PIXEL  //"Percep็ใo IGV"
		...
		@ 030,005 SAY OemToAnsi(STR0156) SIZE 60,07	OF oAPerc PIXEL //"Valor Percep็ใo"
	...
	Elseif lCalcPerc //Verifica percep็ใo de titulos gerados por faturamento
...
ฑฑบPrograma  ณ Fa087CalcPerบAutor  ณAna Paula           บ Data ณ 03/11/09  บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณCalcula percep็ใo para RA e NFs geradas por faturamento(Peru)บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                    บฑฑ
ฑฑศออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
static Function Fa087CalcPer(nAliqPerc,lPercAdi)
	...
	DEFAULT lPercAdi:= .F.
	aPerc:={}
	If lPercAdi    // Calcula percep็ใo para adiantamentos gerados direto por recibos
		...
		If nValPerc > 0
			lTitAd := .T. // Determina que ้ adiantamento
			Aadd(aPerc,{nValPerc,nAliqPerc,nBasePerc,,,,cDocCred,lTitAd})
		EndIf

	Else    // Verifica a percep็ใo calculada na emissใo da nota
		aArea:=GetArea()
		nValPerc:=0
		For nX:=1 to Len(aLinTit)
			If !aLinTit[nX][4] $(MVRECANT+"/"+MV_CRNEG)
				// Verifica a percep็ใo calculada na emissใo de notas de //
				...
				If dbSeek(xFilial("SF2")+aLinTit[nX][2]+aLinTit[nX][1]+aLinTit[nX][3]+aLinTit[nX][5])
					IF SF2->F2_VALIMP4 > 0
						...
						nVlPeOrig:= Round(xMoeda(SF2->F2_VALIMP4,aLinTit[nX][8],1,3,,aTaxa[aLinTit[nX][8]]),MsDecimais(oCBMOed:nAt))// Valor da percep็ใo calculado na emissao da nota
						...
						nAliqPerc := Round((nVlPeOrig/nValMerc),MsDecimais(oCBMOed:nAt))*100 // Aliquota percep็ใo SD2->D2_ALIQMP4
						nBasePerc := Round((nValProp * nValMerc),MsDecimais(oCBMOed:nAt)) // Base percep็ใo
						...
						lTitAd := .F. // Determina que nao ้ um adiantamento
					EndIf
					If nValPerc > 0
			...
			Else
				...
				If dbSeek(xFilial("SF1")+aLinTit[nX][2]+aLinTit[nX][1]+aLinTit[nX][3]+aLinTit[nX][5])
					IF SF1->F1_VALIMP4 > 0
						...
						nVlPeOrig:= Round(xMoeda(SF1->F1_VALIMP4,aLinTit[nX][8],1,3,,aTaxa[aLinTit[nX][8]]),MsDecimais(oCBMOed:nAt))// Valor da percep็ใo calculado na emissao da nota //SF1->F1_VALIMP4 // Valor da percep็ใo calculado na emissao da nota
						nValProp := Round(nValRec/nValTit,6) // Valor proporcional
						...
						nAliqPerc := Round((nVlPeOrig/nValMerc),MsDecimais(oCBMOed:nAt))*100 // Aliquota percep็ใo SD1->D1_ALIQMP4
						nBasePerc := Round((nValProp * nValMerc),MsDecimais(oCBMOed:nAt)) // Base percep็ใo
						nValPerc:=Round(nBasePerc*(nAliqPerc/100),MsDecimais(oCBMOed:nAt))
						cNumTit:= SF1->F1_DOC
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ F087aPerok บAutor  ณAna Paula           บ Data ณ  04 /11/09บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณvalida a inclusใo da aliquota de percep็ใo		          บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ GetCertPer บAutor  ณMicrosiga           บ Data ณ    /  /   บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณPega os numeros de certificados de percep็ใo(Peru)          บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณCkNaturezaบAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณlRetCkPG  บAutor  ณMicrosiga           บ Data ณ  03/23/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ fa087FilTipoบAutor  ณ Jos้ Lucas         บ Data ณ 02/12/10 บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDesc.     ณ Fun็ใo para cria็ใo de filtro no gatilho campo EL_TIPODOC. บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ fa087TipCredบAutor  ณ Jos้ Lucas         บ Data ณ 02/12/10 บฑฑ
ฑฑฬออออออออออุอออออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDesc.     ณ Fun็ใo para definir a regra do gatilho campo EL_TIPODOC.   บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณ fa087Concept บAutor  ณ Jos้ Lucas     บ Data ณ  01/12/10   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Retornar o array Concepto com informa็๕es das reten็oes.   บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
static Function fa087Concept(cPrefixo,cNFiscal,cParcela,cTipo,cCliente,cLoja,cCodRet,aDadImp,lAtu,lGrava,lComparVlres)
	...
	Else
		...
		Private aCerts	 := {} //-- Compatibiliza็ใo Configurador de Impostos Localizado - Rep.Dom.
...
/*/
	...
	ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
	ฑฑฺฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
	ฑฑณFun…o    ณ GerNumCertณ Autor ณ marcos Kato          ณ Data ณ30/07/2010ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณDescri…o ณ Verifica o proximo numero do certificado do imposto        ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณ Retorno  ณ Retorna o numero de certificado e o Numero de Autorizacao  ณฑฑ
	ฑฑณ          ณ aArray[1] -> Numero Certificado                            ณฑฑ
	ฑฑณ          ณ aArray[2] -> Numero Autorizacao                            ณฑฑ
	ฑฑรฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
	ฑฑณ Uso      ณ Equador                                                    ณฑฑ
	ฑฑภฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
	ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
	฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ A087aFillC บAutor  ณBruno               บ Data ณ  22/09/10 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณFuncao para recplicar os dados que devem ser iguais no acoolบฑฑ
ฑฑบ          ณdo detalhe das retencoes. (Argentina)                       บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA87RetVldบAutor  ณRenan Guedes        บ Data ณ  03/28/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValida็ใo da altera็ใo do campo VALOR do quadro de reten็๕esบฑฑ
ฑฑบ          ณdo painel 5. Esta fun็ใo chama as fun็๕es executadas nos 	  บฑฑ
ฑฑบ          ณpain้is anteriores.										  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
static Function FA87RetVld()
	...
	If cPaisLoc $ "ARG|COS"
		...
		If cCampo == "M->EL_VALOR"
			//Posi็๕es dos campos no cabe็alho
			...
			//Atualiza a linha da reten็ใo com o novo valor
			oRetTit:aCols[oRetTit:nAt][nPosVal2] := nNewVal

			//Zera os valores do quadro de resumo de reten็๕es
			For nX := 1 To Len(oRetRes:aArray)
				oRetRes:aArray[nX,2] := 0
			Next nX
			...
			//Atualiza o quadro de resumo de reten็๕es
			oRetRes:Refresh()

			For nX := 1 To Len(aColsRet)
				If !(aColsRet[nX,Len(aHeaderSEL)+1])
					For nY := 1 To Len(oRetTit:aCols)
						//Procura a linha da aCols onde a reten็ใo se localiza
						If !(aColsRet[nX,Len(aHeaderSEL)+1])	 							.And.;
							...
							//Atualiza o valor da reten็ใo para possibilitar as valida็๕es
			...
			//Atribui a aCols o array aCSEL e atualiza o objeto da GetDados de reten็๕es (Painel 1)
			...
			//Seta o aCols para o objeto do browse de reten็๕es
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA87RetOk  บAutor  ณRenan Guedes       บ Data ณ  03/28/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณValida็ใo ao confirmar a opera็ใo de recebimentos diversos. บฑฑ
ฑฑบ          ณFaz a atualiza็ใo dos quadros de reten็๕es a partir das 	  บฑฑ
ฑฑบ          ณaltera็๕es nos valores dos impostos retidos.                บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParโmetrosณnPanAtu	= N๚mero do painel em exibi็ใo                    บฑฑ
ฑฑบ          ณnUltPan	= N๚mero do ๚ltimo painel						  บฑฑ
ฑฑบ          ณ															  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function FA87RetOk(nPanAtu,nUltPan)
	...
	If cPaisLoc == "ARG"
		//Verifica se estแ no ๚ltimo painel
		If nPanAtu == nUltPan
			//Fecha os arquivos temporแrios e restaura os alias originais
			FA87aCtbA(2)
			//Valida a aCols inteira
			If !Fa087aTudoOk()
				lRet := .F.
			ElseIf !Fa087aBaixaOK()
				lRet := .F.
			EndIf
			If lRet
				//Posi็๕es dos campos no cabe็alho
				...
				//Atualiza cada linha do quadro de reten็๕es (Painel 1) a partir das altera็๕es do painel 5
				For nX := 1 To Len(oRetTit:aCols)
					If !(oRetTit:aCols[nX,Len(oRetTit:aHeader)+1])
						For nY := 1 To Len(aColsSEL)
							If !(aColsSEL[nX,Len(aHeaderSEL)+1])								.And.;
								...
								//Atualiza linhas do quadro de reten็๕es
				...
				//Atualiza os arrays e objeto do quadro de reten็๕es do painel 1
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัอออออออออออหอออออออัออออออออออออออออออออหออออออัออออออออออออปฑฑ
ฑฑบPrograma  ณFA87AValPanบAutor  ณRenan Guedes        บ Data ณ 03/31/11   บฑฑ
ฑฑฬออออออออออุอออออออออออสอออออออฯออออออออออออออออออออสออออออฯออออออออออออนฑฑ
ฑฑบDesc.     ณValida o refresh do painel 4 - Resumo                       บฑฑ
ฑฑบ          ณEsta fun็ใo forca a atualiza็ใo do painel 4 quando o		  บฑฑ
ฑฑบ          ณusuแrio estแ num painel posterior e volta para este.        บฑฑ
ฑฑบ          ณ															  บฑฑ
ฑฑบ          ณFecha e apaga os arquivos temporแrios da simula็ใo da 	  บฑฑ
ฑฑบ          ณcontabiliza็ใo, caso tenham sido criados					  บฑฑ
ฑฑบ          ณ															  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParโmetrosณnPan = N๚mero do painel a ser exibido                       บฑฑ
ฑฑบ          ณ															  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
...
Static Function FA87AValPan(nPan,nLPan)
	...
	If cPaisLoc == "ARG"
		If (nPan == (nLPan - 1)) .Or. (nPan == 4)
			...
			//Refaz o browse da simula็ใo da contabiliza็ใo
			aColsCtb := Array(1,Len(oSimCtb:aHeader)+1)
			For nX := 1 To Len(oSimCtb:aHeader)
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFINA087A  บAutor  ณMicrosiga           บ Data ณ  03/31/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function FA87aCtbA(nOpcX)
	...
	Local nPosSE1		:= 0
	Local nPosSA1		:= 0
	//Posi็๕es dos campos nos cabe็alhos
	Local nPosVal1		:= 0
	Local nPosVal2		:= 0
	Local nPosVal3		:= 0
	Local nPosTpDoc1	:= 0
	...
	Local cArquivo		:= ""
	Local nLinha 		:= 1
	Local lLancPad70 	:= VerPadrao("575")
	Local lDigita		:= .F.
	Local cLoteCom		:= ""
	Local nPosAlias		:= 0
	Local aDiario		:= {}
	...
	If !lCtbInUse
		Help(" ",1,"CTBINUSE",,STR0182,1,0)		//"A simula็ใo da contabiliza็ใo estแ disponํvel apenas para ambientes CTB."
		Return
	EndIf
	...
	If cPaisLoc == "ARG"
		If nOpcX == 1
			...
			//Clona os arrays utilizados na confirma็ใo do recebimento
			...
			For nX := 1 To Len(aClonSEL)
				If !(aClonSEL[nX][Len(aHeader)+1])
					//Adiciona a reten็ใo ao array que serแ utilizado na simula็ใo da contabiliza็ใo
					...
					For nY := 1 To Len(aClonRet)
						If	(aClonRet[nY][nPosTpDoc2]	== aClonSEL[nX][nPosTpDoc1])	.And.;
							...
							//Altera o valor para o do quadro de resumo de reten็๕es
			...
			//3 - Alias temporแrio para a tabela original
			//4 - Arquivo de trabalho
			//5 - อndice do arquivo de trabalho
			//6 - Chave do ํndice do arquivo de trabalho
			...
			//Adiciona o registro da tabela SE1 na tabela temporแria
			...
			//Adiciona o registro da tabela SA1 na tabela temporแria
			...
			//Grava os dados da simula็ใo da contabiliza็ใo
			For nX := 1 To Len(aSimCtbSEL)
				...
				If aSimCtbSEL[nX][nPosTpDoc1] $ cCredMed
					RecLock("SE1",.T.)
					SE1->E1_FILIAL 	:= xFilial("SE1")
					SE1->E1_SERREC 	:= SEL->EL_SERIE
					SE1->E1_RECIBO 	:= SEL->EL_RECIBO
					...
					If aSimCtbSEL[nX][nPosCred1] $ "1|2|"
						SE1->E1_BAIXA		:= IIF(aSimCtbSEL[nX][nPosCred1] == "1", dDatabase, DataValida(SEL->EL_DTVCTO))
						SE1->E1_LA			:= 'S'
						SE1->E1_MOTIVO		:= ""
						SE1->E1_MOVIMEN		:= SE1->E1_BAIXA
						SE1->E1_SALDO		:= 0
					...
					If aSimCtbSEL[nX][nPosCred1] == "1"
						SE1->E1_DTACRED := dDatabase
					ElseIf aSimCtbSEL[nX][nPosCred1] == "2"
						SE1->E1_DTACRED := DataValida(SEL->EL_DTVCTO)
					ElseIf aSimCtbSEL[nX][nPosCred1] == "3"
						nDias := Val(SEL->EL_ACREBAN)
						dBase := SE1->E1_VENCREA
						If nDias > 5
							dBase += 3650
					...
					If !aSimCtbSEL[nX][nPosCred1] $ "1|2"
						FA87aAtSdDp("+",SE1->E1_VALOR,SE1->E1_MOEDA,SE1->E1_TIPO,aTaxa[SE1->E1_MOEDA],SE1->E1_EMISSAO)
					EndIf
				Endif
			Next nX
			...
			For nX := 1 to Len(aClonSE1)
				...
				If SE1->(MsSeek(xFilial("SE1")+aClonSE1[nX,nPosPref3]+aClonSE1[nX,nPosNum3]+aClonSE1[nX,nPosPar3]+aClonSE1[nX,nPosTpDoc3]))
					...
					SEL->EL_FILIAL   	:= xFilial("SEL")
					SEL->EL_TIPODOC  	:= "TB"
					SEL->EL_UOBSTAR  := "REST Rut. "+ cIdTransc // 30/08/2019 Nahim Terrazas
					if type("OPagBajasNT:IDAPP") <> "U"
						SEL->EL_UIDAPPM	 := CVALTOCHAR(OPagBajasNT:IDAPP)// NAHIM ADICIONANDO ID
					endif
				...
				For nI := 1 To Len(aSimCtbSEL)
						...
						For nY := 1 To Len(aLinRet[nX])
							...
							ElseIf aSimCtbSEL[nI][nPosTpDoc1] == "RI"
								If !aLinRet[nX][nY][Len(aLinRet[nX,nY])] .And. (aLinRet[nX][nY][Len(aLinRet[nX,nY])-1] > 0)
									RecLock("SFE",.T.)
									SFE->FE_FILIAL	:= xFilial("SFE")
									SFE->FE_EMISSAO	:= aSimCtbSEL[nI][nPosEmis1]
									SFE->FE_CLIENTE	:= cCliente
									SFE->FE_LOJCLI 	:= cLoja
									SFE->FE_EST 		:= aLinRet[nX][nY][1]
									SFE->FE_CFO	 		:= aLinRet[nX][nY][2]
					...
					Else
						If (aSimCtbSEL[nI][nPosVal1] > 0) .And. (aSimCtbSEL[nI][nPosTpDoc1] $ "RI")
							...
							SFE->FE_CLIENTE  	:= cCliente
							SFE->FE_LOJCLI 		:= cLoja
							SFE->FE_TIPO   		:= Subs(aSimCtbSEL[nI][nPosTpDoc1] ,2 ,1) // I-B
							SFE->FE_RECIBO   	:= cRecibo
			...
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณ Simula็ใo da contabiliza็ใo                                      ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			If lLancPad70
				//+--------------------------------------------------------------+
				//ฆ Posiciona numero do Lote para Lancamentos do Financeiro      ฆ
			...
			If nHdlPrv > 0 .and. lLancPad70
//			Conout("pasa lLancPad70 2")	// Nahim para ver si genera o no 
				...
				//ฆ Envia para Lancamento Contabil, se gerado arquivo   ฆ
				//+-----------------------------------------------------+
				//SEL->(dbSetOrder (1))		//8##//O ํndice continua sendo 8, por้m como ordem 1
				...
				/*aTpSaldo*/,;
					...
					cTabCTK,;
					cTabCT2)
				//	Conout("pasa 2")	// Nahim para ver si genera o no
				//	Conout(lLanctOk)	// Nahim para ver si genera o no
		...
		If nOpcX == 2
			If (aCtbTmp != Nil) .And. (ValType(aCtbTmp) == "A")
				//Se for 2, fecha e exclui os arquivos temporแrios e restaura os alias originais
				For nX := 1 To Len(aCtbTmp)
					//Elimina las tablas temporales
					//nombre de variable temporal dinแmica declarada en func Fina087
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFINA087A  บAutor  ณMicrosiga           บ Data ณ  04/05/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑณDescricao ณFuncao que grava os campos no SA1 para avalia็ao de credito ณฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณParametrosณcOper = Operando para calcular os campos de avlia็ao do 	  ณฑฑ
ฑฑบ          ณ        credito 											  ณฑฑ
ฑฑณ          ณnValor = Valor do campo que serแ calculado                  ณฑฑ
ฑฑณ          ณnMoeda = Moeda Forte do Cliente                             ณฑฑ
ฑฑณ          ณcTipoDoc = Tipo de Titulo(Docto)                            ณฑฑ
ฑฑณ          ณnTaxa  = Taxa de conversใo do Valor do campo para a Moeda   ณฑฑ
ฑฑบ          ณ         Forte 											  ณฑฑ
ฑฑณ          ณdData  = Data de conversใo do Valor do cmapo para a Moeda   ณฑฑ
ฑฑบ          ณ         Forte 											  ณฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบATENวรO   ณ ESTE PROGRAMA ษ UMA CำPIA E ADAPTAวรO DO AtuSalDup         บฑฑ
ฑฑบ          ณ CONTIDO NO FONTE MATXATU                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function FA87aAtSdDp(cOper,nValor,nMoeda,cTipoDoc,nTaxa,dData,nCm)
	...
	Local cCampo		:= ""									// Campo que terแ o saldo atualizado
	Local cCampo1		:= ""									// Campo que terแ o saldo atualizado
	...
	If !cOper $ "+-="
		//MsgAlert(STR0044)  //"Operando incorreto, Verifique se ้ uma atribui็ใo, soma ou subtra็ใo"
		Return
	Endif
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFA87aSESTpบAutor  ณ Renan Guedes       บ Data ณ  04/05/11   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณRetorna a os tipos de acordo com o bloco de codigo.         บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณ bProps    = Bloco de codigo com as propriedades a consultarบฑฑ
ฑฑบ          ณ cCarteira = Carteira a consultar (Default  ambas).        บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบATENวรO   ณ ESTE PROGRAMA ษ UMA CำPIA E ADAPTAวรO DO GetSESTipos       บฑฑ
ฑฑบ          ณ CONTIDO NO FONTE MATXFUNC                                  บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑบPrograma  ณFINNextAliasบAutor  ณAlvaro Camillo Netoบ Data ณ  15/04/10  บฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออปฑฑ
ฑฑบPrograma  ณ F087aValCliบAutor  ณAna Paula           บ Data ณ  18/05/11 บฑฑ
ฑฑฬออออออออออุออออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออนฑฑ
ฑฑบDesc.     ณValida็ใo de clientes bloqueados							  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ FINA087A                                                   บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณGetIndicesบAutor  ณMicrosiga           บ Data ณ  22/09/2011 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ OBTEM OS INDICES DAS TABELAS                               บฑฑ
ฑฑบ          ณ UTILIZADA PARA SIMULACAO DE LANCOS CONTABEIS (ARGENTTINA)  บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ AP                                                         บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณPmsFi087A บAutor  ณJandir Deodato      บFecha ณ 04/09/12    บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
Static Function PmsFi087a()
	Local aSave
	Local bPMSDlg87 :={||PmsDlgRC(3,SE1->E1_PREFIXO,SE1->E1_NUM,SE1->E1_PARCELA,SE1->E1_TIPO,SE1->E1_CLIENTE,SE1->E1_LOJA,SE1->E1_ORIGEM)}//integra็ใo com Totvs obras e projetos
	aSave:=GetArea()
	M->E1_NUM 		:=SE1->E1_NUM
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFa087aNFRAบAutor  ณMicrosiga           บ Data ณ  19/06/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Caso a natureza do titulo seja de adiantamento ED_OPERADT=1บฑฑ
ฑฑบ          ณ gera o titulo do tipo RA (E1_TIPODOC) com base no titulo   บฑฑ
ฑฑบ          ณ de adiantamento.                                           บฑฑ
ฑฑบ          ณ Esta rotina tem como base o processo de geracao de NCC     บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ SIGAFIN - MEXICO                                           บฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function Fa087aNFRA(nValBaixa)
	...
	If SE1->(!EOF())
		...
		RegToMemory("SE1",.F.) //Carrega o titulo base na mem๓ria

		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Caso o titulo do tipo RA ja exista (processo de baixa ณ
		// ณparcial) o campo E1_PARCELA eh incrementado.          ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		SE1->(DbSetOrder(1)) //E1_FILIAL+E1_PREFIXO+E1_NUM+E1_PARCELA+E1_TIPO
		...
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Gera o novo titulo do tipo RA                         ณ
		//ณ O conceito de criacao eh semelhante ao gerado na NCC. ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		RecLock("SE1",.T.)
		SE1->E1_FILIAL   	:= XFilial("SE1")
		...
		//ณ Gera o recibo do titulo RA gerado acima ณ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบPrograma  ณFINA087A  บAutor  ณMicrosiga           บ Data ณ  25/06/12   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Valida a natureza selecionada para o recibo para nao per-  บฑฑ
ฑฑบ          ณ mitir a utilizacao de natureza de operacao de adiantamento บฑฑ
ฑฑบ          ณ ED_OPERADT == 1                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
Static Function FA087AVlNa()
	...
	If cPaisLoc == "PER" .And. AllTrim(cCalcITF) == "1"
		...
		Else
			lRet := .F.
			MsgAlert(STR0166) //"O campo Natureza ้ obrigat๓rio!"
		EndIf
	EndIf
...
ÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜÜ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณGetUUID     ณ Autor ณ Raul Ortiz  Medina  ณ Fecha ณ25/05/2017ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณObtiene el Timbre Fiscal                                     ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
...
Static Function GetUUID(cCte, cTda, cDoc, cTipo, cPrefixo, cFil, cOrigen)
	...
	If AllTrim(cTipo) $ cTipoDoc
		...
		Else
			...
			If SF2->(DbSeek(xFilial("SF2") + cCte + Ctda + cDoc + cPrefixo))
				lRet := !Empty(SF2->F2_UUID)
			EndIf
		EndIf
	Else
		If AllTrim(cTipo) $ "NCC"
			...
			If SF1->(DbSeek(xFilial("SF1") + cDoc + cPrefixo+cCte+cTda))
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณIntegDef   ณ Autor ณ Luis E. Enrํquez Mataณ Fecha ณ16/05/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณFunci๓n para integraci๓n EAI                                 ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ FINA087A                                                    ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณFA087Integ ณ Autor ณ Luis E. Enrํquez Mataณ Fecha ณ16/05/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณValida existencia configuraci๓n de Adapter p/integraci๓n EAI ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ FINA087A                                                    ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
static Function FA087Integ(lCancel,lMSG)
	...
	If !(Alltrim(SE1->E1_TIPO)=="PR")
		...
		If __lF087EAI == NIL
			__lF087EAI := FWHasEAI("FINA087A",.T.,,.T.) //Valida que rutina se encuentre configurada como adapter para integraci๓n EAI
		Endif
		...
		If __lF087EAI
			...
			If !EMPTY(oXX4:= If(FINDFUNCTION('FINCLSXX4'),oFINCLSXX4():New(cRotina,cMsg),NIL))
				...
				If (ValType(lRetExec) == "L" .and. lRetExec .and. !(oXX4:GetFldValue('_METODO')=='1'))
					If lMSG
						HELP(" ",1,"FA087INTEG",,"NAHIMSTR0224",2,0) //"El adapter de Baja de cunetas porCobrar (FINA087A) estแ configurado como NO SINCRONIZADO en el configurador. Configurar como SINCRONIZADO."
					EndIf
					lRet := .F.
				EndIf
				oXX4:CleanUp()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณFN087AWHEN    ณ Autor ณ Alfredo Medrano   ณ Fecha ณ06/04/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณactiva o desactiva los campos Relacionados al CEP            ณฑฑ
ฑฑณ            ณEL_CEPTIP, EL_CEPCER, EL_CEPCAD y EL_CEPSEL                  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณFN087AWH    ณ Autor ณ Alfredo Medrano     ณ Fecha ณ09/04/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณactiva o desactiva los campos Relacionados al CEP EL_RFCEMI, ณฑฑ
ฑฑณ            ณEL_CTAORD,EL_CEPTIP, EL_CEPCER, EL_CEPCAD y EL_CEPSEL        ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณfVerifImp   ณ Autor ณ Jonathan Gonzalez   ณ Fecha ณ25/05/2017ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณObtiene el impuesto del Anticipo en cuentas por pagar        ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณfValTipDoc  ณ Autor ณ Veronica Flo        ณ Fecha ณ19/10/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณSi tipo documento es RI, asigna default a Serie Retenci๓n.   ณฑฑ
ฑฑณ            ณPer๚                                                         ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑฺฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฟฑฑ
ฑฑณPrograma    ณF87AValRec  ณ Autor ณ Luis Enrํquez       ณ Fecha ณ29/11/2018ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณDescripcion ณValidaciones para recibo a sustituir. (MEX)                  ณฑฑ
ฑฑรฤฤฤฤฤฤฤฤฤฤฤฤลฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤดฑฑ
ฑฑณUso         ณ SIGAFIN                                                     ณฑฑ
ฑฑภฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤูฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
	...
	If !Empty(cSer) .Or. !Empty(cRec)
		...
		If SEL->(dbSeek(xFilial("SEL") + cSer + cRec))
			If SEL->EL_CANCEL .And. !Empty(SEL->EL_UUID) .And. !Empty(SEL->EL_FECTIMB)
				lRet := .T.
			Else
				MsgAlert("STR0227NAHIM", "STR0230NAHIM") //"Solo se permite sustituir complementoS para recepci๓n de pagos que ya fueron anulados y contienen un Timbre Fiscal." "Aviso"
				Return(.F.)
			EndIf
		Else
			MsgAlert("STR0228" + IIf(!Empty(cSer),Alltrim(cSer) + "-","") + IIf(!Empty(cRec),Alltrim(cRec),"") + "STR0229NAHIM", "STR0230") //"El complemento para recepci๓n de pagos [" "] a sustituir no existe." "Aviso"
			Return(.F.)
		EndIf
	EndIf
Return
